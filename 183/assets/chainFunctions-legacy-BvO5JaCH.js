!function() {
    ...
    System.register([ "./render-legacy-dLzA91Db.js", "./utils-legacy-KzeN2ceP.js" ], function(_export, _context) {
        var assertTruthy, ElementNode, isFocused, clamp, isNotShown;
        ...
        return _export({
            ...
            setters: [ function(_renderLegacy002Js) {
                assertTruthy = _renderLegacy002Js.Vt, ElementNode = _renderLegacy002Js._, isFocused = _renderLegacy002Js.w;
