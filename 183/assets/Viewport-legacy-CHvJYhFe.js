!function() {
    ...
    System.register([ "./render-legacy-dLzA91Db.js", "./state-legacy-C4TEpoVI.js" ], function(_export, _context) {
        var onMount, onCleanup, createElement, use, insert, setProp, createSignal, insertNode, setGlobalBackground;
        return {
            setters: [ function(_renderLegacy002Js) {
                onMount = _renderLegacy002Js.$, onCleanup = _renderLegacy002Js.Q, createElement = _renderLegacy002Js.a, 
                use = _renderLegacy002Js.g, insert = _renderLegacy002Js.l, setProp = _renderLegacy002Js.m, 
