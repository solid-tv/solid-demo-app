import { a as createElement, h as spread, x as renderer } from "./render-BluGTzme.js";
...
function Icon(props) {
    ...
    }("/solid-demo-app/183/assets/icons_white.png", icons), "perf" === props.name ? (_el$ = createElement("view"), 
    spread(_el$, mergeProps(props, {
        src: "/solid-demo-app/183/assets/perficon.png",
        width: 100,
        y: 25,
        height: 50
