...
function getNodeLineHeight(props2) {
    var _a2, _b;
    return (_b = (_a2 = props2.lineHeight) != null ? _a2 : Config.fontSettings.lineHeight) != null ? _b : 1.2 * props2.fontSize;
}
...
function updateNodeStyles(node) {
    ...
    }
    {
        ...
        if (props2.mountX != null) {
            x -= ((_a2 = props2.w) != null ? _a2 : 0) * props2.mountX;
        }
    ...
    if (node instanceof DOMText) {
        ...
        if (rawImgSrc) {
            ...
            if ((_c = props2.textureOptions.resizeMode) == null ? void 0 : _c.type) {
                ...
                const clipX = (_d = resizeMode.clipX) != null ? _d : .5;
                const clipY = (_e = resizeMode.clipY) != null ? _e : .5;
        ...
        if (((_f = props2.shader) == null ? void 0 : _f.props) != null) {
            let shaderProps = props2.shader.props;
            let borderWidth = shaderProps["border-w"];
            let borderColor = shaderProps["border-color"];
            let borderGap = (_g = shaderProps["border-gap"]) != null ? _g : 0;
            let borderInset = (_h = shaderProps["border-inset"]) != null ? _h : true;
            ...
            if (typeof borderWidth === "number" && borderWidth !== 0 && typeof borderColor === "number" && borderColor !== 0) {
                ...
                borderStyle += "outline: ".concat(borderWidth, "px solid ").concat(rgbaColor, ";");
                ...
                if (colors.length > 0) {
                    ...
                    if (gradientStops) {
                        if (colors.length === 1) {
                            ...
                            const pivotX = ((_i = pivot[0]) != null ? _i : .5) * 100;
                            const pivotY = ((_j = pivot[1]) != null ? _j : .5) * 100;
                            let sizePart = "";
                            if (width > 0 && height > 0) {
        ...
        if (needsBackgroundLayer) {
            ...
            if (rawImgSrc) {
                ...
                if (!srcPos && node.imgEl.complete && (!supportsObjectFit || !supportsObjectPosition) && node.imgEl.dataset.rawSrc === rawImgSrc) {
                    const resizeMode = (_k = node.props.textureOptions) == null ? void 0 : _k.resizeMode;
                    const clipX = (_l = resizeMode == null ? void 0 : resizeMode.clipX) != null ? _l : .5;
                    const clipY = (_m = resizeMode == null ? void 0 : resizeMode.clipY) != null ? _m : .5;
...
function scheduleUpdateDOMTextMeasurement(node) {
    if (textNodesToMeasure.size === 0) {
        ...
        if (document.fonts.status === "loaded") {
            ...
            if (fonts2 && fonts2.ready && typeof fonts2.ready.then === "function") {
...
class ElementNode extends Object {
    ...
    get fontFamily() {
        var _a2;
        return this._fontFamily || ((_a2 = Config.fontSettings) == null ? void 0 : _a2.fontFamily);
    }
    ...
    setFocus() {
        if (this.rendered) {
            ...
            if (focusQueued === false) {
                focusQueued = true;
                queueMicrotask(() => {
                    if (nextActiveElement) setActiveElement$1(nextActiveElement);
    ...
    _layoutOnLoad() {
        this.lng.on("loaded", () => {
            if ("reprocessUpdates" in renderer$2.stage && renderer$2.stage.reprocessUpdates) {
                renderer$2.stage.reprocessUpdates();
            }
...
const KeepAlive = props2 => {
    ...
    if (existing && ((_a2 = props2.shouldDispose) == null ? void 0 : _a2.call(props2, props2.id))) {
        existing.dispose();
...
const KeepAliveRoute = props2 => {
    ...
    const preload2 = props2.preload ? preloadProps => {
        ...
        if (existing && ((_a2 = props2.shouldDispose) == null ? void 0 : _a2.call(props2, key))) {
            existing.dispose();
...
const Player = lazy(() => __vitePreload(() => import("./Player-CRV1VFzy.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-C7IudiT6.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-skGzt79T.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-Cc3KorAh.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-8NmEDQ28.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-HFK-JYrH.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-C3GoKjsu.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-C3F6NfFJ.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DsKI9hce.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-jjYoWGUD.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-BBbBxPyT.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-T9D6vjeP.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-juG_AftC.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-B5Yvn96E.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DP1P6OCE.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CWZL7sR8.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-Cxkhtpzx.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-CyxRiGt9.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-ZrREMXl8.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-CfaMfjiJ.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CJauCZ8G.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-D8IY6ejH.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-DVYX_A3q.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-CoG2-XJi.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-CVIBJmp9.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-1jgK3LHh.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DMRDgWhA.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-sIn769Ff.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-B8j9okz8.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-BOtc0yXz.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-D1VnGAhJ.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-BhhkvfSw.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-Cmf9Mm6I.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-BQLo1OAV.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-TJqkKwa-.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-BfsCZ5rK.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-x3KzSo9A.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-utwBT595.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-DSM7OnWv.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-Ds97FmRC.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-AJCna964.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-DwTvUDUy.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
