...
class CoreNode extends EventEmitter {
    ...
    update(delta, parentClippingRect) {
        ...
        if (updateType & UpdateType.WorldAlpha) {
            this.worldAlpha = ((_a2 = parent == null ? void 0 : parent.worldAlpha) != null ? _a2 : 1) * this.props.alpha;
    ...
    sortChildren() {
        ...
        let firstZIndex = children2[0].props.zIndex;
        let min = firstZIndex;
        let max = firstZIndex;
    ...
    draw(renderer2) {
        const {glw: glw, stage: stage} = renderer2;
        const canvas2 = stage.platform.canvas;
        ...
        if (this.clippingRect.valid === true) {
            ...
            let clipY = Math.round(canvas2.height - clipHeight - this.clippingRect.y * pixelRatio);
            if (this.parentHasRenderTexture) {
...
class ImageTexture extends Texture {
    ...
    determineImageTypeAndLoadImage() {
        const {src: src, premultiplyAlpha: premultiplyAlpha, type: type2, w: w, h: h, sx: sx, sy: sy, sw: sw, sh: sh} = this.props;
        const platform = this.platform;
        const premultiply = premultiplyAlpha != null ? premultiplyAlpha : true;
        if (src === null) {
            return {
                data: null
            };
...
class SubTexture extends Texture {
    constructor(txManager, props2) {
        ...
        this.props = props2;
        assertTruthy(props2.texture);
        assertTruthy(props2.texture instanceof ImageTexture);
        this.parentTexture = txManager.resolveParentTexture(props2.texture);
        if (this.renderableOwners.length > 0) {
...
class Stage {
    constructor(options) {
        ...
        const {clearColor: clearColor, appWidth: appWidth, appHeight: appHeight, boundsMargin: boundsMargin, enableContextSpy: enableContextSpy, numImageWorkers: numImageWorkers2, textureMemory: textureMemory, renderEngine: renderEngine, fontEngines: fontEngines, createImageBitmapSupport: createImageBitmapSupport, platform: platform, maxRetryCount: maxRetryCount} = options;
...
class Platform {
    constructor(settings = {}) {
        __publicField(this, "settings");
        __publicField(this, "glw", null);
        __publicField(this, "canvas", null);
        var _a2, _b, _c;
        this.settings = {
            numImageWorkers: (_a2 = settings.numImageWorkers) != null ? _a2 : 2,
            forceWebGL2: (_b = settings.forceWebGL2) != null ? _b : false,
            canvas: (_c = settings.canvas) != null ? _c : null
        };
...
class ImageWorkerManager {
    constructor(numImageWorkers2, workerFactory) {
        ...
        this.workers = this.createWorkers(numImageWorkers2, workerFactory);
    ...
    handleMessage(event, workerIndex) {
        ...
        if (msg) {
            ...
            if (error) {
                ...
                this.createImageFromBlob(data.data, data.premultiplyAlpha).then(resolve).catch(reject);
            } else {
                resolve(data);
            }
        }
    }
    createWorkers(numWorkers2 = 1, workerFactory) {
        let workerCode = "(".concat(workerFactory.toString(), ")()");
            ...
            try {
                if (this.workers) {
                    ...
                    if (nextWorkerIndex !== -1) {
                        ...
                        this.workerLoad[nextWorkerIndex] = ((_a2 = this.workerLoad[nextWorkerIndex]) != null ? _a2 : 0) + 1;
                        worker.postMessage({
                            id: id,
                            src: src,
                            premultiplyAlpha: premultiplyAlpha,
...
function createWebGLContext(canvas2, forceWebGL2 = false) {
    const config = {
        alpha: true,
        antialias: false,
        depth: false,
...
class WebGlContextWrapper extends GlContextWrapper {
    constructor(gl) {
        super();
...
class WebPlatform extends Platform {
    constructor(settings = {}) {
        var _a2;
        super(settings);
        __publicField(this, "useImageWorker");
        __publicField(this, "imageWorkerManager", null);
        __publicField(this, "hasWorker", !!self.Worker);
        const numImageWorkers2 = (_a2 = settings.numImageWorkers) != null ? _a2 : 0;
        this.useImageWorker = numImageWorkers2 > 0 && this.hasWorker;
        if (this.useImageWorker === true) {
            this.imageWorkerManager = this.createImageWorkerManager(numImageWorkers2);
        }
    }
    createImageWorkerManager(numImageWorkers2) {
        return new ImageWorkerManager(numImageWorkers2, this.getImageWorkerFactory());
    }
    ...
    async loadImage(src, premultiplyAlpha, sx, sy, sw, sh) {
        ...
        const x = sx != null ? sx : null;
        const y = sy != null ? sy : null;
        const width = sw != null ? sw : null;
        const height = sh != null ? sh : null;
    ...
    async loadSvg(src, width, height, sx, sy, sw, sh) {
        return loadSvg(convertUrlToAbsolute(src), width, height, sx != null ? sx : null, sy != null ? sy : null, sw != null ? sw : null, sh != null ? sh : null);
    }
...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        assertTruthy(settings.platform);
    ...
    resolveTxSettings(textureMemory) {
        ...
        return {
            criticalThreshold: (_b = (_a2 = textureMemory == null ? void 0 : textureMemory.criticalThreshold) != null ? _a2 : currentTxSettings == null ? void 0 : currentTxSettings.criticalThreshold) != null ? _b : 124e6,
...
class WebGlShaderProgram {
    ...
    bindRenderOp(renderOp) {
        ...
        const framebufferDimensions = isCoreNode ? renderOp.parentFramebufferDimensions : renderOp.framebufferDimensions;
...
class WebGlCtxTexture extends CoreContextTexture {
    ...
    async onLoadRequest() {
        ...
        if (isImageBitmap || tdata instanceof ImageData || isHTMLImageElement(tdata) === true) {
            ...
            glw["upload" + type2](this._nativeCtxTexture, tdata);
            if (this.checkGLError() === true) {
                return {
                    w: 0,
                    h: 0
...
class WebGlRenderer extends CoreRenderer {
    constructor(stage) {
        ...
        const canvas2 = platform.canvas;
        const glw = this.glw = platform.createContext();
        glw.viewport(0, 0, canvas2.width, canvas2.height);
    ...
    reuseRenderOp(node) {
        ...
        if ((curShader == null ? void 0 : curShader.shaderKey) !== (shader == null ? void 0 : shader.shaderKey)) {
            return false;
        }
        ...
        if (curRenderOp.parentHasRenderTexture !== node.parentHasRenderTexture || curRtt !== (node.props.rtt === true)) {
            return false;
        }
        ...
        if ((curShader == null ? void 0 : curShader.shaderKey) === "default" && (shader == null ? void 0 : shader.shaderKey) === "default") {
            return true;
        }
        if ((curShader == null ? void 0 : curShader.program.reuseRenderOp(node, curRenderOp)) === false) {
            return false;
        }
        return true;
    }
...
class SdfRenderOp extends CoreRenderOp {
    constructor(renderer2, shader, sdfShaderProps, quadBufferCollection, worldAlpha, clippingRect, w, h, rtt, parentHasRenderTexture, framebufferDimensions) {
        super();
        __publicField(this, "renderer");
...
const generateTextLayout = (props2, fontCache2) => {
    ...
    for (let i = 0; i < lineAmount; i++) {
        ...
        for (const char of textLine) {
            ...
            let kerning = 0;
            if (prevGlyphId !== 0) {
                kerning = getKerning(fontFamily, prevGlyphId, glyph.id);
            }
            currentX += kerning;
            const glyphLayout = {
                codepoint: codepoint,
...
const tryOnCleanup$1 = onCleanup;

function makeEventListener$1(target, type2, handler, options) {
    target.addEventListener(type2, handler, options);
    return tryOnCleanup$1(target.removeEventListener.bind(target, type2, handler, options));
}
...
function useMouse(myApp = rootNode, throttleBy = 100, options) {
    ...
    makeEventListener$1(window, "wheel", handleScroll);
    makeEventListener$1(window, "click", handleClickContext);
    makeEventListener$1(window, "mousedown", handleMouseDownContext);
    createEffect(() => {
        if (scheduled()) {
...
const basePath$1 = "/solid-demo-app/300/";
...
const basePath = "/solid-demo-app/300/";
...
const Player = lazy(() => __vitePreload(() => import("./Player-B3na7Cq_.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DETS12yR.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DV3rb2G-.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-CRkGjqms.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CfleSVtB.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-BoR06FNy.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-D4JZnX-P.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-CVw_iNgo.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-BfU6YBL5.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-D23oBmmr.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-BTIUX-t5.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CHX7yHee.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-DkpfRsZ1.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-D256zhMH.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DmnnLR0l.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DBmvqz38.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DBNlLKkv.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-D_SOjTu6.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DRI-SIU7.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-DV74cyTV.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-Df0d62Gs.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-Bi4LOicA.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BDzLyrCM.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-4btbx3S6.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-UhDUiCUo.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-ClpgETok.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-TfnRaKE5.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-Dm_bOTFn.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-BhtjCXUw.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-CtqvrJDj.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-DYyVKSEu.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-CXxWt5BH.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-ftemcckS.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-AzDZ-Hp5.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-CQ7JVFRt.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-DZo1Zf3D.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-DAWDIdeG.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-CvnbYwdW.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-bqgbkug6.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-105dfXqQ.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-QNupVfM-.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-CWXyBf54.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
