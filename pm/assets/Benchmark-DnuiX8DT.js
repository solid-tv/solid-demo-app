import { $ as on, A as activeElement, C as renderer, F as Show, M as For, R as batch, U as createEffect, Y as createSignal, a as createElement, c as effect, d as memo, et as onCleanup, g as use, i as createComponent, k as Config, l as insert, m as setProp, s as createTextNode, u as insertNode, v as postMutationTiming, y as resetPostMutationTiming } from "./render-CkIU5n3A.js";

import { n as LazyRow, t as LazyColumn } from "./Lazy-vT0AK1Fj.js";

import { n as resetCounter } from "./FPSCounter-DBBuu4ox.js";

import { t as ContentBlock } from "./ContentBlock-D03gWwUR.js";

import { n as useFocusStack } from "./createFocusStack-YLXF27aL.js";

import { a as Hero, i as DISPLAY_SIZE, s as SHOW_TEXT, t as AssetPanel, u as TitleRow } from "./components-BR5oDtwp.js";
...
var Benchmark = props => {
    ...
    function simulateKeyDown(key, cycle, index) {
        try {
            ...
            const pmBefore = postMutationTiming.total;
            const pmCallsBefore = postMutationTiming.calls;
            const pmFocusBefore = postMutationTiming.focusTotal;
            const pmLayoutBefore = postMutationTiming.layoutTotal;
    ...
    async function runBenchmark() {
        ...
        const avgFps = totalRenderedMs > 0 && totalSampledFrames > 0 ? totalSampledFrames / (totalRenderedMs / 1e3) : fpsValues.length > 0 ? fpsValues.reduce((a, b) => a + b, 0) / fpsValues.length : 0;
        ...
        const meanKeyTask = keyDispatchCount > 0 ? totalKeyTaskMs / keyDispatchCount : 0;
        const worstKeyPresses = keyPressSamples.slice().sort((a, b) => b.taskMs - a.taskMs).slice(0, 5);
        ...
        const benchmarkResultsJson = {
            ...
            inputDispatch: {
                ...
                presses: keyPressSamples.map(sample => ({
                    press: sample.press,
                    cycle: sample.cycle,
