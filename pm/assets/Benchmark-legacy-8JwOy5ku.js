(function() {
    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./Lazy-legacy-CR9vbY3g.js", "./FPSCounter-legacy-Isnb4vQr.js", "./ContentBlock-legacy-Dusuj8wQ.js", "./createFocusStack-legacy-BMimzEI0.js", "./components-legacy-DRMoEX8o.js", "./styles-legacy-BOzjtbic.js", "./state-legacy-2LKtSLYa.js", "./dist-legacy-DZzTUFOg.js" ], function(_export, _context) {
        "use strict";
        var on, activeElement, renderer, Show, For, batch, createEffect, createSignal, createElement, effect, memo, onCleanup, use, createComponent, Config, insert, setProp, createTextNode, insertNode, postMutationTiming, resetPostMutationTiming, LazyRow, LazyColumn, resetCounter, ContentBlock, useFocusStack, Hero, DISPLAY_SIZE, SHOW_TEXT, AssetPanel, TitleRow, styles_default, setGlobalBackground, debounce, TOTAL_CYCLES, NAV_DELAY_MS, FRAME_TIME_SPLIT_MS, FRAME_TIME_FINE_MS, FRAME_TIME_COARSE_MS, FRAME_TIME_BUCKET_COUNT, Benchmark;
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                postMutationTiming = _renderLegacy001Js.v;
                resetPostMutationTiming = _renderLegacy001Js.y;
            ...
            execute: function execute() {
                ...
                _export("default", Benchmark = function Benchmark(props) {
                    ...
                    var maxRenderOps = 0;
                    var maxQuads = 0;
                    var totalKeyHandlerMs = 0;
                    var worstKeyHandlerMs = 0;
                    var totalKeyTaskMs = 0;
                    var worstKeyTaskMs = 0;
                    ...
                    function simulateKeyDown(key, cycle, index) {
                        try {
                            ...
                            var pmBefore = postMutationTiming.total;
                            var pmCallsBefore = postMutationTiming.calls;
                            var pmFocusBefore = postMutationTiming.focusTotal;
                            var pmLayoutBefore = postMutationTiming.layoutTotal;
                            var dispatchStart = performance.now();
                            document.dispatchEvent(event);
                            var handlerMs = performance.now() - dispatchStart;
                            keyDispatchCount++;
                            var press = keyDispatchCount;
                            totalKeyHandlerMs += handlerMs;
                            if (handlerMs > worstKeyHandlerMs) worstKeyHandlerMs = handlerMs;
                            var sample = {
                                press: press,
                                cycle: cycle,
                            ...
                            var closeSample = function closeSample() {
                                var taskMs = performance.now() - dispatchStart;
                                sample.taskMs = taskMs;
                                sample.pmMs = postMutationTiming.total - pmBefore;
                                sample.pmCalls = postMutationTiming.calls - pmCallsBefore;
                                sample.pmFocusMs = postMutationTiming.focusTotal - pmFocusBefore;
                                sample.pmLayoutMs = postMutationTiming.layoutTotal - pmLayoutBefore;
                                totalKeyTaskMs += taskMs;
                                if (taskMs > worstKeyTaskMs) worstKeyTaskMs = taskMs;
                            };
                            if (typeof queueMicrotask === "function") queueMicrotask(closeSample); else Promise.resolve().then(closeSample);
                        } catch (e) {
                            ...
                            return _regenerator().w(function(_context2) {
                                while (1) switch (_context2.n) {
                                  ...
                                  case 15:
                                    ...
                                    avgFps = totalRenderedMs > 0 && totalSampledFrames > 0 ? totalSampledFrames / (totalRenderedMs / 1e3) : fpsValues.length > 0 ? fpsValues.reduce(function(a, b) {
                                        return a + b;
                                    ...
                                    meanKeyTask = keyDispatchCount > 0 ? totalKeyTaskMs / keyDispatchCount : 0;
                                    ...
                                    benchmarkResultsJson = {
                                        ...
                                        inputDispatch: {
                                            ...
                                            presses: keyPressSamples.map(function(sample) {
                                                return {
                                                    press: sample.press,
                                                    cycle: sample.cycle,
                                                    ...
                                                    pmMs: parseFloat(sample.pmMs.toFixed(2)),
                                                    pmCalls: sample.pmCalls,
                                                    pmFocusMs: parseFloat(sample.pmFocusMs.toFixed(2)),
                                                    pmLayoutMs: parseFloat(sample.pmLayoutMs.toFixed(2))
                                                };
                                            }),
                                        ...
                                        postMutation: {
                                            enabled: Config.postMutationDebug === true,
                                            calls: postMutationTiming.calls,
                                            totalMs: parseFloat(postMutationTiming.total.toFixed(2)),
                                            maxMs: parseFloat(postMutationTiming.max.toFixed(2)),
                                            meanMs: postMutationTiming.calls > 0 ? parseFloat((postMutationTiming.total / postMutationTiming.calls).toFixed(3)) : 0,
                                            deleteTotalMs: parseFloat(postMutationTiming.deleteTotal.toFixed(2)),
                                            deleteMaxMs: parseFloat(postMutationTiming.deleteMax.toFixed(2)),
                                            layoutTotalMs: parseFloat(postMutationTiming.layoutTotal.toFixed(2)),
                                            layoutMaxMs: parseFloat(postMutationTiming.layoutMax.toFixed(2)),
                                            focusTotalMs: parseFloat(postMutationTiming.focusTotal.toFixed(2)),
                                            focusMaxMs: parseFloat(postMutationTiming.focusMax.toFixed(2))
                                        },
                    ...
                    return createComponent(Show, {
                        ...
                        get children() {
                            ...
                            insertNode(_el$14, createTextNode("Benchmark (version: pm)"));
                            setProp(_el$14, "x", 20);
                            setProp(_el$14, "y", 16);
