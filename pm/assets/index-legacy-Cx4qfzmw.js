    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./utils-legacy-I5pIoiB4.js", "./mergeProps-legacy-CW0lxKJl.js", "./announcer-legacy-tX7RJVKM.js", "./web-legacy-Dt_TNc5h.js", "./Lazy-legacy-CR9vbY3g.js", "./chainFunctions-legacy-D8RSddZy.js", "./Column-legacy-BHaIz8zK.js", "./FPSCounter-legacy-Isnb4vQr.js", "./ContentBlock-legacy-Dusuj8wQ.js", "./createFocusStack-legacy-BMimzEI0.js", "./components-legacy-DRMoEX8o.js", "./Icon-legacy-D8WGyQv3.js", "./routing-legacy-DpYbccnY.js", "./theme-legacy-CRa-Zkyx.js", "./styles-legacy-BOzjtbic.js", "./state-legacy-2LKtSLYa.js", "./dist-legacy-DZzTUFOg.js", "./api-legacy-CQ6iaaWY.js", "./ItemFormatter-legacy-DdRxF7y_.js" ], function(_export, _context) {
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                createWebGLContext = _renderLegacy001Js.At;
                renderer = _renderLegacy001Js.C;
                calcFactoredRadiusArray = _renderLegacy001Js.Ct;
                isFunction = _renderLegacy001Js.D;
                TextureType = _renderLegacy001Js.Dt;
                getNormalizedRgbaComponents = _renderLegacy001Js.Et;
                Show = _renderLegacy001Js.F;
                createResource = _renderLegacy001Js.K;
                DIRTY_QUAD_BUFFER = _renderLegacy001Js.Ot;
                mergeProps = _renderLegacy001Js.Q;
                batch = _renderLegacy001Js.R;
                loadFonts = _renderLegacy001Js.S;
                isHTMLImageElement = _renderLegacy001Js.St;
                isElementNode = _renderLegacy001Js.T;
                compareRect = _renderLegacy001Js.Tt;
                createEffect = _renderLegacy001Js.U;
                createComputed = _renderLegacy001Js.V;
                createMemo = _renderLegacy001Js.W;
                getListener = _renderLegacy001Js.X;
                createSignal = _renderLegacy001Js.Y;
                getOwner = _renderLegacy001Js.Z;
                ElementNode = _renderLegacy001Js._;
                MAX_QUAD_BUFFER_SIZE = _renderLegacy001Js._t;
                createElement = _renderLegacy001Js.a;
                focusPath = _renderLegacy001Js.b;
                createIndexBuffer = _renderLegacy001Js.bt;
                effect = _renderLegacy001Js.c;
                takeCanvasPrefetch = _renderLegacy001Js.ct;
                memo = _renderLegacy001Js.d;
                mapTextLayout = _renderLegacy001Js.dt;
                onCleanup = _renderLegacy001Js.et;
                rootNode = _renderLegacy001Js.f;
                normalizeFontMetrics = _renderLegacy001Js.ft;
                use = _renderLegacy001Js.g;
                MAX_QUADS = _renderLegacy001Js.gt;
                spread = _renderLegacy001Js.h;
                UpdateType = _renderLegacy001Js.ht;
                createComponent = _renderLegacy001Js.i;
                sharedConfig = _renderLegacy001Js.it;
                Config = _renderLegacy001Js.k;
                assertTruthy = _renderLegacy001Js.kt;
                insert = _renderLegacy001Js.l;
                takeSdfPrefetch = _renderLegacy001Js.lt;
                setProp = _renderLegacy001Js.m;
                uploadCompressedTexture = _renderLegacy001Js.mt;
                createRenderer = _renderLegacy001Js.o;
                untrack = _renderLegacy001Js.ot;
                CoreShaderNode = _renderLegacy001Js.pt;
                createRoot = _renderLegacy001Js.q;
                runWithOwner = _renderLegacy001Js.rt;
                createTextNode = _renderLegacy001Js.s;
                onMount = _renderLegacy001Js.tt;
                insertNode = _renderLegacy001Js.u;
                defaultFontMetrics = _renderLegacy001Js.ut;
                UNIT_TEXTURE_COORDS = _renderLegacy001Js.vt;
                hasFocus = _renderLegacy001Js.w;
                clampUnit = _renderLegacy001Js.wt;
                useFocusManager = _renderLegacy001Js.x;
                createTextureCoords = _renderLegacy001Js.xt;
                WORDS_PER_QUAD = _renderLegacy001Js.yt;
                children = _renderLegacy001Js.z;
            ...
            execute: function execute() {
                ...
                WebGlRenderer = function(_CoreRenderer) {
                    ...
                    return _createClass(WebGlRenderer, [ {
                        ...
                        value: function addSdfQuads(glyphs, glyphCount, fontScale, transform, color, worldAlpha, distanceRange, atlasTexture, clippingRect, width, height, sdfShader) {
                            ...
                            var g = color >>> 16 & 255;
                            var b = color >>> 8 & 255;
                            var packedColor = ((color & 255) << 24 | b << 16 | g << 8 | r) >>> 0;
                        ...
                        value: function addSdfCachedQuads(cachedVertices, numGlyphs, dx, dy, atlasTexture, clippingRect, worldAlpha, width, height, sdfShader) {
                        ...
                        value: function finalizeSdfBatch(startQuad, glyphCount, dx, dy, atlasTexture, clippingRect, worldAlpha, width, height, sdfShader) {
                ...
                renderQuads$1 = function renderQuads$1(renderer, layout, _vertexBuffer, renderProps) {
                    ...
                    if (cache !== void 0) {
                        ...
                        var _len2 = endIdx - startIdx;
                        if (_len2 > 0) {
                            if (cache.vertices === null || cache.vertices.length !== _len2) cache.vertices = new Float32Array(_len2);
                ...
                CanvasTexture = function(_CoreContextTexture2) {
                    function CanvasTexture() {
                        var _this8;
                        for (var _len3 = arguments.length, _args = new Array(_len3), _key5 = 0; _key5 < _len3; _key5++) {
                ...
                Player = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Player-legacy-B2R_HgwE.js");
                    }, void 0);
                });
                Grid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Grid-legacy-F5SRdxB_.js");
                    }, void 0);
                });
                Loops = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Loops-legacy-DKE1NgMs.js");
                    }, void 0);
                });
                Infinite = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Infinite-legacy-BAk5DwLf.js");
                    }, void 0);
                });
                TMDBGrid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TMDBGrid-legacy-CIOo91e1.js");
                    }, void 0);
                });
                Portal = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Portal-legacy-BA6UV23k.js");
                    }, void 0);
                });
                MatrixPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Matrix-legacy-WhgRKotv.js");
                    }, void 0);
                });
                TextPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Text-legacy-BHexcN-8.js");
                    }, void 0);
                });
                TextPosterPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextPoster-legacy-C9du5_Px.js");
                    }, void 0);
                });
                CreatePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Create-legacy-BOyY01qa.js");
                    }, void 0);
                });
                ViewportPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Viewport-legacy-C40DQnOe.js");
                    }, void 0);
                });
                PositioningPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Positioning-legacy-Bd7Jb-m1.js");
                    }, void 0);
                });
                LayoutPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Layout-legacy-BCKZh_34.js");
                    }, void 0);
                });
                FocusBasicsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusBasics-legacy-CKf6tC4B.js");
                    }, void 0);
                });
                KeyHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./KeyHandling-legacy-CnaE3Js_.js");
                    }, void 0);
                });
                TransitionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Transitions-legacy--WlaKbQP.js");
                    }, void 0);
                });
                ComponentsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Components-legacy-tEaWRgnV.js");
                    }, void 0);
                });
                FocusHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusHandling-legacy-DRAofGHG.js");
                    }, void 0);
                });
                GradientsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Gradients-legacy-AdSc_ok_.js");
                    }, void 0);
                });
                FlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Flex-legacy-CPskisCW.js");
                    }, void 0);
                });
                FlexGrowPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexGrow-legacy-Bp0ZkYv1.js");
                    }, void 0);
                });
                FlexMenuPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexMenu-legacy-BSa0j_XH.js");
                    }, void 0);
                });
                FlexSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexSize-legacy-CPBrT2lr.js");
                    }, void 0);
                });
                FlexColumnSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumnSize-legacy-C5bp0c9P.js");
                    }, void 0);
                });
                FlexColumnPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumn-legacy-0YdIyhdJ.js");
                    }, void 0);
                });
                ButtonsMaterialPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ButtonsMaterial-legacy-Bv5zRGrq.js");
                    }, void 0);
                });
                SuperFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./SuperFlex-legacy-DM30d5pn.js");
                    }, void 0);
                });
                Entity = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Entity-legacy-CHOrqkvO.js");
                    }, void 0);
                });
                People = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./People-legacy-CdA9nJbx.js");
                    }, void 0);
                });
                FireboltPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Firebolt-legacy-DbOhjB0U.js");
                    }, void 0);
                });
                LoginPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Login-legacy-D03U5wx2.js");
                    }, void 0);
                });
                VirtualPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Virtual-legacy-DNsAHHpp.js");
                    }, void 0);
                });
                TagsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Tags-legacy-IvOfY2Tk.js");
                    }, void 0);
                });
                ImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ImagePerformance-legacy-Dk6p2dbt.js");
                    }, void 0);
                });
                LargeImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./LargeImagePerformance-legacy-4zxtI87s.js");
                    }, void 0);
                });
                MixedImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./MixedImagePerformance-legacy-CmpRRwHZ.js");
                    }, void 0);
                });
                TextureCompressionPerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextureCompressionPerformance-legacy-BboOv7sr.js");
                    }, void 0);
                });
                ComplexFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlex-legacy-BthsUTZ9.js");
                    }, void 0);
                });
                ComplexFlexCapsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlexCaps-legacy-D8kEYn91.js");
                    }, void 0);
                });
                BenchmarkPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Benchmark-legacy-alGFx3I6.js");
                    }, void 0);
                });
                RendererVersionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./RendererVersions-legacy-zIqLOc_w.js");
                    }, void 0);
                });
                TextCenteringPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextCentering-legacy-CO-4OY-Q.js");
                    }, void 0);
                });
                CountdownTimerPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CountdownTimer-legacy-D2u7zDAs.js");
                    }, void 0);
                });
                CustomButtonsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CustomButtons-legacy-6c-P4T3C.js");
                    }, void 0);
                });
                                                    ...
                                                    return [ createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./Nested-legacy-b3peGX-G.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./KeepAlive-legacy-TTsXEkQZ.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./suspense-legacy-B1yPr_7P.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
