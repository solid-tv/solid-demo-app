(function() {
    ...
    System.register([ "./render-legacy-BpYVxbwM.js" ], function(_export, _context) {
        "use strict";
        var onMount, For, createElement, effect, createComponent, insert, setProp, createSignal, insertNode, TextureCompressionPerformance;
        return {
            ...
            execute: function execute() {
                _export("default", TextureCompressionPerformance = function TextureCompressionPerformance() {
                    ...
                    var basePath = "/solid-demo-app/sdfbatch/";
                    var startTime = 0;
                    var imageLoadTimes = {};
                    var totalImages = 25;
                    ...
                    var handleImageLoaded = function handleImageLoaded(index, id) {
                        ...
                        if (currentCount % 5 === 0) performance.mark("images-loaded-".concat(currentCount));
