(function() {
    System.register([ "./render-legacy-BpYVxbwM.js", "./mergeProps-legacy-0nyPmrpt.js" ], function(_export, _context) {
        "use strict";
        ...
        function Icon(props) {
            sprite = sprite || createSpriteMap("/solid-demo-app/sdfbatch/assets/icons_white.png", icons);
        ...
        return {
            ...
            execute: function execute() {
                basePath = "/solid-demo-app/sdfbatch/";
                icons = [ {
                    name: "experiment",
                    width: 81,
                    height: 100,
