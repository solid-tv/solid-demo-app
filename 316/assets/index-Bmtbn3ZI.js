const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-DUh4PV6y.js","assets/index-BQzytLQQ.js","assets/Infinite-DcQYIE1o.js"])))=>i.map(i=>d[i]);
...
class CoreTextureManager extends EventEmitter {
    ...
    hasUpdates() {
        return this.uploadTextureQueue.size > 0 || this.priorityQueue.length > 0;
    }
...
const getGlyph = (fontFamily, codepoint) => {
    ...
    return cache2.glyphMap.get(codepoint) || cache2.glyphMap.get(32) || null;
};
...
class WebGlRenderer extends CoreRenderer {
    ...
    render(surface = "screen") {
        ...
        const QUAD_SIZE_IN_BYTES = 4 * (5 * arr.BYTES_PER_ELEMENT);
...
const basePath$1 = "/solid-demo-app/316/";
...
const basePath = "/solid-demo-app/316/";
...
const Player = lazy(() => __vitePreload(() => import("./Player-BSTDPuQn.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DQQDfy__.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DUh4PV6y.js"), true ? __vite__mapDeps([0,1]) : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-DcQYIE1o.js"), true ? __vite__mapDeps([2,1]) : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-BT8HLjTv.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-B6CyGhyE.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BT2qUGra.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-_wdVikgt.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-iP678N0E.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-Z4z2XsPn.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-KJCaY36v.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CmOGBIU3.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-P-iPNCh1.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-BRJm0XEx.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-Gm2xO6YO.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-xNWs47Sw.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-B3n7WKwa.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-3cdRJ10B.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BSnyiiIg.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-DuXhPuN-.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-VCcGIOxs.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-DhMwBJZ8.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-aLBBGPRQ.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Cl0FqtC4.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-CXzUtJ3U.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-rpwLZbvz.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CfbfGA3-.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-4z-t2eS5.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-CDWL9NXf.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-CK687Ggi.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CPEpqiMn.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-x_NtBpNw.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-CTzuqv2V.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-C9gi1OYl.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-DaYN1dmd.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-DAsioNEw.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-nlkG7dRP.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-q9vlBkd-.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-jdu2QDlh.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-DeYEpEkJ.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-48T_30nR.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-BeY2R34W.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
