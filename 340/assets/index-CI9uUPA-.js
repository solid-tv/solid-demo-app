...
class AnimationManager {
    ...
    applyValues(anim) {
        ...
        if (anim.props) {
            for (const key in anim.props) {
                ...
                anim.node[key] = this.interpolate(key, value.start, value.target, easedProgress, anim.progress);
            }
        }
        if (anim.shaderProps && anim.node.shader) {
            ...
            for (const key in anim.shaderProps) {
                ...
                anim.node.shader.props[key] = this.interpolate(key, value.start, value.target, easedProgress, anim.progress);
                updated = true;
            }
            if (updated) {
    ...
    interpolate(propName, start, target, easedProgress, p) {
        if (p === 1) return target;
        if (p === 0) return start;
        if (propName.indexOf("color") !== -1) {
            return mergeColorProgress(start, target, easedProgress);
        }
...
const Player = lazy(() => __vitePreload(() => import("./Player-D2JsycQ4.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-BAoQ9gkf.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DouedqKh.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BanRV514.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CTxxfl0C.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-DuJyZS6d.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-DCcog_nu.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-IuCA_sAv.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DMOFTNTB.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-D269fzKf.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-BrvYIIBx.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CveFC94G.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CmbsvXl1.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-du7O3uN4.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-BAza4igM.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DvktrCBr.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-OJM8Tx__.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Cet8x8b0.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-C3P4sF9y.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BzQQr_7B.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BWsnNV8A.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-wXP7PjWN.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-pmAZEghK.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Cl3ShYg-.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-DrxXXePf.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DQGP8wwX.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BipU9Ycw.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-Bo9SPo2i.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DTEqv8Xq.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-SQGRcWf0.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-BtgHcgJF.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-CzDIX1OK.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DCNfzSBv.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-DwHyZk_V.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-CtRUPc81.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-C1r_SIa6.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-CXcs7eFN.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-CaE6VqHn.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-D5aYJZYr.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-b6Uz-DRm.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-CigFu8RS.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-CViQI_Jo.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
