const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-ChP5WhSZ.js","assets/index-BKIX9Nw7.js","assets/Infinite-BVnuAO9m.js"])))=>i.map(i=>d[i]);
...
const assetsURL = function(dep) {
    return "/solid-demo-app/3.3.1/" + dep;
};
...
class CoreTextNode extends CoreNode {
    ...
    renderQuads(renderer2) {
        ...
        if (this._cachedRenderOp) {
            ...
            this._cachedRenderOp.parentHasRenderTexture = USE_RTT;
            this._cachedRenderOp.framebufferDimensions = null;
...
class WebGlShaderProgram {
    ...
    bindRenderOp(renderOp) {
        ...
        if (isCoreNode === false && renderOp.sdfShaderProps !== void 0) {
            ...
            (_a2 = opShader.shaderType.onSdfBind) == null ? void 0 : _a2.call(this.glw, renderOp.sdfShaderProps);
            return;
        }
...
class DOMNode extends EventEmitter {
    constructor(stage, props2) {
        ...
        __publicField(this, "lazyImagePendingSrc", null);
        __publicField(this, "lazyImageSubTextureProps", null);
        __publicField(this, "boundsDirty", true);
        __publicField(this, "children", new Set);
...
class DOMRendererMain {
    constructor(settings, rawTarget) {
        ...
        __publicField(this, "canvas");
        __publicField(this, "stage");
        __publicField(this, "eventListeners", new Map);
        var _a2, _b;
...
const createKeepAliveComponent = (map, storeFn) => props2 => {
    ...
    if (existing && (((_a2 = props2.shouldDispose) == null ? void 0 : _a2.call(props2, props2.id)) || ((_b = existing.children) == null ? void 0 : _b.destroyed))) {
        ...
        (_c = existing.dispose) == null ? void 0 : _c.call(existing);
    ...
    if (!existing || !existing.dispose) {
        ...
        existing.children = runWithOwner(existing.owner, () => wrapChildren(props2, existing.setIsAlive));
    }
...
const KeepAliveRoute = props2 => {
    ...
    const preload2 = props2.preload ? preloadProps => {
        var _a2, _b, _c, _d;
        let existing2 = keepAliveRouteElements.get(key);
        if (existing2 && existing2.children && (((_a2 = props2.shouldDispose) == null ? void 0 : _a2.call(props2, key)) || ((_b = existing2.children) == null ? void 0 : _b.destroyed))) {
            existing2.children.destroy();
            (_c = existing2.dispose) == null ? void 0 : _c.call(existing2);
            keepAliveRouteElements.delete(key);
            existing2 = void 0;
        }
        if (!existing2 || !existing2.dispose) {
            return createRoot(dispose2 => {
                const [isAlive, setIsAlive] = (existing2 == null ? void 0 : existing2.isAlive) && (existing2 == null ? void 0 : existing2.setIsAlive) ? [ existing2.isAlive, existing2.setIsAlive ] : createSignal(true);
                storeKeepAliveRoute({
                    id: key,
                    owner: getOwner(),
                    dispose: dispose2,
        ...
        } else if (existing2.children) {
            (_d = existing2.children) == null ? void 0 : _d.setFocus();
            return props2.preload({
                ...preloadProps,
                isAlive: existing2.isAlive
            });
        } else {
            return props2.preload({
                ...preloadProps,
    ...
    return createComponent(Route, mergeProps(props2, {
        ...
        component: childProps => {
            const existing2 = keepAliveRouteElements.get(key);
...
const basePath$1 = "/solid-demo-app/3.3.1/";
...
const basePath = "/solid-demo-app/3.3.1/";
...
const Player = lazy(() => __vitePreload(() => import("./Player-C2YA-2me.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-IZz5_9Nt.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-ChP5WhSZ.js"), true ? __vite__mapDeps([0,1]) : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BVnuAO9m.js"), true ? __vite__mapDeps([2,1]) : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-Di5KhanV.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-DVWP0WoI.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-Dn4o-KYW.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-BVd1KjvW.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DpzDchjm.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-B9jeLOK8.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-mx5ZD2em.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-pNT6E3mR.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-6MMdsHCd.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-CfkLizka.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-j4XhtR8c.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-C1MA6hdH.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DX5erNsr.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-CBYpTpae.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BMeZoJCe.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-Vit5uScW.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BIcbZlU4.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-Bj27Z9Rz.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BDqYRWFk.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-BvKOo0zk.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-BcbbT8Mw.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DZBq0qyQ.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-uNH3hGHc.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-CjcQwhv8.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DRkerUQ_.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-q5tuxUVJ.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CnI4dB-g.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-C0IfSFwd.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DlwFGTJo.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-BjSfYvXG.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-BbZmCwRu.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-wQcBGfvJ.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-CCb9-zpd.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-BwKa9Ap6.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-B-boiz_N.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-mBETXhtA.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-BJWwTvzB.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-DXdXLo8P.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
...
export { $TRACK as $, activeElement as A, ContentBlock as B, Column as C, useFocusStack as D, ElementNode as E, For as F, children as G, Announcer as H, Index as I, memo as J, styles$1 as K, LazyRow as L, assertTruthy as M, combineStyles as N, Block as O, Poster as P, Dynamic as Q, Row as R, Show as S, Text as T, Button as U, View as V, MaterialButtonText as W, TileRow as X, api as Y, getImageUrl as Z, convertItemsToTiles as _, __vite_legacy_guard, createSignal as a, useParams as a0, Switch as a1, Match as a2, LazyColumn as a3, TitleRow as a4, setProp as a5, rootNode as a6, effect as a7, renderer$2 as a8, Hero as a9, AssetPanel as aa, resetCounter as ab, insertNode as ac, getOwner as ad, Config as ae, Suspense as af, createTextNode as ag, createResource as b, createComponent as c, createComputed as d, batch as e, createSelector as f, createEffect as g, hexColor as h, on as i, createMemo as j, onCleanup as k, untrack as l, mergeProps as m, createRoot as n, onMount as o, createElement as p, chainRefs as q, hasFocus as r, setGlobalBackground as s, theme as t, useNavigate as u, use as v, spread as w, chainFunctions as x, insert as y, debounce as z };
