...
class Stage {
    ...
    resolveNodeDefaults(props2) {
        ...
        return {
            ...
            src: (_D = props2.src) != null ? _D : null,
            srcHeight: props2.srcHeight,
            srcWidth: props2.srcWidth,
            srcX: props2.srcX,
            srcY: props2.srcY,
            scale: scale,
            scaleX: (_F = (_E = props2.scaleX) != null ? _E : scale) != null ? _F : 1,
            scaleY: (_H = (_G = props2.scaleY) != null ? _G : scale) != null ? _H : 1,
            mount: mount,
            mountX: (_I = props2.mountX) != null ? _I : mount,
            mountY: (_J = props2.mountY) != null ? _J : mount,
            pivot: pivot,
            pivotX: (_K = props2.pivotX) != null ? _K : pivot,
            pivotY: (_L = props2.pivotY) != null ? _L : pivot,
            rotation: (_M = props2.rotation) != null ? _M : 0,
            rtt: (_N = props2.rtt) != null ? _N : false,
            data: data,
            imageType: props2.imageType,
            interactive: (_O = props2.interactive) != null ? _O : false
        };
    }
    cleanup(full = false) {
...
class WebGlContextWrapper {
    constructor(gl) {
        ...
        __publicField(this, "programUniforms", new WeakMap);
        __publicField(this, "enabledVertexAttribArrays", []);
        __publicField(this, "vertexAttribState", []);
        __publicField(this, "canvas");
        ...
        this.enabledVertexAttribArrays = new Array(maxVertexAttribs).fill(false);
        this.vertexAttribState = new Array(maxVertexAttribs).fill(null).map(() => ({
            buffer: null,
            size: 0,
            type: 0,
            normalized: false,
    ...
    _getActiveTexture() {
        var _a2;
        return (_a2 = this.texture2dUnits[this.activeTextureUnit]) != null ? _a2 : null;
    }
    ...
    vertexAttribPointer(buffer, index, size, type2, normalized, stride, offset) {
        const state = this.vertexAttribState[index];
        if (state && state.buffer === buffer && state.size === size && state.type === type2 && state.normalized === normalized && state.stride === stride && state.offset === offset && this.boundArrayBuffer === buffer) {
            return;
        }
        if (this.boundArrayBuffer !== buffer) {
            this.gl.bindBuffer(this.gl.ARRAY_BUFFER, buffer);
    ...
    uniform1f(location, v0) {
        if (this._getUniformCache(location) === v0) {
            return;
        }
        this._setUniformCache(location, v0);
        this.gl.uniform1f(this.curUniformLocations[location] || null, v0);
    }
    uniform1fv(location, value) {
        const cached = this._getUniformCache(location);
        if (cached) {
            if (this._compareFloat32Arrays(cached, value)) return;
            cached.set(value);
        } else {
            this._setUniformCache(location, new Float32Array(value));
        }
    ...
    uniform1iv(location, value) {
        const cached = this._getUniformCache(location);
        if (cached) {
            if (this._compareInt32Arrays(cached, value)) return;
            cached.set(value);
        } else {
            this._setUniformCache(location, new Int32Array(value));
        }
        this.gl.uniform1iv(this.curUniformLocations[location] || null, value);
    }
    uniform2f(location, v0, v1) {
        const c0 = this._getUniformCache(location + "_0");
        const c1 = this._getUniformCache(location + "_1");
        if (c0 === v0 && c1 === v1) {
            return;
        }
        this._setUniformCache(location + "_0", v0);
        this._setUniformCache(location + "_1", v1);
        this.gl.uniform2f(this.curUniformLocations[location] || null, v0, v1);
    }
    uniform2fa(location, value) {
        this.uniform2f(location, value[0], value[1]);
    }
    uniform2fv(location, value) {
        const cached = this._getUniformCache(location);
        if (cached) {
    ...
    uniform3f(location, v0, v1, v2) {
        const c0 = this._getUniformCache(location + "_0");
        const c1 = this._getUniformCache(location + "_1");
        const c2 = this._getUniformCache(location + "_2");
        if (c0 === v0 && c1 === v1 && c2 === v2) {
            return;
        }
        this._setUniformCache(location + "_0", v0);
        this._setUniformCache(location + "_1", v1);
        this._setUniformCache(location + "_2", v2);
        this.gl.uniform3f(this.curUniformLocations[location] || null, v0, v1, v2);
    }
    uniform3fa(location, value) {
        this.uniform3f(location, value[0], value[1], value[2]);
    }
    uniform3fv(location, value) {
        const cached = this._getUniformCache(location);
        if (cached) {
    ...
    uniform4f(location, v0, v1, v2, v3) {
        ...
        const c1 = this._getUniformCache(location + "_1");
        const c2 = this._getUniformCache(location + "_2");
        const c3 = this._getUniformCache(location + "_3");
        ...
        this._setUniformCache(location + "_1", v1);
        this._setUniformCache(location + "_2", v2);
        this._setUniformCache(location + "_3", v3);
        this.gl.uniform4f(this.curUniformLocations[location] || null, v0, v1, v2, v3);
    }
    uniform4fa(location, value) {
        this.uniform4f(location, value[0], value[1], value[2], value[3]);
    }
    uniform4fv(location, value) {
        const cached = this._getUniformCache(location);
        if (cached) {
    ...
    enableVertexAttribArray(index) {
        if (this.enabledVertexAttribArrays[index]) {
            return;
        }
        this.gl.enableVertexAttribArray(index);
        this.enabledVertexAttribArrays[index] = true;
    }
    disableVertexAttribArray(index) {
        ...
        this.enabledVertexAttribArrays[index] = false;
    }
    createShader(type2) {
    ...
    _getUniformCache(name) {
        var _a2;
        if (!this.curProgram) return void 0;
        return (_a2 = this.programUniforms.get(this.curProgram)) == null ? void 0 : _a2[name];
    }
    _setUniformCache(name, value) {
        if (!this.curProgram) return;
        let cache2 = this.programUniforms.get(this.curProgram);
        if (!cache2) {
            cache2 = {};
            this.programUniforms.set(this.curProgram, cache2);
        }
        cache2[name] = value;
    }
    _compareFloat32Arrays(a, b) {
...
const KeepAliveRoute = props2 => {
    ...
    const preload2 = props2.preload ? preloadProps => {
        ...
        if (existing.children && (((_a2 = props2.shouldDispose) == null ? void 0 : _a2.call(props2, key)) || ((_b = existing.children) == null ? void 0 : _b.destroyed))) {
            existing.children.destroy();
            (_c = existing.dispose) == null ? void 0 : _c.call(existing);
        ...
        if (!existing.dispose) {
            ...
            (_d = existing.children) == null ? void 0 : _d.setFocus();
            return props2.preload({
                ...preloadProps,
                isAlive: existing.isAlive
            });
...
const basePath$1 = "/solid-demo-app/331/";
...
const basePath = "/solid-demo-app/331/";
...
const Player = lazy(() => __vitePreload(() => import("./Player-BN4JQAVG.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DoXOX0CN.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-CIG7_tkW.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-w3gdrcxU.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-_vytzyYW.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-BhyX24Lm.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-azpsiIt0.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-ZDty-8DK.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-agoIJfuY.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-BFnSmkgG.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-IZTRgXVo.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-D8IhD4Pz.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-DtqIx2MK.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-BSC1bUVN.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-B0JIlf0J.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-pXW1vVal.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BlHGIFhS.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-DKH0FxO6.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BVMwo7K2.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-D-SwClUn.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-C7JqvkOl.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-DLEJy8kv.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-DjkIEBnD.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Bq970hFH.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-kgRSTY5K.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-9Pn4o0xI.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DV6pHvSn.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-BV4z8rCG.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DNeH8IS6.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-BnuDal7u.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-DC9yPV_r.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-efQnkQ7j.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-BFmLeUfV.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-BQnStIkS.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-CBbrTEgj.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-DfR0kKKv.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-DWP5VVBt.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-DtiBks8K.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-B76xrRRA.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-CmisDe9t.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-B13pzewu.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-COvPGMSt.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
