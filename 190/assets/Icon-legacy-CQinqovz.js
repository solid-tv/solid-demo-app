System.register([ "./render-legacy-BWVYYcsn.js", "./mergeProps-legacy-D2-w7VmI.js" ], function(_export, _context) {
    var createElement, spread, renderer, mergeProps, basePath, icons, sprite;
    return _export("t", function(props) {
        var src, subTextures, spriteMapTexture, _el$, _el$2;
        return sprite = sprite || (src = "/solid-demo-app/190/assets/icons_white.png", subTextures = icons, 
        ...
        setters: [ function(_renderLegacy002Js) {
            createElement = _renderLegacy002Js.a, spread = _renderLegacy002Js.h, renderer = _renderLegacy002Js.x;
        }, function(_mergePropsLegacy005Js) {
            mergeProps = _mergePropsLegacy005Js.t;
        } ],
        execute: function() {
            basePath = "/solid-demo-app/190/", icons = [ {
                name: "experiment",
                width: 81,
                height: 100,
                x: 0,
