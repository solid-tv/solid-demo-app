!function() {
    ...
    System.register([ "./render-legacy-BWVYYcsn.js", "./state-legacy-DCkLOvQm.js" ], function(_export, _context) {
        var onMount, Suspense, onCleanup, createEffect, createResource, createElement, use, createComponent, insert, setProp, createSignal, createTextNode, insertNode, setGlobalBackground;
        function fadeIn(el) {
        ...
        return _export("default", function() {
            ...
            var _el$, lastCount = 0, _createResource2 = _slicedToArray(createResource(_asyncToGenerator(_regenerator().m(function _callee() {
                return _regenerator().w(function(_context2) {
                    for (;;) switch (_context2.n) {
                      case 0:
                        return _context2.n = 1, new Promise(function(r) {
                            return setTimeout(r, 1600);
                        });

                      case 1:
                        return _context2.a(2, ++lastCount);
                    }
                }, _callee);
            }))), 2), data = _createResource2[0], refetch = _createResource2[1].refetch;
            return _el$ = createElement("view"), setProp(_el$, "forwardFocus", 0), insert(_el$, createComponent(Suspense, {
                ...
                get children() {
                    ...
                    return insertNode(_el$2, _el$3), use(function(elm) {
                        var _createSignal2 = _slicedToArray(createSignal(0), 2), count = _createSignal2[0], setCount = _createSignal2[1];
                        onMount(function() {
                    ...
                    setProp(_el$2, "onRender", fadeIn), setProp(_el$2, "onRemove", fadeOut), setProp(_el$2, "onEnter", function() {
                        refetch();
                    }), setProp(_el$2, "display", "flex"), setProp(_el$2, "center", !0), insertNode(_el$3, _el$4), 
                    insertNode(_el$3, _el$5), insert(_el$3, function() {
                        var _data;
            ...
            setters: [ function(_renderLegacy002Js) {
                onMount = _renderLegacy002Js.$, Suspense = _renderLegacy002Js.P, onCleanup = _renderLegacy002Js.Q, 
                createEffect = _renderLegacy002Js.V, createResource = _renderLegacy002Js.W, createElement = _renderLegacy002Js.a, 
                use = _renderLegacy002Js.g, createComponent = _renderLegacy002Js.i, insert = _renderLegacy002Js.l, 
