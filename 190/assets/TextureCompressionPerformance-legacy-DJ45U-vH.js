!function() {
    ...
    System.register([ "./render-legacy-BWVYYcsn.js" ], function(_export, _context) {
        var onMount, For, createElement, effect, createComponent, insert, setProp, createSignal, insertNode;
        return {
                                  ...
                                  case 0:
                                    try {
                                        setStatus("Preparing images..."), newImages = Array.from({
                                            ...
                                            return {
                                                id: "img-".concat(id),
                                                src: "".concat("/solid-demo-app/190/", "assets/ktx/image-").concat(id, ".ktx"),
