import { At as assertTruthy, J as createSignal, a as createElement, f as mergeProps, g as spread, h as setProp, l as insert, s as createTextNode, u as insertNode } from "./render-UQXSDH2t.js";
...
var WebGlShaderProgram = class {
    ...
    bindRenderOp(renderOp) {
        ...
        const parentHasRenderTexture = renderOp.parentHasRenderTexture, framebufferDimensions = isCoreNode && renderOp.parentHasRenderTexture ? renderOp.parentFramebufferDimensions : renderOp.framebufferDimensions;
        if (!0 === renderOp.rtt && !0 === parentHasRenderTexture) return;
        let pixelRatio, resolutionW, resolutionH;
...
export { Default as a, ShadowTemplate as c, HolePunchTemplate as d, BorderTemplate as f, WebGlShaderProgram as i, getShadowProps as l, resetCounter as n, RadialGradientTemplate as o, getBorderProps as p, setupFPS as r, LinearGradientTemplate as s, FPSCounter as t, RoundedTemplate as u };