!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./chainFunctions-legacy-iSOIOqjU.js", "./ContentBlock-legacy-CIbTwJhf.js", "./components-legacy-CMcgiR3G.js", "./state-legacy-CIkOTHs-.js", "./dist-legacy-CtobM8tC.js" ], function(_export, _context) {
        var hasFocus, createEffect, createSignal, Index, on, createMemo, use, createElement, untrack, mergeProps, spread, setProp, createComponent, activeElement, insert, createTextNode, insertNode, ElementNode, chainRefs, chainFunctions, ContentBlock, Poster, setGlobalBackground, debounce;
        function Grid(props) {
        ...
        return {
            setters: [ function(_renderLegacy002Js) {
                hasFocus = _renderLegacy002Js.C, createEffect = _renderLegacy002Js.H, createSignal = _renderLegacy002Js.J, 
                Index = _renderLegacy002Js.M, on = _renderLegacy002Js.Q, createMemo = _renderLegacy002Js.U, 
                ...
                createComponent = _renderLegacy002Js.i, activeElement = _renderLegacy002Js.k, insert = _renderLegacy002Js.l, 
                createTextNode = _renderLegacy002Js.s, insertNode = _renderLegacy002Js.u, ElementNode = _renderLegacy002Js.v;
            }, function(_chainFunctionsLegacy008Js) {
                chainRefs = _chainFunctionsLegacy008Js.n, chainFunctions = _chainFunctionsLegacy008Js.t;
            }, function(_ContentBlockLegacy00bJs) {
                ContentBlock = _ContentBlockLegacy00bJs.t;
            }, function(_componentsLegacy00dJs) {
                Poster = _componentsLegacy00dJs.s;
