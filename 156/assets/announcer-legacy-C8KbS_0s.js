!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js" ], function(_export, _context) {
        var onCleanup, createSignal, getOwner, getListener, untrack, focusPath, ARIA_PARENT_ID, ariaLabelPhrases, currentSeries, debounce, resetFocusPathTimer, prevFocusPath, currentlySpeaking, voiceOutDisabled, Announcer;
        ...
        return _export("n", function(schedule) {
            ...
            setters: [ function(_renderLegacy002Js) {
                onCleanup = _renderLegacy002Js.$, createSignal = _renderLegacy002Js.J, getOwner = _renderLegacy002Js.X, 
                getListener = _renderLegacy002Js.Y, untrack = _renderLegacy002Js.at, focusPath = _renderLegacy002Js.y;
            } ],
            execute: function() {
