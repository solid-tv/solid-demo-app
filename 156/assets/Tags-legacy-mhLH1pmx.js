!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./state-legacy-CIkOTHs-.js" ], function(_export, _context) {
        var onCleanup, createSignal, createElement, effect, mergeProps, spread, setProp, createComponent, insert, rootNode, createTextNode, insertNode, setGlobalBackground;
        ...
        return {
            setters: [ function(_renderLegacy002Js) {
                ...
                rootNode = _renderLegacy002Js.p, createTextNode = _renderLegacy002Js.s, insertNode = _renderLegacy002Js.u;
