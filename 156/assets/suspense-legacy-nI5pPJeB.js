!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./state-legacy-CIkOTHs-.js" ], function(_export, _context) {
        var onCleanup, Suspense, createResource, createEffect, createSignal, use, createElement, onMount, setProp, createComponent, insert, createTextNode, insertNode, setGlobalBackground;
        function fadeIn(el) {
        ...
        return _export("default", function() {
            ...
            setters: [ function(_renderLegacy002Js) {
                onCleanup = _renderLegacy002Js.$, Suspense = _renderLegacy002Js.F, createResource = _renderLegacy002Js.G, 
                createEffect = _renderLegacy002Js.H, createSignal = _renderLegacy002Js.J, use = _renderLegacy002Js._, 
