!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./Column-legacy-IFAmq0kZ.js", "./theme-legacy-Bdf29FvE.js", "./state-legacy-CIkOTHs-.js" ], function(_export, _context) {
        var createComputed, createResource, createEffect, createSignal, batch, Index, on, createElement, effect, onMount, setProp, createComponent, insert, createSelector, insertNode, Column, theme_default, setGlobalBackground, gridStyles_default;
        ...
        return {
            setters: [ function(_renderLegacy002Js) {
                createComputed = _renderLegacy002Js.B, createResource = _renderLegacy002Js.G, createEffect = _renderLegacy002Js.H, 
                createSignal = _renderLegacy002Js.J, batch = _renderLegacy002Js.L, Index = _renderLegacy002Js.M, 
                on = _renderLegacy002Js.Q, createElement = _renderLegacy002Js.a, effect = _renderLegacy002Js.c, 
                onMount = _renderLegacy002Js.et, setProp = _renderLegacy002Js.h, createComponent = _renderLegacy002Js.i, 
                insert = _renderLegacy002Js.l, createSelector = _renderLegacy002Js.q, insertNode = _renderLegacy002Js.u;
