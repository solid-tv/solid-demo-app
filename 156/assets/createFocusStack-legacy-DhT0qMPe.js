!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js" ], function(_export, _context) {
        var onCleanup, createSignal, createContext, createComponent, useContext, FocusStackContext;
        return _export({
            n: function() {
            ...
            setters: [ function(_renderLegacy002Js) {
                onCleanup = _renderLegacy002Js.$, createSignal = _renderLegacy002Js.J, createContext = _renderLegacy002Js.V, 
                createComponent = _renderLegacy002Js.i, useContext = _renderLegacy002Js.ot;
            } ],
            execute: function() {
