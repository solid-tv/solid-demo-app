!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./utils-legacy-B35bImB8.js", "./chainFunctions-legacy-iSOIOqjU.js", "./Column-legacy-IFAmq0kZ.js", "./Row-legacy-C4R_D95v.js", "./styles-legacy-ByBLMtKI.js" ], function(_export, _context) {
        var onCleanup, $TRACK, hasFocus, createEffect, createSignal, createRoot, batch, Index, Config, Show, on, createMemo, use, createElement, untrack, effect, mergeProps, spread, setProp, createComponent, insert, Dynamic, insertNode, ElementNode, mod, combineStyles, clamp, defaultTransitionForward, navigableForwardFocus, defaultTransitionUp, chainRefs, defaultTransitionBack, defaultTransitionDown, chainFunctions, handleNavigation, Column, Row, buttonStyles, styles_default, SHOW_TEXT, DISPLAY_SIZE, POSTER_SCALE, scaled, heroTransition, titleRowStyles, posterStyles, posterTitleStyles, heroStyles, heroTextStyles, typeToComponent, BlockStyle;
        ...
        return _export({
            ...
            setters: [ function(_renderLegacy002Js) {
                onCleanup = _renderLegacy002Js.$, $TRACK = _renderLegacy002Js.A, hasFocus = _renderLegacy002Js.C, 
                createEffect = _renderLegacy002Js.H, createSignal = _renderLegacy002Js.J, createRoot = _renderLegacy002Js.K, 
                batch = _renderLegacy002Js.L, Index = _renderLegacy002Js.M, Config = _renderLegacy002Js.O, 
                Show = _renderLegacy002Js.P, on = _renderLegacy002Js.Q, createMemo = _renderLegacy002Js.U, 
                use = _renderLegacy002Js._, createElement = _renderLegacy002Js.a, untrack = _renderLegacy002Js.at, 
                effect = _renderLegacy002Js.c, mergeProps = _renderLegacy002Js.f, spread = _renderLegacy002Js.g, 
                setProp = _renderLegacy002Js.h, createComponent = _renderLegacy002Js.i, insert = _renderLegacy002Js.l, 
                Dynamic = _renderLegacy002Js.t, insertNode = _renderLegacy002Js.u, ElementNode = _renderLegacy002Js.v;
                ...
                defaultTransitionUp = _chainFunctionsLegacy008Js.l, chainRefs = _chainFunctionsLegacy008Js.n, 
                defaultTransitionBack = _chainFunctionsLegacy008Js.o, defaultTransitionDown = _chainFunctionsLegacy008Js.s, 
                ...
                buttonStyles = _stylesLegacy00hJs.n, styles_default = _stylesLegacy00hJs.r;
            } ],
            execute: function() {
