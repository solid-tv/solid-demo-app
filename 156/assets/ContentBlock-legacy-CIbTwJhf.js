!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./chainFunctions-legacy-iSOIOqjU.js", "./theme-legacy-Bdf29FvE.js" ], function(_export, _context) {
        var onCleanup, createEffect, createSignal, Show, createMemo, use, createElement, effect, memo, mergeProps, spread, setProp, createComponent, For, insert, createTextNode, insertNode, chainFunctions, theme_default, SAFETY_MARGIN, ContentBlockStyle, HeadlineStyles, Headline, DescriptionStyles, BadgeStyle, Description, Badge, MetaTextStyle, Metadata;
        ...
        return {
            setters: [ function(_renderLegacy002Js) {
                onCleanup = _renderLegacy002Js.$, createEffect = _renderLegacy002Js.H, createSignal = _renderLegacy002Js.J, 
                Show = _renderLegacy002Js.P, createMemo = _renderLegacy002Js.U, use = _renderLegacy002Js._, 
