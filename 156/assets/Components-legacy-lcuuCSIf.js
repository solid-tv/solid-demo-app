!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./components-legacy-CMcgiR3G.js", "./state-legacy-CIkOTHs-.js" ], function(_export, _context) {
        var onCleanup, createSignal, createRoot, children, createMemo, createElement, untrack, mergeProps, spread, setProp, createComponent, For, insert, createTextNode, Dynamic, insertNode, ElementNode, Button, setGlobalBackground;
        ...
        return {
            setters: [ function(_renderLegacy002Js) {
                onCleanup = _renderLegacy002Js.$, createSignal = _renderLegacy002Js.J, createRoot = _renderLegacy002Js.K, 
                children = _renderLegacy002Js.R, createMemo = _renderLegacy002Js.U, createElement = _renderLegacy002Js.a, 
                untrack = _renderLegacy002Js.at, mergeProps = _renderLegacy002Js.f, spread = _renderLegacy002Js.g, 
                setProp = _renderLegacy002Js.h, createComponent = _renderLegacy002Js.i, For = _renderLegacy002Js.j, 
                insert = _renderLegacy002Js.l, createTextNode = _renderLegacy002Js.s, Dynamic = _renderLegacy002Js.t, 
                insertNode = _renderLegacy002Js.u, ElementNode = _renderLegacy002Js.v;
