!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./web-legacy-CZsMP84a.js" ], function(_export, _context) {
        var createSignal, batch, on, createMemo, createContext, createRenderEffect, getOwner, untrack, startTransition, runWithOwner, useContext, resetErrorBoundaries, createComponent, depth, hasSchemeRegex, trimPathRegex, mockBase, MAX_REDIRECTS, RouterContextObj, RouteContextObj, useRouter, useLocation, intent;
        ...
        return _export({
            ...
            setters: [ function(_renderLegacy002Js) {
                createSignal = _renderLegacy002Js.J, batch = _renderLegacy002Js.L, on = _renderLegacy002Js.Q, 
                createMemo = _renderLegacy002Js.U, createContext = _renderLegacy002Js.V, createRenderEffect = _renderLegacy002Js.W, 
                getOwner = _renderLegacy002Js.X, untrack = _renderLegacy002Js.at, startTransition = _renderLegacy002Js.it, 
                runWithOwner = _renderLegacy002Js.nt, useContext = _renderLegacy002Js.ot, resetErrorBoundaries = _renderLegacy002Js.tt, 
                createComponent = _renderLegacy002Js.z;
