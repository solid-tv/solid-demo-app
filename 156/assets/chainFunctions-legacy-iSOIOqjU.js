!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./utils-legacy-B35bImB8.js" ], function(_export, _context) {
        var assertTruthy, isFocused, ElementNode, clamp, isNotShown;
        ...
        return _export({
            ...
            setters: [ function(_renderLegacy002Js) {
                assertTruthy = _renderLegacy002Js.At, isFocused = _renderLegacy002Js.T, ElementNode = _renderLegacy002Js.v;
