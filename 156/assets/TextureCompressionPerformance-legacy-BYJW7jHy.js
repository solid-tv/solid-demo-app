!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js" ], function(_export, _context) {
        var createSignal, createElement, effect, onMount, setProp, createComponent, For, insert, insertNode;
        return {
            ...
            execute: function() {
                _export("default", function() {
                    ...
                    _createSignal4[1]), _createSignal6 = _slicedToArray(createSignal("Initializing..."), 2), status = _createSignal6[0], setStatus = _createSignal6[1], _createSignal8 = _slicedToArray(createSignal(0), 2), loadedCount = _createSignal8[0], setLoadedCount = _createSignal8[1], startTime = 0, imageLoadTimes = {}, fetchImages = function() {
                        var n, _ref = (n = _regenerator().m(function _callee() {
                            ...
                            return _regenerator().w(function(_context2) {
                                for (;;) switch (_context2.n) {
                                  case 0:
                                    try {
                                        setStatus("Preparing images..."), newImages = Array.from({
                                            length: 25
                                        }, function(_, i) {
                                            var id = i + 1;
                                            return {
                                                id: "img-".concat(id),
                                                src: "".concat("/solid-demo-app/156/", "assets/ktx/image-").concat(id, ".ktx"),
                                                title: "Image ".concat(id)
                                            };
                                        }), startTime = performance.now(), setImages(newImages), setStatus("Loading... 0/".concat(25));
                                    } catch (error) {
                    ...
                    insertNode(_el$, _el$3), setProp(_el$2, "autofocus", !0), insert(_el$2, createComponent(For, {
                        ...
                        children: function(item, index) {
                            var _el$6, col = index() % 5, row = Math.floor(index() / 5), x = 175 + 377.5 * col, y = 50 + 175.5 * row;
                            ...
                            setProp(_el$6, "onEvent", {
                                loaded: function() {
                                    return function(index, id) {
                                        ...
                                        if (setLoadedCount(currentCount), setStatus("Loading... ".concat(currentCount, "/").concat(25)), 
                                        currentCount % 5 == 0 && performance.mark("images-loaded-".concat(currentCount)), 
                                        25 === currentCount) {
