!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./Column-legacy-IFAmq0kZ.js", "./Row-legacy-C4R_D95v.js" ], function(_export, _context) {
        var createSignal, Show, use, createElement, effect, setProp, createComponent, For, insert, createTextNode, insertNode, Column, Row, Items, styles, SpecialFont;
        return {
            setters: [ function(_renderLegacy002Js) {
                createSignal = _renderLegacy002Js.J, Show = _renderLegacy002Js.P, use = _renderLegacy002Js._, 
                createElement = _renderLegacy002Js.a, effect = _renderLegacy002Js.c, setProp = _renderLegacy002Js.h, 
