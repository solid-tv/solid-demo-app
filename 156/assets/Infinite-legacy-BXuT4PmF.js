!function() {
    ...
    System.register([ "./render-legacy-t4wUAioc.js", "./components-legacy-CMcgiR3G.js", "./state-legacy-CIkOTHs-.js" ], function(_export, _context) {
        var createEffect, createSignal, Show, use, createElement, effect, mergeProps, setProp, createComponent, insert, createTextNode, insertNode, List, Poster, setGlobalBackground;
        return {
            setters: [ function(_renderLegacy002Js) {
                createEffect = _renderLegacy002Js.H, createSignal = _renderLegacy002Js.J, Show = _renderLegacy002Js.P, 
                use = _renderLegacy002Js._, createElement = _renderLegacy002Js.a, effect = _renderLegacy002Js.c, 
                mergeProps = _renderLegacy002Js.f, setProp = _renderLegacy002Js.h, createComponent = _renderLegacy002Js.i, 
