                        ...
                        var n, _ref = (n = _regenerator().m(function _callee() {
                            ...
                            return _regenerator().w(function(_context2) {
                                for (;;) switch (_context2.p = _context2.n) {
                                  ...
                                  case 1:
                                    newImages = _context2.v.results.slice(0, 4).map(function(item) {
                                        return {
                                            id: item.id,
                                            src: perf.bust(getImageUrl(item.backdrop_path || item.poster_path, "original")),
                                            title: item.title
                                        };
                                    }), startTime = performance.now(), perf.start(), setImages(newImages), setStatus("Loading... 0/".concat(4)), 
                                    _context2.n = 3;
                                    break;
                            ...
                            setProp(_el$6, "y", y), setProp(_el$6, "onEvent", {
                                loaded: function() {
                                    return function(index, id) {
                                        ...
                                        if (setLoadedCount(currentCount), setStatus("Loading... ".concat(currentCount, "/").concat(4)), 
                                        performance.mark("large-images-loaded-".concat(currentCount)), 4 === currentCount) {
