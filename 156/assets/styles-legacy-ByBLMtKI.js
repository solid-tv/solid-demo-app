!function() {
    ...
    System.register([ "./theme-legacy-Bdf29FvE.js" ], function(_export, _context) {
        var theme_default, roundPoster, Button, TopBar, ButtonText, MaterialButton;
        return {
            setters: [ function(_themeLegacy00gJs) {
                theme_default = _themeLegacy00gJs.t;
            } ],
            execute: function() {
                roundPoster = "false" !== new URLSearchParams(window.location.search).get("roundPoster"), 
                _export("r", {
                    Page: {
                        width: 1920,
                        height: 1080
