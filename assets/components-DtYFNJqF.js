import { $ as onCleanup, A as $TRACK, C as hasFocus, H as createEffect, J as createSignal, K as createRoot, L as batch, M as Index, O as Config, P as Show, Q as on, U as createMemo, _ as use, a as createElement, at as untrack, c as effect, f as mergeProps, g as spread, h as setProp, i as createComponent, l as insert, t as Dynamic, u as insertNode, v as ElementNode } from "./render-o0EKBQJM.js";

import { i as mod, n as combineStyles, t as clamp } from "./utils-DGAAUPJA.js";

import { c as defaultTransitionForward, d as navigableForwardFocus, l as defaultTransitionUp, n as chainRefs, o as defaultTransitionBack, s as defaultTransitionDown, t as chainFunctions, u as handleNavigation } from "./chainFunctions-PE67vVDV.js";
...
function createVirtual(component, props, keyHandlers) {
          ...
          case "edge":
            {
                ...
                if (props.wrap) if (delta > 0) if (prev.selected < startScrolling) {
                    selected = prev.selected + 1;
                    shiftBy = 0;
    ...
    const onSelectedChanged = function(_idx, elm, _active, _lastIdx) {
        ...
        queueMicrotask(() => {
            ...
            } else this.lng[axis] = this.lng[axis] + childSize * slice().shiftBy;
        });
    };
