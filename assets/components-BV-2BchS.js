import { D as Config, G as createRoot, H as createMemo, I as batch, Q as onCleanup, S as hasFocus, V as createEffect, Z as on, _ as ElementNode, a as createElement, c as effect, g as use, h as spread, i as createComponent, it as untrack, j as Index, k as $TRACK, l as insert, m as setProp, q as createSignal, t as Dynamic, u as insertNode } from "./render-RHsi_cL1.js";

import { i as mod, n as combineStyles, t as clamp } from "./utils-_C2GWV9P.js";

import { t as mergeProps } from "./mergeProps-BM8W0ufM.js";

import { c as defaultTransitionForward, d as navigableForwardFocus, l as defaultTransitionUp, n as chainRefs, o as defaultTransitionBack, s as defaultTransitionDown, t as chainFunctions, u as handleNavigation } from "./chainFunctions-DEvkSaCc.js";
...
function Hero(props) {
    ...
    return (() => {
        var _el$0 = createElement("view"), _el$1 = createElement("view"), _el$10 = createElement("view"), _el$11 = createElement("text"), _el$12 = createElement("text");
        ...
        setProp(_el$1, "transition", {
            alpha: heroTransition
        });
        setProp(_el$10, "width", 185);
        setProp(_el$10, "height", 278);
        setProp(_el$10, "x", 54);
        setProp(_el$10, "y", 220);
        setProp(_el$11, "y", 520);
        setProp(_el$11, "x", 54);
        setProp(_el$11, "fontSize", 64);
        setProp(_el$11, "width", 1e3);
        setProp(_el$11, "maxLines", 1);
        setProp(_el$11, "style", heroTextStyles);
        insert(_el$11, () => props.item.title);
        setProp(_el$12, "y", 620);
        setProp(_el$12, "x", 60);
        setProp(_el$12, "fontSize", 21);
        setProp(_el$12, "width", 1e3);
        setProp(_el$12, "maxLines", 2);
        setProp(_el$12, "lineHeight", 36);
        setProp(_el$12, "color", 3435973887);
        setProp(_el$12, "style", heroTextStyles);
        insert(_el$12, () => props.item.overview);
        effect(_p$ => {
            var _v$ = hasFocus() ? 1 : 0, _v$2 = props.item.src;
            _v$ !== _p$.e && (_p$.e = setProp(_el$1, "alpha", _v$, _p$.e));
            _v$2 !== _p$.t && (_p$.t = setProp(_el$10, "src", _v$2, _p$.t));
            return _p$;
        }, {
            e: void 0,
            t: void 0
...
function Block(props) {
    return (() => {
        ...
        spread(_el$13, mergeProps(props, {
            width: 100,
            height: 100,
            style: BlockStyle,
            get color() {
