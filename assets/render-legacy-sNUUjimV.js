(function() {
    ...
    System.register([], function(_export, _context) {
        ...
        _export({
            ...
            at: useContext,
            b: loadFonts,
            bt: createTextureCoords,
            et: resetErrorBoundaries,
            it: untrack,
            j: Index,
            kt: createWebGLContext,
            o: createRenderer,
            p: scheduleTask,
            q: createSignal,
            rt: startTransition,
            ...
            w: isFocused,
            wt: compareRect,
            xt: isHTMLImageElement,
            yt: createIndexBuffer,
            z: createComputed,
            Et: void 0,
            mt: void 0,
            x: void 0
        ...
        return {
            ...
            execute: function execute() {
                ...
                _export("Dt", DIRTY_QUAD_BUFFER = typeof __dirtyQuadBuffer__ !== "undefined" ? __dirtyQuadBuffer__ : true);
                ...
                })(TextureType || _export("Et", TextureType = {}));
                ...
                _export("Tt", getNormalizedRgbaComponents = function getNormalizedRgbaComponents(rgba) {
                    var r = rgba >>> 24;
                    var g = rgba >>> 16 & 255;
                    var b = rgba >>> 8 & 255;
                    var a = rgba & 255;
                ...
                BYTES_PER_VERTEX = 16;
                BYTES_PER_QUAD = 16 * 4;
                _export("vt", WORDS_PER_QUAD = 64 / Uint32Array.BYTES_PER_ELEMENT);
                UV_QUANT_MAX = 65535;
                _export("_t", UNIT_TEXTURE_COORDS = createTextureCoords(0, 0, 1, 1));
                _export("ht", MAX_QUADS = 16384);
                _export("gt", MAX_QUAD_BUFFER_SIZE = MAX_QUADS * 64);
                ...
                ColorTexture = function(_Texture) {
                    ...
                    return _createClass(ColorTexture, [ {
                        ...
                        value: function buildTextureData() {
                            ...
                            var _getTextureSource = _asyncToGenerator(_regenerator().m(function _callee2() {
                                return _regenerator().w(function(_context3) {
                                    while (1) switch (_context3.n) {
                                      case 0:
                                        return _context3.a(2, this.buildTextureData());
                                    }
                                }, _callee2, this);
                            }));
                ...
                _export("ft", CoreShaderNode = function() {
                ...
                _export("dt", normalizeFontMetrics = function normalizeFontMetrics(metrics, fontSize) {
                ...
                _export("ut", mapTextLayout = function mapTextLayout(measureText, metrics, text, textAlign, fontFamily, lineHeight, overflowSuffix, wordBreak, letterSpacing, maxLines, maxWidth, maxHeight) {
                ...
                _export("ct", frameTimeBucketLowerBound = function frameTimeBucketLowerBound(index) {
                    return index < 32 ? index * 1 : 32 + (index - 32) * 8;
                });
                ...
                Stage = function() {
                    ...
                    return _createClass(Stage, [ {
                        ...
                        value: function createDefaultTexture() {
                            ...
                            this.defaultTexture = dt;
                            dt.textureData = dt.buildTextureData();
                            this.txManager.uploadTexture(dt);
                            this.requestRender();
                            dt.setRenderableOwner("stage", true);
                        }
                    }, {
                ...
                RendererMain = function(_EventEmitter4) {
                    function RendererMain(settings, target) {
                        ...
                        _this21.stage = void 0;
                        _this21.inspector = null;
                        ...
                        if (inspector && ENABLE_INSPECTOR) _this21.inspector = new inspector(canvas, settings);
                        return _this21;
                    }
                ...
                DOMNode = function(_EventEmitter5) {
                    function DOMNode(stage, props) {
                        var _this23;
                        _this23 = _callSuper(this, DOMNode);
                        _this23.stage = void 0;
                        _this23.props = void 0;
                        _this23.div = document.createElement("div");
                        _this23.divBg = void 0;
                        _this23.divBorder = void 0;
                        _this23.imgEl = void 0;
                        _this23.imageLoading = false;
                        _this23.lazyImagePendingSrc = null;
                        _this23.lazyImageSubTextureProps = null;
                        _this23.boundsDirty = true;
                        _this23.children = new Set;
                        _this23._lastStyleStr = "";
                        _this23.id = ++lastNodeId;
                        _this23.renderState = 0;
                        _this23.preventCleanup = true;
                        _this23.animate = animate;
                        _this23.stage = stage;
                        _this23.props = props;
                        _this23.div._node = _this23;
                        _this23.div.setAttribute("data-id", String(_this23.id));
                        elMap.set(_this23, _this23.div);
                        var parent = _this23.props.parent;
                        if (parent instanceof DOMNode) parent.children.add(_this23);
                        updateNodeParent(_this23);
                        updateNodeStyles(_this23);
                        updateNodeData(_this23);
                        return _this23;
                    }
                ...
                DOMText = function(_DOMNode) {
                    function DOMText(stage, props) {
                        var _this24;
                        _this24 = _callSuper(this, DOMText, [ stage, props ]);
                        _this24.props = void 0;
                        _this24.loaded = false;
                        _this24.props = props;
                        _this24.div.innerText = props.text;
                        updateNodeStyles(_this24);
                        updateDOMTextSize(_this24, false);
                        syncContainTextNodeTracking(_this24);
                        scheduleUpdateDOMTextMeasurement(_this24);
                        return _this24;
                    }
                    ...
                    return _createClass(DOMRendererMain, [ {
                        ...
                        value: function once(event, listener) {
                            ...
                            var _wrappedListener = function wrappedListener(target, data) {
                                _this25.off(event, _wrappedListener);
                                listener(target, data);
                            };
                ...
                States = function(_Array) {
                    function States(callback) {
                        ...
                        var _super = function _super() {
                            ...
                            return _this26 = _callSuper(_this27, States, [].concat(_args)), _this26.onChange = void 0, 
                        ...
                        _this26.onChange = callback;
                        return _possibleConstructorReturn(_this26, _assertThisInitialized(_this26));
                    }
                    _inherits(States, _Array);
                    return _createClass(States, [ {
                        key: "has",
                        value: function has(state) {
                            if (this.indexOf(state) >= 0) return true;
                            return state.charCodeAt(0) !== 36 && this.indexOf("$" + state) >= 0;
                        }
                    }, {
                        key: "is",
                ...
                _export("_", ElementNode = function() {
                    ...
                    return _createClass(ElementNode, [ {
                        ...
                        value: function _stateChanged() {
                            ...
                            if (this._undoStyles !== void 0 && this._undoStyles.length > 0 || keyExists(this, states)) {
                                var stylesToUndo;
                                if (this._undoStyles && this._undoStyles.length) {
                                    ...
                                    this._undoStyles.forEach(function(styleKey) {
                                        ...
                                        if (fallbackValue === void 0) fallbackValue = _this32.style[styleKey];
                                        if (false) {
