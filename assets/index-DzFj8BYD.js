...
const _Texture = class _Texture extends EventEmitter {
    constructor(txManager) {
        ...
        __publicField(this, "renderableOwners", new Set);
...
class CoreNode extends EventEmitter {
    constructor(stage, props2) {
        ...
        __publicField(this, "textureOwnership", false);
...
class ImageTexture extends Texture {
    ...
    async createImageBitmap(blob, premultiplyAlpha, sx, sy, sw, sh) {
        ...
        } else if (imageBitmapSupported.options === false && imageBitmapSupported.full === false) {
            return {
...
async function detectPremultiplyAlphaHonored(platform) {
    ...
    (_c = gl.getExtension("WEBGL_lose_context")) == null ? void 0 : _c.loseContext();
    return result;
}
...
class TextureMemoryManager {
    ...
    evictOrphanedTextures() {
        ...
        for (const texture of keyCache.values()) {
            ...
            if (evictable === true && texture.preventCleanup === false && texture.renderableOwners.size === 0 && texture.hasListeners() === false) {
...
class Stage {
    ...
    drawFrame(hasActiveAnimations = false) {
        ...
        if (this.txManager.hasUpdates() === true) {
            const processing = hasActiveAnimations === true ? this.txManager.processOne() : this.txManager.processUntil(this.options.textureProcessingTimeLimit);
...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        settings = {
            ...
            handleLoopError: (_n = settings.handleLoopError) != null ? _n : noop
        };
        ...
        this.stage = new Stage({
            ...
            platform: platform,
            maxRetryCount: (_o = settings.maxRetryCount) != null ? _o : 5,
    ...
    if (node instanceof DOMText) {
        ...
        if (rawImgSrc) {
            ...
            if (hasTint) {
                ...
                if (props2.placeholderColor !== 0) {
                    bgStyle += "background-color: ".concat(colorToRgba(props2.placeholderColor), ";");
                }
            }
...
function resolveNodeDefaults(props2) {
    ...
    return {
        ...
        ignoreParentAlpha: (_g = props2.ignoreParentAlpha) != null ? _g : false,
        autosize: (_h = props2.autosize) != null ? _h : false,
        boundsMargin: (_i = props2.boundsMargin) != null ? _i : null,
        clipping: (_j = props2.clipping) != null ? _j : false,
        color: color,
        colorTop: (_k = props2.colorTop) != null ? _k : color,
        colorBottom: (_l = props2.colorBottom) != null ? _l : color,
        colorLeft: (_m = props2.colorLeft) != null ? _m : color,
        colorRight: (_n = props2.colorRight) != null ? _n : color,
        colorBl: (_q = (_p = (_o = props2.colorBl) != null ? _o : props2.colorBottom) != null ? _p : props2.colorLeft) != null ? _q : color,
        colorBr: (_t = (_s = (_r = props2.colorBr) != null ? _r : props2.colorBottom) != null ? _s : props2.colorRight) != null ? _t : color,
        colorTl: (_w = (_v = (_u = props2.colorTl) != null ? _u : props2.colorTop) != null ? _v : props2.colorLeft) != null ? _w : color,
        colorTr: (_z = (_y = (_x = props2.colorTr) != null ? _x : props2.colorTop) != null ? _y : props2.colorRight) != null ? _z : color,
        zIndex: (_A = props2.zIndex) != null ? _A : 0,
        parent: (_B = props2.parent) != null ? _B : null,
        texture: (_C = props2.texture) != null ? _C : null,
        ...
        placeholderColor: (_X = props2.placeholderColor) != null ? _X : 0,
        data: {},
        imageType: props2.imageType
    };
}
...
const LinearGradient = {
    ...
    update(node) {
        const props2 = this.props;
        const angle = props2.angle - Math.PI / 180 * 90;
        ...
        for (let attempt = 0; attempt <= MAX_FONT_LOAD_RETRIES; attempt++) {
            try {
                ...
                if (attempt < MAX_FONT_LOAD_RETRIES) {
                    console.warn('SDF font "'.concat(fontFamily, '" failed to load (attempt ').concat(attempt + 1, " of ").concat(MAX_FONT_LOAD_RETRIES + 1, "), retrying."), error);
                }
            }
        }
        fontLoadPromises$1.delete(fontFamily);
        fontCache$1.delete(fontFamily);
        console.error("Failed to load SDF font: ".concat(fontFamily), lastError);
        throw lastError;
    })();
...
const SdfFontHandler = Object.freeze(Object.defineProperty({
    __proto__: null,
    MAX_FONT_LOAD_RETRIES: MAX_FONT_LOAD_RETRIES,
...
class WebGlRenderer extends CoreRenderer {
    constructor(options) {
        ...
        __publicField(this, "sdfBufferChanged", true);
        __publicField(this, "lastUploadedSdfSize", 0);
    ...
    reuseRenderOp(node) {
        ...
        if (curShader !== shader) {
            if (curShader.program !== shader.program || curShader.uniforms !== shader.uniforms) {
                return false;
            }
        }
    ...
    addSdfTranslatedQuads(cachedVertices, numGlyphs, dx, dy, atlasTexture, clippingRect, worldAlpha, width, height, parentHasRenderTexture, framebufferDimensions, sdfShader2) {
        if (numGlyphs === 0) {
            return;
        }
        this.sdfBufferChanged = true;
    ...
    uploadSdfBuffer() {
        ...
        if (this.sdfBufferChanged === false && this.sdfBufferIdx === this.lastUploadedSdfSize) {
            return;
        }
        const glw = this.glw;
...
const renderQuads$1 = (renderer2, layout, _vertexBuffer, renderProps) => {
    ...
    if (cache2 !== void 0 && cache2.vertices !== null) {
        ...
        if (cache2.layoutRef === layout && cache2.color === renderProps.color && cache2.alpha === renderProps.worldAlpha && ct[0] === t[0] && ct[1] === t[1] && ct[2] === t[3] && ct[3] === t[4]) {
            ...
            webGlRenderer.addSdfTranslatedQuads(cache2.vertices, cache2.glyphCount, dx, dy, ctxTexture, renderProps.clippingRect, renderProps.worldAlpha, layout.width, layout.height, renderProps.parentHasRenderTexture, renderProps.framebufferDimensions, shader);
            return null;
        }
    }
...
class CanvasRenderer extends CoreRenderer {
    ...
    renderNodeContent(node, target) {
        ...
        if (node.placeholderActive === true || texture === null) {
            texture = this.stage.defaultTexture;
        }
...
const Player = lazy(() => __vitePreload(() => import("./Player-CXHihKvm.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-CKOR2z1a.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DjrIl90G.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-6qsrDCw0.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-Cf5mEXkJ.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-Bsj2CqaD.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-DHcDHIDd.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-L5XvRDBL.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-D9qxJwKO.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-BdWsirkB.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-6hCC0--F.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-DehmhKyr.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-DMCYZFpa.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-iw2paGBZ.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DtosKfHl.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-_OOShkqz.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-B381Vtk_.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-CKSobkoi.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BYzsY8Dl.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BIZKL4qu.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-MtuHxwdZ.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-Dq8b03Vi.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BfBVwso0.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-zR2og1_s.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-IS_7O55l.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-zETXgYqn.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-BAthodbB.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-iCcM2b74.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-CuqIO-PD.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-DI-8LQke.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CghFEza9.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-YG7-9GPj.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-TUIkohgn.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-DmH2QZnR.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-BaZsmPCI.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-pi8_8FDx.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-DNGEyfaK.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-3zIZLPYr.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-nhpsbfv8.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-Di0L9esT.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-C0Lvhe-o.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-WfO_EuS9.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-Bzcey-B8.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-ClZ-0YvN.js"), true ? [] : void 0));
                        ...
                        return [ createComponent(Route, {
                            ...
                            get children() {
                                return [ createComponent(Route, {
                                    ...
                                    path: "nested",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./Nested-C-GeL9-l.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "textposter",
                                    ...
                                    path: "keepalive",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./KeepAlive-11BLeJVV.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "suspense",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./suspense-BB8O6ERM.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "superflex",
