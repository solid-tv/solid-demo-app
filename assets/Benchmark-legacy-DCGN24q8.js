(function() {
    ...
    System.register([ "./render-legacy-BgUCmiUl.js", "./Lazy-legacy-DtxijRuz.js", "./FPSCounter-legacy-Bv3GRpsJ.js", "./ContentBlock-legacy-Dz432To1.js", "./createFocusStack-legacy-BGIA4NbM.js", "./components-legacy-BUaTspyO.js", "./styles-legacy-BOzjtbic.js", "./state-legacy-JVYMUv7r.js", "./dist-legacy-C1dl_1cU.js" ], function(_export, _context) {
        "use strict";
        ...
        return {
            ...
            execute: function execute() {
                ...
                _export("default", Benchmark = function Benchmark(props) {
                    ...
                    var totalAnimationMs = 0;
                    var totalFlushMs = 0;
                    var worstMaxAnimationMs = 0;
                    var worstMaxFlushMs = 0;
                    ...
                    function _runBenchmark() {
                        _runBenchmark = _asyncToGenerator(_regenerator().m(function _callee() {
                            var _props$data, _currentCaps$webGlVer, _currentCaps$vertexAr, totalRows, cycle, i, _i3, avgAnimatedFps, avgFps, minFps, maxFps, animP95, animP99, allP95, allP99, avgActiveAnims, meanUploadCost, meanKeyDispatch, worstKeyPresses, calculatedStats, currentCaps, benchmarkResultsJson, animRateStr;
