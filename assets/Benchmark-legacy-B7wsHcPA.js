(function() {
    ...
    System.register([ "./index-legacy-DNSIlMWB.js" ], function(exports, module) {
        "use strict";
        var onCleanup, createSignal, useFocusStack, createEffect, renderer, debounce, setGlobalBackground, on, activeElement, createComponent, Show, View, Text, ContentBlock, LazyColumn, LazyRow, Hero, TitleRow, styles, memo, AssetPanel, resetCounter, batch;
        return {
            setters: [ function(module) {
                ...
                LazyColumn = module.a4;
                LazyRow = module.L;
                Hero = module.aa;
                TitleRow = module.a5;
                styles = module.K;
                memo = module.J;
                AssetPanel = module.ab;
                resetCounter = module.ac;
                batch = module.e;
            } ],
...
//# sourceMappingURL=Benchmark-legacy-B7wsHcPA.js.map
