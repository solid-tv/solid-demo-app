...
function createWebGLContext(canvas2, contextSpy) {
    const config = {
        alpha: true,
        antialias: false,
        depth: false,
    ...
    const gl = canvas2.getContext("webgl", config) || canvas2.getContext("experimental-webgl", config);
    if (!gl) {
    ...
    getImage(src, premultiplyAlpha, sx, sy, sw, sh) {
        return new Promise((resolve, reject) => {
            try {
                ...
                if (nextWorkerIndex !== -1 && this.workerLoad[nextWorkerIndex] > 0 && this.workers.length < this.maxWorkers) {
                    this.spawnWorker();
...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        settings = {
            ...
            textLayoutCacheSize: (_c = settings.textLayoutCacheSize) != null ? _c : 250,
            numImageWorkers: settings.numImageWorkers !== void 0 ? settings.numImageWorkers : 2,
            enableContextSpy: (_d = settings.enableContextSpy) != null ? _d : false,
...
const Player = lazy(() => __vitePreload(() => import("./Player-9AZLAddU.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-B-sdRJBC.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-Dmiv8FGi.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BQQFi9n6.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-kLXzJyoZ.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-CKJf-h0B.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-kkOEyhpU.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-DHVKpDeF.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-BxxxxSce.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-fBG4q04l.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-BTVzQrDy.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-Byu0zToS.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CRP1GPBO.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-DqKy_-uH.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-CIN0clGm.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-BC79EAkw.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-fXAzBhcH.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-C3T5XFuT.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-bUXWmltb.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-Cocf63Gy.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-9ohqO0eY.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-BJPZA1VT.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CYIa3qs8.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-BQmQGro0.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-Bz5XpnOy.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-joMWlxtA.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Bxoq-aZk.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-CnS3IDl8.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DuPa4SN9.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-DoVSYRpQ.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-NUXjFm1v.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-BHQddDLy.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-BZu67FO0.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-sZ-nhIWy.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-tQKWy5cR.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-B86h86AR.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-VFCAPUHw.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-jbwr5MvN.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-BkZNNpZn.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-GKZeGHxy.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-wgp2wpZs.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-D-0DsSgH.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-DuqD6jaj.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-CYJBImEa.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-B0UayhrP.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-W4hS-dv4.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-CP1nFV4i.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
...
//# sourceMappingURL=index-BWNx3kiE.js.map
