(function() {
    ...
    System.register([ "./index-legacy-CWh80G35.js" ], function(exports, module) {
        "use strict";
        var createSignal, useFocusStack, createEffect, debounce, setGlobalBackground, on, activeElement, createComponent, View, Text, ContentBlock, LazyColumn, LazyRow, Hero, TitleRow, styles, memo, AssetPanel, renderer, batch;
        return {
            setters: [ function(module) {
                createSignal = module.a;
                useFocusStack = module.D;
                createEffect = module.g;
                debounce = module.z;
                setGlobalBackground = module.s;
                on = module.i;
                activeElement = module.A;
                createComponent = module.c;
                View = module.V;
                Text = module.T;
                ContentBlock = module.B;
            ...
            execute: function execute() {
                ...
                var Benchmark = exports("default", function(props) {
                    ...
                    var _createSignal7 = createSignal(null), _createSignal8 = _slicedToArray(_createSignal7, 2), avgFps = _createSignal8[0], setAvgFps = _createSignal8[1];
                    var _createSignal9 = createSignal(false), _createSignal0 = _slicedToArray(_createSignal9, 2), benchmarkRunning = _createSignal0[0], setBenchmarkRunning = _createSignal0[1];
                    var _createSignal1 = createSignal(false), _createSignal10 = _slicedToArray(_createSignal1, 2), benchmarkDone = _createSignal10[0], setBenchmarkDone = _createSignal10[1];
                    var fpsValues = [];
                                ...
                                while (1) switch (_context.n) {
                                  ...
                                  case 10:
                                    ...
                                    if (fpsValues.length > 0) {
                                        ...
                                        setAvgFps(avg);
                                        setBenchmarkStatus("Done — Avg: ".concat(avg.toFixed(1), " FPS | Min: ").concat(min.toFixed(1), " | Max: ").concat(max.toFixed(1), " | Samples: ").concat(fpsValues.length));
                                    } else {
                                    ...
                                    return [ createComponent(Text, {
                                        ...
                                        return memo(function() {
                                            ...
                                            get color() {
                                                return memo(function() {
                                                    return avgFps() >= 55;
                                                })() ? 16746751 : avgFps() >= 30 ? 4291559679 : 4282664191;
                                            },
                                            get children() {
                                                return [ "Average FPS: ", memo(function() {
...
//# sourceMappingURL=Benchmark-legacy-CsclNC3M.js.map
