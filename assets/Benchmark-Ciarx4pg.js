import { A as For, D as Config, I as batch, N as Show, O as activeElement, Q as onCleanup, V as createEffect, Z as on, a as createElement, c as effect, ct as frameTimeBucketLowerBound, d as memo, g as use, i as createComponent, l as insert, m as setProp, q as createSignal, s as createTextNode, u as insertNode, x as renderer } from "./render-D3oWDwIw.js";

import { n as LazyRow, t as LazyColumn } from "./Lazy-CfzmQFvj.js";

import { n as resetCounter } from "./FPSCounter-DOFY9TLA.js";

import { t as ContentBlock } from "./ContentBlock-Bzos5Df7.js";

import { n as useFocusStack } from "./createFocusStack-0kSgLHBI.js";

import { a as Hero, i as DISPLAY_SIZE, s as SHOW_TEXT, t as AssetPanel, u as TitleRow } from "./components-DjCuvpxU.js";
...
var Benchmark = props => {
    ...
    let cumulativeAllBuckets = createZeroArray(45);
    let cumulativeAnimBuckets = createZeroArray(45);
    ...
    function attachFpsListener() {
        ...
        root.on("fpsUpdate", (_target, fpsData) => {
            ...
            if (typeof fps === "number" && fps > 0) fpsValues.push(fps);
            if (typeof fpsData === "object" && fpsData !== null) {
                ...
                if (typeof payload.meanActiveAnimations === "number") activeAnimationsWeightedSum += payload.meanActiveAnimations * (payload.renderedFrames || 0);
    ...
    async function runBenchmark() {
        ...
        fpsValues = [];
        animatedFpsValues = [];
        cumulativeAllBuckets = createZeroArray(45);
        cumulativeAnimBuckets = createZeroArray(45);
        ...
        const avgActiveAnims = totalRenderedFrames > 0 ? activeAnimationsWeightedSum / totalRenderedFrames : 0;
    ...
    return createComponent(Show, {
        ...
        get children() {
            ...
            insertNode(_el$14, createTextNode(`Benchmark (version: 1.8.0)`));
            setProp(_el$14, "x", 20);
            setProp(_el$14, "y", 16);
