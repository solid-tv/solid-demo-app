(function() {
    ...
    System.register([ "./render-legacy-BO_iU_BL.js" ], function(_export, _context) {
        "use strict";
        var createEffect, createSignal, getOwner, createElement, effect, memo, onCleanup, use, createComponent, Config, insert, setProp, createRoot, insertNode;
        function createPersistentComponent(fn) {
            ...
            return function(p) {
                ...
                if (dispose == null) createRoot(function(d) {
                    dispose = d;
                    result = fn(props);
                }, detachedOwner);
        ...
        function getElementRect(el) {
            ...
            while (curr != null) {
                x += curr.x;
                y += curr.y;
                if (curr.scaleX != null) x += curr.width / 2 * (1 - curr.scaleX);
                if (curr.scaleY != null) y += curr.height / 2 * (1 - curr.scaleY);
                curr = curr.parent;
            }
