(function() {
    ...
    System.register([ "./render-legacy-zhspBKrd.js", "./chainFunctions-legacy-BbsnBFhX.js", "./theme-legacy-CRa-Zkyx.js" ], function(_export, _context) {
        "use strict";
        var onCleanup, createEffect, createSignal, Show, createMemo, use, createElement, effect, memo, mergeProps, spread, setProp, createComponent, For, insert, createTextNode, insertNode, chainFunctions, theme_default, SAFETY_MARGIN, blockWidth, ContentBlockStyle, HeadlineStyles, Headline, DescriptionStyles, BadgeStyle, Description, Badge, MetaTextStyle, Metadata, ContentBlock;
