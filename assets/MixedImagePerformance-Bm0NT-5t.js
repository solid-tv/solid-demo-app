import { M as For, Y as createSignal, a as createElement, c as effect, i as createComponent, l as insert, m as setProp, tt as onMount, u as insertNode } from "./render-CkIU5n3A.js";

import { n as getImageUrl, t as api_default } from "./api-BiLDTsHT.js";

import { t as createImagePerfRun } from "./imagePerf-DErG7wpH.js";
...
var MixedImagePerformance = () => {
    ...
    const perf = createImagePerfRun("image-mixed", totalImages);
    ...
    return (() => {
        ...
        insert(_el$2, createComponent(For, {
            ...
            children: (item, index) => {
                ...
                const startX = 120;
                const startY = 750;
                const x = startX + posterIndex * 170;
                const y = startY;
                return (() => {
...
//# sourceMappingURL=MixedImagePerformance-Bm0NT-5t.js.map