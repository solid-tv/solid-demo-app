    ...
    System.register([], function(_export, _context) {
        ...
        function createImageWorker() {
            ...
            self.onmessage = function(event) {
                ...
                var batch = event.data.batch;
                for (var i = 0; i < batch.length; i++) handleRequest(batch[i]);
            };
        }
        ...
        return {
            ...
            execute: function execute() {
                ...
                _export("bt", DIRTY_QUAD_BUFFER = typeof __dirtyQuadBuffer__ !== "undefined" ? __dirtyQuadBuffer__ : true);
                ...
                })(TextureType || _export("yt", TextureType = {}));
                ...
                _export("vt", getNormalizedRgbaComponents = function getNormalizedRgbaComponents(rgba) {
                    var r = rgba >>> 24;
                    var g = rgba >>> 16 & 255;
                    var b = rgba >>> 8 & 255;
                    var a = rgba & 255;
                ...
                })(UpdateType || _export("mt", UpdateType = {}));
                CoreNode = function(_EventEmitter2) {
                    function CoreNode(stage, props) {
                        ...
                        _this6.onTextureLoaded = function(_, dimensions) {
                            ...
                            _this6.applyAutosizeDimensions(dimensions.w, dimensions.h);
                        ...
                        p.src = null;
                        p.scale = null;
                        _this6.hasColorProps = _this6.computeHasColorProps();
                    ...
                    return _createClass(CoreNode, [ {
                        ...
                        value: function draw(renderer) {
                            ...
                            var quadIdx = this.renderOpBufferIdx / 16 * 6 * 2;
                ...
                AnimationManager = function() {
                    ...
                    return _createClass(AnimationManager, [ {
                        ...
                        value: function applyValues(anim) {
                            ...
                            if (anim.shaderProps && anim.node.shader) for (var _key7 in anim.shaderProps) {
                ...
                ImageWorkerManager = function() {
                    function ImageWorkerManager(createImageBitmapSupport) {
                        var _this7 = this;
                        ...
                        this.flushTask = function() {
                            _this7.flushScheduled = false;
                            var pending = _this7.pending;
                            var count = pending.length;
                            if (count === 0) return;
                            if (_this7.worker === null) try {
                                _this7.spawnWorker();
                            } catch (e) {}
                            var worker = _this7.worker;
                            if (worker === null) {
                                for (var i = 0; i < count; i++) {
                                    var id = pending[i].id;
                                    var msg = _this7.messageManager.get(id);
                                    if (msg !== void 0) {
                                        _this7.messageManager.delete(id);
                                        msg[1](new Error("No image worker available"));
                                    }
                                }
                                pending.length = 0;
                                return;
                    ...
                    return _createClass(ImageWorkerManager, [ {
                        ...
                        value: function handleWorkerError(event) {
                        ...
                        value: function spawnWorker() {
                            ...
                            var blobURL = urlFactory.createObjectURL(blob);
                            var worker = new Worker(blobURL);
                            urlFactory.revokeObjectURL(blobURL);
                            worker.onmessage = function(event) {
                                return _this8.handleMessage(event);
                            };
                            worker.onerror = function(event) {
                                return _this8.handleWorkerError(event);
                            };
                        ...
                        value: function getImage(src, premultiplyAlpha, sx, sy, sw, sh) {
                            ...
                            return new Promise(function(resolve, reject) {
                                ...
                                _this9.messageManager.set(id, [ resolve, reject ]);
                                _this9.pending.push({
                                    id: id,
                                    src: src,
                                ...
                                if (_this9.flushScheduled === false) {
                                    _this9.flushScheduled = true;
                                    queueMicrotask(_this9.flushTask);
                                }
                            });
                        }
                    } ]);
                ...
                _export("pt", uploadCompressedTexture = {
                    ktx: uploadKTX,
                    pvr: uploadPVR,
                    astc: uploadASTC
                });
                ...
                subTextureId = 0;
                _export("ft", SubTexture = function(_Texture4) {
                ...
                CoreTextureManager = function(_EventEmitter3) {
                    function CoreTextureManager(stage, settings) {
                        ...
                        _this15.keyCache = new Map;
                        _this15.txConstructors = {};
                        _this15.maxRetryCount = void 0;
                        _this15.uploadTextureQueue = new TextureUploadQueue;
                        _this15.pendingLoads = 0;
                        _this15.initialized = false;
                        _this15.stage = void 0;
                        _this15.numImageWorkers = void 0;
                        _this15.imageDecodeConcurrency = void 0;
                        _this15.decodeGate = null;
                        _this15.platform = void 0;
                        _this15.imageWorkerManager = null;
                        _this15.hasCreateImageBitmap = false;
                        _this15.imageBitmapSupported = {
                            basic: false,
                            options: false,
                            full: false,
                            premultiplyHonored: null
                        };
                        _this15.hasWorker = !!self.Worker;
                        _this15.renderer = void 0;
                        ...
                        _this15.imageDecodeConcurrency = imageDecodeConcurrency;
                        if (createImageBitmapSupport === "auto") validateCreateImageBitmap(_this15.platform).then(function(result) {
                            _this15.resolvePremultiplyAndInit(result, premultiplyAlphaHonored);
                        }).catch(function() {
                        ...
                        }); else _this15.resolvePremultiplyAndInit({
                    ...
                    return _createClass(CoreTextureManager, [ {
                        ...
                        value: function uploadQueued(texture) {
                            if (this.isTextureDead(texture)) return;
                            if (texture.textureData !== null) {
                                try {
                                    this.uploadTexture(texture);
                                } catch (error) {
                        ...
                        value: function refetchAndUpload(texture) {
                            ...
                            texture.getTextureData().then(function() {
                                if (_this17.isTextureDead(texture) || texture.textureData === null) return;
                                _this17.uploadTexture(texture);
                            }).catch(function(error) {
                                console.error("Failed to upload texture:", error);
                            });
                        }
                ...
                Stage = function() {
                    ...
                    return _createClass(Stage, [ {
                        ...
                        value: function drawFrame() {
                            ...
                            renderer.render();
                            if (this.txManager.hasUpdates() === true) if (hasActiveAnimations === true) this.txManager.processOne(); else this.txManager.processUntil(this.options.textureProcessingTimeLimit);
                            if (true) {
                                this.calculateFps();
                            ...
                            for (var _i14 = 0, _len6 = timedNodes.length; _i14 < _len6; _i14++) if (timedNodes[_i14].isRenderable === true) {
                                this.requestRender();
                                break;
                            }
                        ...
                        value: function flushFrameEvents() {
                            var _iterator16 = _createForOfIteratorHelper(this.frameEventQueue), _step16;
                            try {
                                for (_iterator16.s(); !(_step16 = _iterator16.n()).done; ) {
                                    var _step16$value = _slicedToArray(_step16.value, 2), name = _step16$value[0], data = _step16$value[1];
                ...
                WebPlatform = function(_Platform) {
                    ...
                    return _createClass(WebPlatform, [ {
                        ...
                        value: function(_createImageBitmap2) {
                            function createImageBitmap(_x25, _x26, _x27, _x28, _x29, _x30) {
                ...
                RendererMain = function(_EventEmitter4) {
                    function RendererMain(settings, target) {
                        ...
                        settings = {
                            ...
                            boundsMargin: (_settings$boundsMargi = settings.boundsMargin) !== null && _settings$boundsMargi !== void 0 ? _settings$boundsMargi : 200,
                    ...
                    return _createClass(RendererMain, [ {
                        ...
                        value: function getNodeById(id) {
                            ...
                            var _findNode = function findNode(node) {
                                ...
                                var _iterator17 = _createForOfIteratorHelper(node.children), _step17;
                                try {
                ...
                AnimationController = function() {
                    function AnimationController(node, props, rawSettings) {
                        ...
                        for (var _i15 = 0, _Object$entries = Object.entries(props); _i15 < _Object$entries.length; _i15++) {
                            var _Object$entries$_i = _slicedToArray(_Object$entries[_i15], 2), prop = _Object$entries$_i[0], value = _Object$entries$_i[1];
                ...
                DOMNode = function(_EventEmitter5) {
                    ...
                    return _createClass(DOMNode, [ {
                        ...
                        value: function markChildrenBoundsDirty() {
                            var _iterator18 = _createForOfIteratorHelper(this.children), _step18;
                            try {
                ...
                DOMRendererMain = function() {
                    ...
                    return _createClass(DOMRendererMain, [ {
                        ...
                        value: function emit(event, targetOrData, maybeData) {
                            ...
                            for (var _i16 = 0, _Array$from = Array.from(listeners); _i16 < _Array$from.length; _i16++) {
                                var listener = _Array$from[_i16];
                                try {
                                    listener(target, data);
                                } catch (error) {
                ...
                States = function(_Array) {
                    function States(callback) {
                        ...
                        var _super = function _super() {
                            for (var _len8 = arguments.length, _args = new Array(_len8), _key0 = 0; _key0 < _len8; _key0++) {
                ...
                flattenKeyMap = function flattenKeyMap(keyMap, targetMap) {
                    ...
                    var _loop6 = function _loop6() {
                        var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i17], 2), key = _Object$entries2$_i[0], value = _Object$entries2$_i[1];
                        if (Array.isArray(value)) value.forEach(function(v) {
                            newTargetMap[v] = key;
                        }); else if (value === null) delete newTargetMap[key]; else newTargetMap[value] = key;
                    };
                    for (var _i17 = 0, _Object$entries2 = Object.entries(keyMap); _i17 < _Object$entries2.length; _i17++) {
                        _loop6();
                    }
                    return newTargetMap;
                };
                ...
                findSuppression = function findSuppression(ids) {
                    var _iterator19 = _createForOfIteratorHelper(ids), _step19;
                    try {
                ...
                liftSuppression = function liftSuppression(ids) {
                    ...
                    if (!found) return;
                    var _iterator20 = _createForOfIteratorHelper(found.ids), _step20;
                    try {
                ...
                _export("_", ElementNode = function() {
                    ...
                    return _createClass(ElementNode, [ {
                        ...
                        set: function set(v) {
                            ...
                            var _iterator21 = _createForOfIteratorHelper(EFFECT_SHADER_KEYS), _step21;
                            try {
                        ...
                        value: function emit(event) {
                            ...
                            for (var _len9 = arguments.length, args = new Array(_len9 > 1 ? _len9 - 1 : 0), _key1 = 1; _key1 < _len9; _key1++) {
                        ...
                        value: function render(topNode) {
                            ...
                            if (node.onEvent) {
                                ...
                                for (var _i18 = 0, _Object$entries3 = Object.entries(node.onEvent); _i18 < _Object$entries3.length; _i18++) {
                                    _loop7();
                                }
                            }
                ...
                var _iterator23 = _createForOfIteratorHelper(LightningRendererNumberProps), _step23;
                try {
                ...
                var _iterator24 = _createForOfIteratorHelper(LightningRendererNonAnimatingProps), _step24;
                try {
