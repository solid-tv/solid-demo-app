!function() {
    ...
    System.register([], function(_export, _context) {
        ...
        return _export({
            ...
            H: createMemo,
            Ht: function(canvas) {
                var forceWebGL2 = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], contextSpy = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, config = {
                    alpha: !0,
                    antialias: !1,
                    depth: !1,
                    stencil: !1,
                    desynchronized: !1,
                    powerPreference: arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "default",
            ...
            Pt: function(radius, width, height) {
            ...
            tt: runWithOwner,
            vt: isAdvancedShaderProp,
            w: isFocused,
            yt: resolveShaderProps,
            z: createComputed,
            zt: void 0,
            Et: void 0,
            St: void 0,
            ...
            execute: function() {
                ...
                }(), _export("Bt", closeImageBitmap = function(data) {
                ...
                }(TextureType || _export("zt", TextureType = {})), _export("Rt", Texture = function(_EventEmitter) {
                ...
                }, _export("At", WORDS_PER_QUAD = 64 / Uint32Array.BYTES_PER_ELEMENT), UV_QUANT_MAX = 65535, 
                _export("kt", createTextureCoords(0, 0, 1, 1)), _export("Dt", MAX_QUADS = 16384), 
                _export("Ot", 64 * MAX_QUADS), function(CoreNodeRenderState) {
                ...
                }(UpdateType || _export("Et", UpdateType = {})), CoreNode = function(_EventEmitter2) {
                    function CoreNode(stage, props) {
                        ...
                        _this5.numQuads = 0, _this5.renderOpTexture = null, _this5.hasShaderUpdater = !1, 
                        _this5.hasShaderTimeFn = !1, _this5.hasColorProps = !1, _this5.textureLoaded = !1, 
                        _this5.textureOwnership = !1, _this5.placeholderActive = !1, _this5.updateType = 0, 
                        _this5.childUpdateType = 0, _this5.globalTransform = void 0, _this5.localTransform = void 0, 
                        _this5.renderCoords = void 0, _this5.renderBound = void 0, _this5.clippingRect = NO_CLIPPING_RECT, 
                        _this5.textureCoords = void 0, _this5.updateShaderUniforms = !1, _this5.isRenderable = !1, 
                        _this5.renderState = CoreNodeRenderState.Init, _this5.isSimple = !0, _this5._localIsTranslate = !0, 
                        _this5._hasContainResize = !1, _this5._hasMount = !1, _this5._globalIsTranslate = !0, 
                        _this5.worldAlpha = 1, _this5.premultipliedColorTl = 0, _this5.premultipliedColorTr = 0, 
                        _this5.premultipliedColorBl = 0, _this5.premultipliedColorBr = 0, _this5.calcZIndex = 0, 
                        _this5.destroyed = !1, _this5.loadTextureTask = function() {
                ...
                }(), _export("wt", ImageTexture = function(_Texture2) {
                ...
                _export("xt", TextureError = function(_Error) {
                ...
                }(), _export("bt", CoreTextureManager = function(_EventEmitter3) {
                    ...
                    var _loadTexture;
                }(EventEmitter)), _export("_t", function() {
                ...
                }(), spaceRegex = /[ \u200B]+/g, _export("mt", {
                    ascender: 800,
                    descender: -200,
                    lineGap: 200,
                    unitsPerEm: 1e3
                }), _export("gt", function(metrics, fontSize) {
                    ...
                    baselineMode = mode;
                }, _export("ht", function(measureText, metrics, text, textAlign, fontFamily, lineHeight, overflowSuffix, wordBreak, letterSpacing, maxLines, maxWidth, maxHeight) {
                    ...
                    return _inherits(WebPlatform, _Platform), _createClass(WebPlatform, [ {
                        ...
                        value: function(stage) {
                            var _this21 = this, isIdle = !1, lastFrameTime = 0, lastTickTime = 0, scheduled = !1, nextFrameTime = 0, requestLoop = function() {
                                return requestAnimationFrame(_runLoop);
                            }, tick = function(currentTime) {
                                if (!0 !== stage.isContextLost) {
                                    var targetFrameTime = stage.targetFrameTime, timerPacing = targetFrameTime > 0 && "timer" === stage.options.framePacing;
                                    if (!0 === timerPacing) {
                                    ...
                                    isIdle = !1, !0 === timerPacing && (!function(currentTime, targetFrameTime) {
                                        (nextFrameTime += targetFrameTime) - currentTime < targetFrameTime / 2 && (nextFrameTime = currentTime + targetFrameTime);
                                        var delay = nextFrameTime - _this21.getTimeStamp();
                                        setTimeout(requestLoop, Math.min(Math.max(delay, 0), targetFrameTime));
                                    }(currentTime, targetFrameTime), scheduled = !0), stage.drawFrame(hasActiveAnimations), 
                                    stage.flushFrameEvents(), !1 === timerPacing && (requestAnimationFrame(_runLoop), 
                                    scheduled = !0);
                                }
                            }, _runLoop = function() {
                    ...
                    function RendererMain(settings, target) {
                        ...
                        if (_this22.canvas = canvas, canvas.width = deviceLogicalWidth * devicePhysicalPixelRatio, 
                        canvas.height = deviceLogicalHeight * devicePhysicalPixelRatio, canvas.style.width = "".concat(deviceLogicalWidth, "px"), 
                        canvas.style.height = "".concat(deviceLogicalHeight, "px"), _this22.stage = new Stage({
                            appWidth: appWidth,
                            appHeight: appHeight,
                        ...
                        }), _this22.root = _this22.stage.root, target) {
                            var targetEl;
                        ...
                        return inspector && ENABLE_INSPECTOR && (_this22.inspector = new inspector(canvas, settings)), 
                        _this22;
                    }
                ...
                animationTasks = [], animationFrameRequested = !1, AnimationController = function() {
                    return _createClass(function(node, props, rawSettings) {
                        ...
                        value: function() {
                            var _this$stopPromise, _this23 = this;
                ...
                DOMText = function(_DOMNode) {
                    function DOMText(stage, props) {
                        var _this25;
                        return (_this25 = _callSuper(this, DOMText, [ stage, props ])).props = void 0, _this25.loaded = !1, 
                        _this25.props = props, _this25.div.innerText = props.text, updateNodeStyles(_this25), 
                        updateDOMTextSize(_this25, !1), syncContainTextNodeTracking(_this25), scheduleUpdateDOMTextMeasurement(_this25), 
                        _this25;
                    }
                    ...
                    function DOMNode(stage, props) {
                        var _this24;
                        (_this24 = _callSuper(this, DOMNode)).stage = void 0, _this24.props = void 0, _this24.div = document.createElement("div"), 
                        _this24.divBg = void 0, _this24.divBorder = void 0, _this24.imgEl = void 0, _this24.imageLoading = !1, 
                        _this24.lazyImagePendingSrc = null, _this24.lazyImageSubTextureProps = null, _this24.boundsDirty = !0, 
                        _this24.children = new Set, _this24._lastStyleStr = "", _this24.id = ++lastNodeId, 
                        _this24.renderState = 0, _this24.preventCleanup = !0, _this24.animate = animate, 
                        _this24.stage = stage, _this24.props = props, _this24.div._node = _this24, _this24.div.setAttribute("data-id", String(_this24.id)), 
                        elMap.set(_this24, _this24.div);
                        var parent = _this24.props.parent;
                        return parent instanceof DOMNode && parent.children.add(_this24), updateNodeParent(_this24), 
                        updateNodeStyles(_this24), updateNodeData(_this24), _this24;
                    }
                    ...
                    return _createClass(function(settings, rawTarget) {
                        ...
                        key: "once",
                        value: function(event, listener) {
                            var _this26 = this, _wrappedListener = function(target, data) {
                                _this26.off(event, _wrappedListener), listener(target, data);
                            };
                    ...
                    function States(callback) {
                        var _this27, _this28 = this, initialState = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, _super = function() {
                            for (var _len8 = arguments.length, _args = new Array(_len8), _key9 = 0; _key9 < _len8; _key9++) _args[_key9] = arguments[_key9];
                            return (_this27 = _callSuper(_this28, States, [].concat(_args))).onChange = void 0, 
                        ...
                        }))), _this27.onChange = callback, _possibleConstructorReturn(_this27, _assertThisInitialized(_this27));
                    }
                    ...
                    return _createClass(function(name) {
                        ...
                        value: function() {
                            ...
                            this.lng.on("loaded", function() {
                                schedulePostMutation(), _this30.parent.updateLayout();
                            });
                        }
                    }, {
                        key: "getText",
                        ...
                        value: function() {
                            ...
                            if (void 0 !== this._undoStyles && this._undoStyles.length > 0 || function(obj, keys) {
                                ...
                                this._undoStyles && this._undoStyles.length && (stylesToUndo = {}, this._undoStyles.forEach(function(styleKey) {
                                    ...
                                    void 0 === fallbackValue && (fallbackValue = _this33.style[styleKey]), stylesToUndo[styleKey] = fallbackValue;
                                }));
