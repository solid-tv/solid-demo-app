!function() {
    ...
    System.register([ "./render-legacy-1jX59Y6X.js", "./mergeProps-legacy-8amjdkoE.js" ], function(_export, _context) {
        var createElement, spread, insert, setProp, createSignal, createTextNode, insertNode, mergeProps, validateArrayLength4, Default, fpsStyle, fpsLabel, fpsValue, fps, setFps, avgFps, setAvgFps, minFps, setMinFps, maxFps, setMaxFps, quads, setQuads, criticalThresholdSignal, setCriticalThresholdSignal, targetThresholdSignal, setTargetThresholdSignal, renderableMemUsedSignal, setRenderableMemUsedSignal, memUsedSignal, setMemUsedSignal, renderableTexturesLoadedSignal, setRenderableTexturesLoadedSignal, loadedTexturesSignal, setLoadedTexturesSignal, renderOps, setRenderOps, count, totalFps, calcFps, frameCount;
        ...
        return _export({
            ...
            setters: [ function(_renderLegacy002Js) {
                createElement = _renderLegacy002Js.a, spread = _renderLegacy002Js.h, insert = _renderLegacy002Js.l, 
                ...
                validateArrayLength4 = function(value) {
                    ...
                    return e = function(renderer, config, resolvedProps) {
                        ...
                        value: function(node, currentRenderOp) {
                            ...
                            var shader = node.props.shader, opShader = currentRenderOp.shader;
                            if (shader === opShader) return !0;
                            if (null === shader || null === opShader) return !1;
                            if (shader.uniforms === opShader.uniforms) return !0;
                            var shaderPropsA = shader.resolvedProps, shaderPropsB = opShader.resolvedProps;
                        ...
                        key: "bindRenderOp",
                        value: function(renderOp, buffer) {
                            this.bindTexture(renderOp.renderOpTexture), this.bindBufferCollection(buffer);
                            var pixelRatio = renderOp.stage.pixelRatio, resolutionW = this.glw.canvasW, resolutionH = this.glw.canvasH;
                    ...
                    } ]) && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", {
                        writable: !1
                    }), e;
                    var e, r, t;
                }()), fpsStyle = {
