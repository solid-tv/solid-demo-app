import { a as createSignal, D as useFocusStack, g as createEffect, z as debounce, s as setGlobalBackground, i as on, A as activeElement, c as createComponent, V as View, T as Text, B as ContentBlock, a3 as LazyColumn, L as LazyRow, a8 as Hero, a4 as TitleRow, K as styles, J as memo, a9 as AssetPanel, aa as renderer, e as batch } from "./index-BKz-5mRh.js";
...
const Benchmark = props => {
    ...
    const [avgFps, setAvgFps] = createSignal(null);
        ...
        get children() {
            return [ createComponent(View, {
                ...
                get children() {
                    ...
                    }), memo(() => memo(() => avgFps() !== null)() && createComponent(Text, {
                        x: 20,
                        y: 84,
                        style: overlayStatusStyle,
                        get color() {
                            return memo(() => avgFps() >= 55)() ? 16746751 : avgFps() >= 30 ? 4291559679 : 4282664191;
                        },
                        get children() {
                            return [ "Average FPS: ", memo(() => avgFps().toFixed(1)) ];
                        }
                    })) ];
                }
...
//# sourceMappingURL=Benchmark-C2YuWqkQ.js.map
