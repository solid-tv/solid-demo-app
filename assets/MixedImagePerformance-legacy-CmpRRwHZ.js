(function() {
    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./api-legacy-CQ6iaaWY.js", "./imagePerf-legacy-CDsIaUnk.js" ], function(_export, _context) {
        "use strict";
        var For, createSignal, createElement, effect, createComponent, insert, setProp, onMount, insertNode, getImageUrl, api_default, createImagePerfRun, MixedImagePerformance;
        return {
            ...
            execute: function execute() {
                _export("default", MixedImagePerformance = function MixedImagePerformance() {
                    ...
                    var imageLoadTimes = {};
                    var totalImages = 11;
                    var perf = createImagePerfRun("image-mixed", totalImages);
                    ...
                    return function() {
                        ...
                        insert(_el$2, createComponent(For, {
                            ...
                            children: function children(item, index) {
                                var i = index();
                                if (item.isMain) return function() {
...
//# sourceMappingURL=MixedImagePerformance-legacy-CmpRRwHZ.js.map