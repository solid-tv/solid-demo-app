import { $ as onMount, Bt as assertTruthy, N as Show, W as createResource, a as createElement, c as effect, i as createComponent, l as insert, m as setProp, s as createTextNode, u as insertNode } from "./render-CAUp88iy.js";

import { t as Column } from "./Column-c3b6xsW1.js";

import { u as TileRow } from "./components-i706jFKd.js";

import { d as useNavigate, f as useParams } from "./routing-Ctwm4NCs.js";
...
function getCredits({id: id}) {
    return api_default.get(`/person/${id}/combined_credits`).then(({cast: cast}) => convertItemsToTiles(cast.slice(0, 7)));
}

function getInfo({id: id}) {
    return api_default.get(`/person/${id}`).then(data => ({
...
var People = () => {
    const params = useParams(), navigate = useNavigate(), [data] = createResource(() => ({
        ...params
    }), getInfo), [credits] = createResource(() => ({
        ...params
    }), getCredits), Backdrop = {
        color: 255,
        alpha: .8,
    ...
    return onMount(() => {
        ...
        get children() {
            ...
            }), setProp(_el$, "y", 40), setProp(_el$, "right", 400), effect(_$p => setProp(_el$, "src", data().backgroundImage, _$p)), 
            ...
            setProp(_el$3, "contain", "width"), setProp(_el$3, "fontFamily", "Roboto"), insert(_el$3, () => data().name), 
            setProp(_el$4, "contain", "both"), insert(_el$4, () => data().biography), effect(_p$ => {
                ...
                get children() {
                    return createComponent(Show, {
                        ...
                        get children() {
                            ...
                            setProp(_el$6, "skipFocus", !0), effect(_$p => setProp(_el$6, "style", styles_default.RowTitle, _$p)), 
