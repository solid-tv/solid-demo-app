...
var EMPTY_TEXTURE_OPTIONS = Object.freeze({}), Stage = class {
    ...
    startLoop(stage) {
        let isIdle = !1, lastFrameTime = 0, scheduled = !1;
        const requestLoop = () => requestAnimationFrame(runLoop), runLoop = (currentTime = 0) => {
            scheduled = !1;
            try {
                (currentTime => {
    ...
    max;
}, resolveTargetFPS = fps => void 0 === fps ? 60 : fps > 0 ? fps : 0, RendererMain = class extends EventEmitter {
...
export { onMount as $, For as A, createIndexBuffer as At, createContext as B, assertTruthy as Bt, isElementNode as C, ImageTexture as Ct, Config as D, MAX_QUAD_BUFFER_SIZE as Dt, isInteger as E, MAX_QUADS as Et, Switch as F, compareRect as Ft, createRoot as G, createMemo as H, batch as I, getNormalizedRgbaComponents as It, getListener as J, createSelector as K, children as L, Texture as Lt, Match as M, isHTMLImageElement as Mt, Show as N, calcFactoredRadiusArray as Nt, activeElement as O, UNIT_TEXTURE_COORDS as Ot, Suspense as P, clampUnit as Pt, onCleanup as Q, createComponent$1 as R, TextureType as Rt, hasFocus as S, isTextureError as St, isFunction as T, UpdateType as Tt, createRenderEffect as U, createEffect as V, createWebGLContext as Vt, createResource as W, mergeProps as X, getOwner as Y, on as Z, ElementNode as _, isAdvancedShaderProp as _t, createElement as a, useContext as at, loadFonts as b, TextureError as bt, effect as c, takeCanvasPrefetch as ct, memo as d, resolveTargetFPS as dt, resetErrorBoundaries as et, rootNode as f, frameTimeBucketLowerBound as ft, use as g, CoreShaderNode as gt, spread as h, normalizeFontMetrics as ht, createComponent as i, untrack as it, Index as j, createTextureCoords as jt, $TRACK as k, WORDS_PER_QUAD as kt, insert as l, takeSdfPrefetch as lt, setProp as m, mapTextLayout as mt, Text as n, sharedConfig as nt, createRenderer as o, clearFontPrefetch as ot, scheduleTask as p, defaultFontMetrics as pt, createSignal as q, View as r, startTransition as rt, createTextNode as s, prefetchFont as st, Dynamic as t, runWithOwner as tt, insertNode as u, RendererMain as ut, focusPath as v, resolveShaderProps as vt, isFocused as w, uploadCompressedTexture as wt, renderer$1 as x, TextureErrorCode as xt, useFocusManager as y, CoreTextureManager as yt, createComputed as z, closeImageBitmap as zt };