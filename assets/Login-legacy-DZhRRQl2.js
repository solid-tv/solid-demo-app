(function() {
    ...
    System.register([ "./index-legacy-BnGC5Byo.js" ], function(exports, module) {
        "use strict";
        var createSignal, createMemo, createEffect, on, createElement, insertNode, spread, mergeProps, setProp, insert, chainFunctions, createComponent, Column, Index, Row, Show, memo, Switch, Match, effect, onMount, setGlobalBackground, createTextNode;
        return {
            ...
            execute: function execute() {
                ...
                var getformatValueText = function getformatValueText(props, value) {
                    ...
                    return props.password ? ((_props$mask = props.mask) != null ? _props$mask : "").repeat((_value$length = value.length) != null ? _value$length : 0) : value;
                };
                var Input = function Input(props) {
                    var _props$valueSignal, _props$position, _props$keyEvents;
                    var _ref = (_props$valueSignal = props.valueSignal) != null ? _props$valueSignal : createSignal(""), _ref2 = _slicedToArray(_ref, 2), value = _ref2[0], setValue = _ref2[1];
                    var _createSignal = createSignal((_props$position = props.position) != null ? _props$position : value().length), _createSignal2 = _slicedToArray(_createSignal, 2), position = _createSignal2[0], setPosition = _createSignal2[1];
                    var _ref3 = (_props$keyEvents = props.keyEvents) != null ? _props$keyEvents : createSignal(""), _ref4 = _slicedToArray(_ref3, 2), keyEvent = _ref4[0], setKeyEvent = _ref4[1];
                            ...
                            return [ createComponent(Match, {
                                ...
                                get children() {
                                    ...
                                    spread(_el$7, mergeProps(props, {
                                        ...
                                        display: "flex",
                                        padding: [ 0, 20 ],
                                        style: (_props$key = props.key) != null && _props$key.size ? actionKeyContainerStyle : keyContainerStyle
                                    }), true);
