...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        settings = {
            ...
            disableVertexArrayObject: (_f = settings.disableVertexArrayObject) != null ? _f : false,
            inspector: (_g = settings.inspector) != null ? _g : false,
            inspectorOptions: (_h = settings.inspectorOptions) != null ? _h : {},
            renderEngine: settings.renderEngine,
            quadBufferSize: (_i = settings.quadBufferSize) != null ? _i : 4 * 1024 * 1024,
            fontEngines: (_j = settings.fontEngines) != null ? _j : [],
            textBaselineMode: (_k = settings.textBaselineMode) != null ? _k : "optical",
...
const Player = lazy(() => __vitePreload(() => import("./Player-CKBbhuj1.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-CBVOTBwf.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-BV40Jcbp.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-DmOZ-4So.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-46nTdw92.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-CvI_oKyf.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-B2a2XWVL.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-bK52RHZU.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DY5adPTG.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-BNoUiyEn.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-DMVZ1IhQ.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-DmNIZLbO.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-BX6-Vv2h.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-Cu3zO-Sg.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-3GcB52OW.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CNwY8EJg.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BhQe3zkm.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-BSYEebYz.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-eaK3mKV3.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-D6iE-Zj4.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CUkhxadA.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-Df4Gk-xu.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CKUP8bLg.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-DtAHp8kX.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-BaGGobb9.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-z3O-JPAL.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DRqgI_Rd.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-BK3JTu-h.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-GwRDkoTj.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-BoWlvfoj.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-B0d09HzJ.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-BKVX9IKo.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DMBF_KBa.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-B_2qHmt5.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-DBvravZG.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-FJpNJHvB.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-C6tMM1CP.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-kslr_yWz.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-DTxocJRu.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-Cx30-Zgh.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-CsVwtSqi.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-DJ_jzo6H.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-B1q0_jin.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-Bt2-bP9d.js"), true ? [] : void 0));
                        ...
                        return [ createComponent(Route, {
                            ...
                            get children() {
                                return [ createComponent(Route, {
                                    ...
                                    path: "nested",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./Nested-BLX2nuLs.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "textposter",
                                    ...
                                    path: "keepalive",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./KeepAlive-DRqb8hBL.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "suspense",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./suspense-DoTMDoT1.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "superflex",
