(function() {
    ...
    System.register([ "./render-legacy-zhspBKrd.js", "./components-legacy-CtMyJ2j1.js", "./state-legacy-CdoSGSvK.js" ], function(_export, _context) {
        "use strict";
        var onCleanup, createSignal, createRoot, children, createMemo, createElement, untrack, mergeProps, spread, setProp, createComponent, For, insert, createTextNode, Dynamic, insertNode, ElementNode, Button, setGlobalBackground, PositioningPage;
