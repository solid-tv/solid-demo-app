...
function createAnimation(manager, node, props2, settings) {
    ...
    const delay = (_a2 = settings.delay) != null ? _a2 : 0;
    let propValues = null;
...
const findChildIndexById = (node, children) => {
    for (let i = 0; i < children.length; i++) {
...
const removeChild = (node, children) => {
        ...
        if (settings.debugLogging && !this.loggingID) {
            ...
            this.loggingID = setInterval(() => {
                if (lastMemUse !== this.memUsed) {
                    ...
                    console.log("[TextureMemoryManager] Memory used: ".concat(bytesToMb(this.memUsed), " mb / ").concat(bytesToMb(this.criticalThreshold), " mb (").concat((this.memUsed / this.criticalThreshold * 100).toFixed(1), "%)"));
                }
            }, 1e3);
        }
...
function createComponent(Comp, props2) {
...
class DOMNode extends EventEmitter {
    constructor(stage, props2) {
        ...
        __publicField(this, "imageLoading", false);
        ...
        __publicField(this, "_lastStyleStr", "");
...
function splash(options) {
    const {src: src, w: w, h: h, bgColor: bgColor = 255} = options;
    const root = renderer$2.root;
    const background = renderer$2.createNode({
        x: 0,
        y: 0,
        w: root.w,
        h: root.h,
    ...
    const image = renderer$2.createNode({
        x: (root.w - w) / 2,
        y: (root.h - h) / 2,
        w: w,
        h: h,
...
function createRenderer$1({createElement: createElement, createTextNode: createTextNode, isTextNode: isTextNode2, replaceText: replaceText, insertNode: insertNode, removeNode: removeNode, setProperty: setProperty, getParentNode: getParentNode, getFirstChild: getFirstChild, getNextSibling: getNextSibling}) {
...
class WebGlContextWrapper {
    ...
    drawElements(mode, count, type2, offset) {
        this.gl.drawElements(mode, count, type2, offset);
    }
...
const SplashImage = "/assets/SolidTV_transparent-DOtoq56x.png";
...
//# sourceMappingURL=index-CTvnraeA.js.map
