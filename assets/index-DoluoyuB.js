const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Player-BaHMVbmi.js","assets/rolldown-runtime-Dacw0Uxr.js","assets/render-DOO6Djf1.js","assets/utils-u7o3C0c_.js","assets/routing-BYM6smbJ.js","assets/web-BxFxPOyO.js","assets/state-BPSabyXY.js","assets/Grid-CHCyz_5z.js","assets/Column-BCKv6cM-.js","assets/mergeProps-CB-6pYOe.js","assets/chainFunctions-Dau9iw54.js","assets/theme-CB9u0IsU.js","assets/Loops-ZaMQ0USF.js","assets/Lazy-HnBElGZB.js","assets/Row-CamJUj-t.js","assets/components-DR1cBJ-C.js","assets/styles-xHyKpT0b.js","assets/Infinite-BMtxrfJ2.js","assets/TMDBGrid-BMnm61AS.js","assets/ContentBlock-CoGm0mvm.js","assets/dist-BWjroMsk.js","assets/Portal-Ba2FePGJ.js","assets/announcer-CEK8WD29.js","assets/createFocusStack-DRIekK_V.js","assets/Matrix-IXP_jgFw.js","assets/Text-DQhTAsCU.js","assets/TextPoster-CCMG1saQ.js","assets/Create-Cin4HXt0.js","assets/Viewport-Cxbw3QCJ.js","assets/Positioning-C15NFtP6.js","assets/Layout-DzyTurRq.js","assets/FocusBasics-CAuIw1-7.js","assets/KeyHandling-CVW4kJkG.js","assets/Transitions-DnydzhfO.js","assets/Components-BMwSUg18.js","assets/FocusHandling-CxJhHkom.js","assets/Gradients-DROvPCVU.js","assets/Flex-BGPmhxW2.js","assets/FlexGrow-BViAHyl9.js","assets/FlexMenu-SLclhyyp.js","assets/FlexSize-DmFeogfm.js","assets/FlexColumnSize-DCV58v9l.js","assets/FlexColumn-B2IKvAsC.js","assets/ButtonsMaterial-CErEPl_n.js","assets/SuperFlex-DqzRCvlT.js","assets/Entity--bvXDPPw.js","assets/People-DuxDOSnf.js","assets/api-BLXElZOg.js","assets/ItemFormatter-Bx-xMo5c.js","assets/Firebolt-BtmnkGmd.js","assets/Login-B8knT9QI.js","assets/Virtual-0Zftrq_J.js","assets/Tags-3Uq245w_.js","assets/ImagePerformance-ZGycgLc-.js","assets/imagePerf-BUvxb9Vh.js","assets/LargeImagePerformance-DusI4KR3.js","assets/MixedImagePerformance-DELZqRGd.js","assets/TextureCompressionPerformance-BcZsbmK0.js","assets/ComplexFlex-BVmOP_1s.js","assets/ComplexFlexCaps-C90e8JdJ.js","assets/Benchmark-CoCOYuzc.js","assets/FPSCounter-DY5fprhj.js","assets/RendererVersions-ddMMp2M4.js","assets/TextCentering-CZkx3s7y.js","assets/CountdownTimer-CjPq1VJg.js","assets/CustomButtons-ClTelg2q.js","assets/Icon-CDGVFzD1.js","assets/FlexJustifyWidth-BgRWVM-3.js","assets/Nested-B42jSUlB.js","assets/KeepAlive-BmmI903G.js","assets/suspense-NqIxhvew.js"])))=>i.map(i=>d[i]);
import 'data:text/javascript,"assets/index-DoluoyuB.js";if(!import.meta.resolve)throw Error("import.meta.resolve not supported")';
...
import { $ as onMount, At as WORDS_PER_QUAD, Bt as closeImageBitmap, C as isElementNode, D as Config, Dt as MAX_QUADS, Et as UpdateType, Ft as clampUnit, G as createRoot, H as createMemo, Ht as createWebGLContext, I as batch, It as compareRect, J as getListener, L as children, Lt as getNormalizedRgbaComponents, Mt as createTextureCoords, N as Show, Nt as isHTMLImageElement, O as activeElement, Ot as MAX_QUAD_BUFFER_SIZE, Pt as calcFactoredRadiusArray, Q as onCleanup, S as hasFocus, T as isFunction, Tt as uploadCompressedTexture, V as createEffect, Vt as assertTruthy, W as createResource, X as mergeProps, Y as getOwner, Z as on, _ as ElementNode, _t as CoreShaderNode, a as createElement, b as loadFonts, c as effect, ct as takeCanvasPrefetch, d as memo, f as rootNode, g as use, gt as normalizeFontMetrics, h as spread, ht as mapTextLayout, i as createComponent, it as untrack, jt as createIndexBuffer, kt as UNIT_TEXTURE_COORDS, l as insert, lt as takeSdfPrefetch, m as setProp, mt as defaultFontMetrics, nt as sharedConfig, o as createRenderer, q as createSignal, s as createTextNode, tt as runWithOwner, u as insertNode, v as focusPath, x as renderer, y as useFocusManager, z as createComputed, zt as TextureType } from "./render-DOO6Djf1.js";

import { a as genGradientColors, c as LinearGradientTemplate, d as RoundedTemplate, f as HolePunchTemplate, i as WebGlShaderProgram, m as getBorderProps, o as Default, r as setupFPS, s as RadialGradientTemplate, t as FPSCounter, u as getShadowProps } from "./FPSCounter-DY5fprhj.js";

import { n as combineStyles, t as clamp } from "./utils-u7o3C0c_.js";

import { t as mergeProps$1 } from "./mergeProps-CB-6pYOe.js";

import { n as createScheduled, r as throttle, t as Announcer } from "./announcer-CEK8WD29.js";

import { t as voidFn } from "./web-BxFxPOyO.js";

import { n as LazyRow, t as LazyColumn } from "./Lazy-HnBElGZB.js";

import { a as withScrolling, d as navigableForwardFocus, f as navigableHandleNavigation, n as chainRefs, t as chainFunctions } from "./chainFunctions-Dau9iw54.js";

import { t as Column } from "./Column-BCKv6cM-.js";

import { t as ContentBlock } from "./ContentBlock-CoGm0mvm.js";

import { n as useFocusStack, t as FocusStackProvider } from "./createFocusStack-DRIekK_V.js";

import { a as Hero, d as TitleRow, l as Thumbnail, p as List, t as AssetPanel } from "./components-DR1cBJ-C.js";

import { t as Icon } from "./Icon-CDGVFzD1.js";

import { _ as saveCurrentDepth, a as createRouterContext, c as setInPreloadFn, d as useNavigate, g as notifyIfNotBlocked, h as keepDepth, i as createRouteContext, l as useLocation, m as createBeforeLeave, n as RouterContextObj, o as getIntent, p as usePreloadRoute, r as createBranches, s as getRouteMatches, t as RouteContextObj, u as useMatch } from "./routing-BYM6smbJ.js";

import { t as theme_default } from "./theme-CB9u0IsU.js";

import { r as styles_default } from "./styles-xHyKpT0b.js";

import { n as setGlobalBackground, t as globalBackground } from "./state-BPSabyXY.js";

import { t as debounce } from "./dist-BWjroMsk.js";
...
var measureContext$1, SdfFontHandler_exports = __exportAll({
    ...
    constructor(renderer) {
        super(), this.renderer = void 0, this.numQuads = 0, this.time = 0, this.stage = void 0, 
        this.startQuad = 0, this.translateX = 0, this.translateY = 0, this.shader = void 0, 
        this.quadBufferCollection = void 0, this.renderOpTexture = void 0, this.worldAlpha = 0, 
        this.clippingRect = void 0, this.w = 0, this.h = 0, this.renderer = renderer, this.stage = renderer.stage;
    }
    init(shader, quadBufferCollection, renderOpTexture, worldAlpha, clippingRect, w, h, startQuad, numQuads, translateX, translateY) {
...
var Player = lazy(() => __vitePreload(() => import("./Player-BaHMVbmi.js"), __vite__mapDeps([0,1,2,3,4,5,6]))), Grid = lazy(() => __vitePreload(() => import("./Grid-CHCyz_5z.js"), __vite__mapDeps([7,2,8,3,9,10,11,6]))), Loops = lazy(() => __vitePreload(() => import("./Loops-ZaMQ0USF.js"), __vite__mapDeps([12,2,9,13,10,3,8,14,15,16,11,6]))), Infinite = lazy(() => __vitePreload(() => import("./Infinite-BMtxrfJ2.js"), __vite__mapDeps([17,2,9,15,3,10,8,14,16,11,6]))), TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-BMnm61AS.js"), __vite__mapDeps([18,2,9,10,3,19,11,15,8,14,16,6,20]))), Portal = lazy(() => __vitePreload(() => import("./Portal-Ba2FePGJ.js"), __vite__mapDeps([21,2,9,22,8,3,10,14,23,4,5,16,11]))), MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-IXP_jgFw.js"), __vite__mapDeps([24,2,8,3,9,10,14]))), TextPage = lazy(() => __vitePreload(() => import("./Text-DQhTAsCU.js"), __vite__mapDeps([25,2,3,6]))), TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-CCMG1saQ.js"), __vite__mapDeps([26,2,14,3,9,10,6]))), CreatePage = lazy(() => __vitePreload(() => import("./Create-Cin4HXt0.js"), __vite__mapDeps([27,2,3,9,6]))), ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-Cxbw3QCJ.js"), __vite__mapDeps([28,2,6]))), PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-C15NFtP6.js"), __vite__mapDeps([29,2,6]))), LayoutPage = lazy(() => __vitePreload(() => import("./Layout-DzyTurRq.js"), __vite__mapDeps([30,2,15,3,9,10,8,14,16,11,6]))), FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-CAuIw1-7.js"), __vite__mapDeps([31,2,14,3,9,10,15,8,16,11,6]))), KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-CVW4kJkG.js"), __vite__mapDeps([32,2,15,3,9,10,8,14,16,11,6]))), TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DnydzhfO.js"), __vite__mapDeps([33,2,6]))), ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BMwSUg18.js"), __vite__mapDeps([34,2,9,15,3,10,8,14,16,11,6]))), FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-CxJhHkom.js"), __vite__mapDeps([35,2,9,8,3,10,14,6]))), GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-DROvPCVU.js"), __vite__mapDeps([36,2,6]))), FlexPage = lazy(() => __vitePreload(() => import("./Flex-BGPmhxW2.js"), __vite__mapDeps([37,2,9,8,3,10,14,16,11,6]))), FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BViAHyl9.js"), __vite__mapDeps([38,2,9,8,3,10,14,16,11,6]))), FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-SLclhyyp.js"), __vite__mapDeps([39,2,9,8,3,10,6]))), FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-DmFeogfm.js"), __vite__mapDeps([40,2,9,8,3,10,14,16,11,6]))), FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-DCV58v9l.js"), __vite__mapDeps([41,2,3,9,8,10,14,6]))), FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-B2IKvAsC.js"), __vite__mapDeps([42,2,3,9,8,10,14,6]))), ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CErEPl_n.js"), __vite__mapDeps([43,2,3,9,14,10,16,11]))), SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-DqzRCvlT.js"), __vite__mapDeps([44,2,8,3,9,10,14]))), Entity = lazy(() => __vitePreload(() => import("./Entity--bvXDPPw.js"), __vite__mapDeps([45,2,8,3,9,10,14,19,11,15,16,4,5,6]))), People = lazy(() => __vitePreload(() => import("./People-DuxDOSnf.js"), __vite__mapDeps([46,2,8,3,9,10,15,14,16,11,4,5,6,47,48]))), FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-BtmnkGmd.js"), __vite__mapDeps([49,2,14,3,9,10,6]))), LoginPage = lazy(() => __vitePreload(() => import("./Login-B8knT9QI.js"), __vite__mapDeps([50,2,9,10,3,8,14,6]))), VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-0Zftrq_J.js"), __vite__mapDeps([51,2,13,9,10,3,8,14,15,16,11,6]))), TagsPage = lazy(() => __vitePreload(() => import("./Tags-3Uq245w_.js"), __vite__mapDeps([52,2,9,6]))), ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-ZGycgLc-.js"), __vite__mapDeps([53,2,47,54]))), LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-DusI4KR3.js"), __vite__mapDeps([55,2,47,54]))), MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-DELZqRGd.js"), __vite__mapDeps([56,2,47,54]))), TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-BcZsbmK0.js"), __vite__mapDeps([57,2]))), ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-BVmOP_1s.js"), __vite__mapDeps([58,2,8,3,9,10,14]))), ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-C90e8JdJ.js"), __vite__mapDeps([59,2,8,3,9,10,14]))), BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-CoCOYuzc.js"), __vite__mapDeps([60,1,2,61,9,13,10,3,8,14,19,11,23,15,16,6,20]))), RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-ddMMp2M4.js"), __vite__mapDeps([62,2,6]))), TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-CZkx3s7y.js"), __vite__mapDeps([63,2,9,11,6]))), CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-CjPq1VJg.js"), __vite__mapDeps([64,2,11,6]))), CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-ClTelg2q.js"), __vite__mapDeps([65,2,8,3,9,10,14,66,11,6]))), FlexJustifyWidthPage = lazy(() => __vitePreload(() => import("./FlexJustifyWidth-BgRWVM-3.js"), __vite__mapDeps([67,2,8,3,9,10,11,6]))), numImageWorkers = "undefined" != typeof window && window.createImageBitmap ? 1 : 0, urlParams = new URLSearchParams(window.location.search), numWorkers = urlParams.get("numImageWorkers"), screenSize = urlParams.get("size") || "default", rendererMode = urlParams.get("mode") || "webgl", animationsEnabled = urlParams.get("animate") || "true", enableContextSpy = "true" === urlParams.get("contextSpy"), forceWebGL2 = "true" === urlParams.get("webgl2"), targetFPSParam = urlParams.get("targetFPS"), targetFPS = targetFPSParam ? parseFloat(targetFPSParam) : 0, powerPreference = urlParams.get("powerPreference"), framePacing = urlParams.get("framePacing"), textBaseline = urlParams.get("textBaseline");
...
}, powerPreference && (Config.rendererOptions.powerPreference = powerPreference), 
framePacing && (Config.rendererOptions.framePacing = framePacing), textBaseline && (Config.rendererOptions.textBaselineMode = textBaseline), 
"canvas" === rendererMode ? (Config.rendererOptions.fontEngines = [ CanvasTextRenderer ], 
Config.rendererOptions.renderEngine = class extends CoreRenderer {
    ...
    constructor(options) {
        ...
        this.uiQuadBuffer = void 0, this.renderOps = [], this.coreTextRenderOps = [], this.sdfOpPool = [], 
        this.sdfOpPoolIdx = 0, this.curBufferIdx = 0, this.curRenderOp = null, this.attachedShader = null, 
        this.sdfBuffer = void 0, this.fSdfBuffer = void 0, this.uiSdfBuffer = void 0, this.sdfBufferIdx = 0, 
        this.sdfQuadCount = 0, this.sdfQuadBufferCollection = void 0, this.curSdfRenderOp = null, 
        this.sdfBufferChanged = !0, this.lastUploadedSdfSize = 0, this.sdfWriteSig = 0, 
        this.lastUploadedSdfSig = 0, this.defaultTextureCoords = UNIT_TEXTURE_COORDS, this.defaultShaderNode = null, 
        this.quadBufferCollection = void 0, this.indexBuffer = null, this.clearColor = {
            raw: 0,
            normalized: [ 0, 0, 0, 0 ]
        }, this.quadBufferUsage = 0, this.numQuadsRendered = 0, this.quadUploadView = null, 
        this.quadBufferSize = void 0, this.quadBufferSize = Math.min(this.stage.options.quadBufferSize, MAX_QUAD_BUFFER_SIZE), 
        ...
        this.mode = "webgl";
        const gl = createWebGLContext(options.canvas, options.forceWebGL2, options.contextSpy, options.powerPreference), glw = this.glw = new WebGlContextWrapper(gl, options.disableVertexArrayObject);
    ...
    reset() {
        const {glw: glw} = this;
        this.curBufferIdx = 0, this.curRenderOp = null, this.curSdfRenderOp = null, this.sdfBufferIdx = 0, 
        this.sdfQuadCount = 0, this.sdfWriteSig = 0, this.renderOps.length = 0, this.coreTextRenderOps.length = 0, 
        this.sdfOpPoolIdx = 0, glw.setScissorTest(!1), glw.clear();
    }
    ...
    addQuad(node, texture) {
        const f = this.fQuadBuffer, u = this.uiQuadBuffer, props = node.props;
        props.zIndex && this.flushTextRenderOps();
        ...
        const reuse = this.reuseRenderOp(node), i = this.curBufferIdx;
        this.curBufferIdx += WORDS_PER_QUAD, !1 === reuse && this.newRenderOp(node, i);
        let curOp = this.curRenderOp;
        null === curOp.renderOpTexture ? curOp.renderOpTexture = ctx : curOp.renderOpTexture !== ctx && (this.newRenderOp(node, i), 
        node.renderOpTexture = ctx, curOp = node);
    ...
    render(surface = "screen") {
        ...
        const {glw: glw, quadBuffer: quadBuffer} = this, buffer = this.quadBufferCollection.getBuffer("a_position") || null;
        let arr = this.quadUploadView;
        null !== arr && arr.length === this.curBufferIdx || (arr = this.quadUploadView = new Float32Array(quadBuffer, 0, this.curBufferIdx)), 
        glw.arrayBufferData(buffer, arr, glw.DYNAMIC_DRAW), this.uploadSdfBuffer();
                        ...
                        return [ createComponent(Route, {
                            ...
                            get children() {
                                return [ createComponent(Route, {
                                    ...
                                    path: "nested",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./Nested-B42jSUlB.js"), __vite__mapDeps([68,2,8,3,9,10,15,14,16,11,6])));
                                    }
                                }), createComponent(Route, {
                                    path: "textposter",
                                    ...
                                    path: "flexjustifywidth",
                                    component: FlexJustifyWidthPage
                                }), createComponent(Route, {
                                    path: "keepalive",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./KeepAlive-BmmI903G.js"), __vite__mapDeps([69,2])));
                                    }
                                }), createComponent(Route, {
                                    path: "suspense",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./suspense-NqIxhvew.js"), __vite__mapDeps([70,2,6])));
                                    }
                                }), createComponent(Route, {
                                    path: "superflex",
