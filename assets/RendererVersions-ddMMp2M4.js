import { $ as onMount, a as createElement, l as insert, m as setProp, q as createSignal, s as createTextNode, u as insertNode } from "./render-DOO6Djf1.js";

import { n as setGlobalBackground } from "./state-BPSabyXY.js";

var knownVersions = [ "Current", 156, 183, 190, 300, 316, 320, 321, 322, 323, 324, 325, 326, 330, 331, 340 ], RendererVersionsPage = () => {
    const [version, setVersion] = createSignal("Current");
    onMount(() => {
        setGlobalBackground(255);
    });
    const onRight = () => {
        const current = version(), index = knownVersions.indexOf(current);
        ...
        !0;
    }, onUp = () => (setVersion(v => "Current" === v ? 341 : v + 1), !0), onDown = () => (setVersion(v => "Current" === v ? 339 : Math.max(0, v - 1)), 
    !0), onEnter = () => ("Current" === version() ? window.location.hash = "#/benchmark" : window.location.href = `https://solid-tv.github.io/solid-demo-app/${version()}/#/benchmark`, 
    !0), Container = {
        width: 1e3,
        height: 500,
        x: 460,
    ...
    setProp(_el$2, "style", Title), setProp(_el$4, "style", VersionText), insert(_el$4, () => version().toString()), 
    ...
    var _el$, _el$2, _el$4, _el$5, _el$7, _el$9;
};
