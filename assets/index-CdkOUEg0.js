...
const Player = lazy(() => __vitePreload(() => import("./Player-Yhi9dhoy.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DujlQ1RR.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-YxpHIuGy.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BGT0htQX.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CcW2FulC.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-DnJwDPSF.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BLWxCGJq.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-V83tR7sw.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-C67ZbaRb.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-_Lh6ob7w.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-DmZR_lgH.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-D4aLK8_9.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-9BNrCHD4.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-D3taPrjY.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling--s16SvwY.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-Ba_1iTux.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BWLbjWT9.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-BjOUqNHv.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-CQX1OYJ4.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-D6kDOXsg.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CWiEX2LE.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-BDTo58SV.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-CZnf_zHO.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-C2x3WvAt.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-CbNjCTMs.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-Cs2A4mf7.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Ch1eNH7x.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-Ypd7UP2a.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-pGywY41q.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-C2biepwi.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-DwS8P62I.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DJx7Ctkj.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-B34sNnGG.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-_nxSD4g7.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-DmeagSc8.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-CDi1AeAS.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-DApTt1Sd.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-Du26hd_f.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-DT5Dpnvz.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-ilZod5Sm.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-BsZFOg6d.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-MmTWlT4C.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-Blgxwvo9.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-BJqtAqJM.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-8ZHE3Yft.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive--rgugFd-.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-BwLjiKgv.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
...
//# sourceMappingURL=index-CdkOUEg0.js.map
