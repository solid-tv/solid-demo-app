    ...
    System.register([ "./rolldown-runtime-legacy-c5pELP7v.js", "./render-legacy-DGIMFHoj.js", "./FPSCounter-legacy-CqWX0CyR.js", "./utils-legacy-4naaonFp.js", "./mergeProps-legacy-BmdPisRS.js", "./announcer-legacy-C66VHtv1.js", "./web-legacy-CZsMP84a.js", "./Lazy-legacy-CPOKhmEz.js", "./chainFunctions-legacy-DSA4DUEs.js", "./Column-legacy-zAoenkih.js", "./ContentBlock-legacy-Ba2IgW8W.js", "./createFocusStack-legacy-C302dX_e.js", "./components-legacy-D4V4IEWy.js", "./Icon-legacy-T1P3Rz1N.js", "./routing-legacy-DVhC9PuZ.js", "./theme-legacy-Bdf29FvE.js", "./styles-legacy--qMSUlWV.js", "./state-legacy-D3yNc7Vl.js", "./dist-legacy-DfRsX4se.js", "./api-legacy-BrsqDpuo.js", "./ItemFormatter-legacy-CSpFnyiZ.js" ], function(_export, _context) {
        ...
        return {
            setters: [ function(_rolldownRuntimeLegacy001Js) {
                ...
                onMount = _renderLegacy002Js.$, WORDS_PER_QUAD = _renderLegacy002Js.At, closeImageBitmap = _renderLegacy002Js.Bt, 
                isElementNode = _renderLegacy002Js.C, Config = _renderLegacy002Js.D, MAX_QUADS = _renderLegacy002Js.Dt, 
                UpdateType = _renderLegacy002Js.Et, clampUnit = _renderLegacy002Js.Ft, createRoot = _renderLegacy002Js.G, 
                createMemo = _renderLegacy002Js.H, createWebGLContext = _renderLegacy002Js.Ht, batch = _renderLegacy002Js.I, 
                compareRect = _renderLegacy002Js.It, getListener = _renderLegacy002Js.J, children = _renderLegacy002Js.L, 
                getNormalizedRgbaComponents = _renderLegacy002Js.Lt, createTextureCoords = _renderLegacy002Js.Mt, 
                Show = _renderLegacy002Js.N, isHTMLImageElement = _renderLegacy002Js.Nt, activeElement = _renderLegacy002Js.O, 
                MAX_QUAD_BUFFER_SIZE = _renderLegacy002Js.Ot, calcFactoredRadiusArray = _renderLegacy002Js.Pt, 
                onCleanup = _renderLegacy002Js.Q, hasFocus = _renderLegacy002Js.S, isFunction = _renderLegacy002Js.T, 
                uploadCompressedTexture = _renderLegacy002Js.Tt, createEffect = _renderLegacy002Js.V, 
                ...
                CoreShaderNode = _renderLegacy002Js._t, createElement = _renderLegacy002Js.a, loadFonts = _renderLegacy002Js.b, 
                effect = _renderLegacy002Js.c, takeCanvasPrefetch = _renderLegacy002Js.ct, memo = _renderLegacy002Js.d, 
                rootNode = _renderLegacy002Js.f, use = _renderLegacy002Js.g, normalizeFontMetrics = _renderLegacy002Js.gt, 
                spread = _renderLegacy002Js.h, mapTextLayout = _renderLegacy002Js.ht, createComponent = _renderLegacy002Js.i, 
                untrack = _renderLegacy002Js.it, createIndexBuffer = _renderLegacy002Js.jt, UNIT_TEXTURE_COORDS = _renderLegacy002Js.kt, 
                insert = _renderLegacy002Js.l, takeSdfPrefetch = _renderLegacy002Js.lt, setProp = _renderLegacy002Js.m, 
                defaultFontMetrics = _renderLegacy002Js.mt, sharedConfig = _renderLegacy002Js.nt, 
                createRenderer = _renderLegacy002Js.o, createSignal = _renderLegacy002Js.q, createTextNode = _renderLegacy002Js.s, 
                runWithOwner = _renderLegacy002Js.tt, insertNode = _renderLegacy002Js.u, focusPath = _renderLegacy002Js.v, 
                renderer = _renderLegacy002Js.x, useFocusManager = _renderLegacy002Js.y, createComputed = _renderLegacy002Js.z, 
                TextureType = _renderLegacy002Js.zt;
            ...
            execute: function() {
                ...
                WebGlCtxSubTexture = function(_WebGlCtxTexture) {
                    ...
                    function WebGlRenderer(options) {
                        ...
                        _this5.lastUploadedSdfSig = 0, _this5.defaultTextureCoords = UNIT_TEXTURE_COORDS, 
                        _this5.defaultShaderNode = null, _this5.quadBufferCollection = void 0, _this5.indexBuffer = null, 
                        _this5.clearColor = {
                            raw: 0,
                            normalized: [ 0, 0, 0, 0 ]
                        }, _this5.quadBufferUsage = 0, _this5.numQuadsRendered = 0, _this5.quadUploadView = null, 
                        _this5.quadBufferSize = void 0, _this5.quadBufferSize = Math.min(_this5.stage.options.quadBufferSize, MAX_QUAD_BUFFER_SIZE), 
                        ...
                        _this5.mode = "webgl";
                        var gl = createWebGLContext(options.canvas, options.forceWebGL2, options.contextSpy, options.powerPreference), glw = _this5.glw = new WebGlContextWrapper(gl, options.disableVertexArrayObject);
                    ...
                    return _inherits(WebGlRenderer, _CoreRenderer), _createClass(WebGlRenderer, [ {
                        ...
                        value: function(node, texture) {
                            var f = this.fQuadBuffer, u = this.uiQuadBuffer, props = node.props;
                            props.zIndex && this.flushTextRenderOps();
                            var tx = void 0 !== texture ? texture : !0 === node.placeholderActive ? this.stage.defaultTexture : props.texture || this.stage.defaultTexture;
                            tx.type === TextureType.subTexture && (tx = tx.parentTexture);
                            var ctx = tx.ctxTexture;
                            if (void 0 !== ctx) {
                                var reuse = this.reuseRenderOp(node), i = this.curBufferIdx;
                        ...
                        key: "invalidateRenderListCaches",
                        value: function() {
                            this.sdfBufferChanged = !0;
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            var glw = this.glw, quadBuffer = this.quadBuffer, buffer = this.quadBufferCollection.getBuffer("a_position") || null, arr = this.quadUploadView;
                    ...
                    for (var glyphs = new Float32Array(8 * maxGlyphs), glyphIdx = 0, glyphCount = 0, currentX = 0, baselineY = 0, _i8 = 0; _i8 < lineAmount; _i8++) {
                        var line = lines[_i8], textLine = line[0], textLineLength = textLine.length, prevGlyphId = 0;
                ...
                _canRenderFont = function() {
                    ...
                    for (var loadPromise = Promise.resolve(prefetched).then(function(faces) {
                        ...
                        for (var _i9 = 0; _i9 < names.length; _i9++) {
                            var loadedFont = faces[_i9];
                            stage.platform.addFont(loadedFont), processFontData(names[_i9], loadedFont, metrics);
                        }
                    }).then(function() {
                        for (var _i0 = 0; _i0 < names.length; _i0++) {
                            var name = names[_i0];
                        ...
                        for (var _i1 = 0; _i1 < names.length; _i1++) fontLoadPromises.delete(names[_i1]);
                        throw console.error("Failed to load font: ".concat(primary), error), error;
                    }), _i10 = 0; _i10 < names.length; _i10++) fontLoadPromises.set(names[_i10], loadPromise);
                    return loadPromise;
                ...
                Player = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Player-legacy-BXIAhPag.js");
                    }, void 0);
                }), Grid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Grid-legacy-Z2Nyr0Ef.js");
                    }, void 0);
                }), Loops = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Loops-legacy-D3S9wkhG.js");
                    }, void 0);
                }), Infinite = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Infinite-legacy-DVubgByu.js");
                    }, void 0);
                }), TMDBGrid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TMDBGrid-legacy-CfYGCCWu.js");
                    }, void 0);
                }), Portal = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Portal-legacy-Bn7luq_e.js");
                    }, void 0);
                }), MatrixPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Matrix-legacy-Bj25dUas.js");
                    }, void 0);
                }), TextPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Text-legacy-D_nkldcn.js");
                    }, void 0);
                }), TextPosterPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextPoster-legacy-BCslglYz.js");
                    }, void 0);
                }), CreatePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Create-legacy-CuVO9IUp.js");
                    }, void 0);
                }), ViewportPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Viewport-legacy-Di24GrWW.js");
                    }, void 0);
                }), PositioningPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Positioning-legacy-DchQk-MP.js");
                    }, void 0);
                }), LayoutPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Layout-legacy-CiWpUT6M.js");
                    }, void 0);
                }), FocusBasicsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusBasics-legacy-CGUZMfHs.js");
                    }, void 0);
                }), KeyHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./KeyHandling-legacy-iYYf9RtP.js");
                    }, void 0);
                }), TransitionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Transitions-legacy-Df7b99cJ.js");
                    }, void 0);
                }), ComponentsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Components-legacy-DViJW86W.js");
                    }, void 0);
                }), FocusHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusHandling-legacy-mp07oDEW.js");
                    }, void 0);
                }), GradientsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Gradients-legacy-DHuowywM.js");
                    }, void 0);
                }), FlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Flex-legacy-CpVDUsbQ.js");
                    }, void 0);
                }), FlexGrowPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexGrow-legacy-O-rGaJes.js");
                    }, void 0);
                }), FlexMenuPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexMenu-legacy-4D9_3CLU.js");
                    }, void 0);
                }), FlexSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexSize-legacy-wkLOSubH.js");
                    }, void 0);
                }), FlexColumnSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumnSize-legacy-BY9WU91R.js");
                    }, void 0);
                }), FlexColumnPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumn-legacy-DuvbAcjL.js");
                    }, void 0);
                }), ButtonsMaterialPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ButtonsMaterial-legacy-Cubh6vai.js");
                    }, void 0);
                }), SuperFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./SuperFlex-legacy-CWya0rlP.js");
                    }, void 0);
                }), Entity = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Entity-legacy-J7wX4_Gm.js");
                    }, void 0);
                }), People = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./People-legacy-DjzY1d9n.js");
                    }, void 0);
                }), FireboltPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Firebolt-legacy-DKMtu6iA.js");
                    }, void 0);
                }), LoginPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Login-legacy-CCqbi57n.js");
                    }, void 0);
                }), VirtualPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Virtual-legacy-anMFkOp3.js");
                    }, void 0);
                }), TagsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Tags-legacy-Dx33BDvR.js");
                    }, void 0);
                }), ImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ImagePerformance-legacy-TE9GrI_c.js");
                    }, void 0);
                }), LargeImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./LargeImagePerformance-legacy-BgUVsZoh.js");
                    }, void 0);
                }), MixedImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./MixedImagePerformance-legacy-LfL3ocOy.js");
                    }, void 0);
                }), TextureCompressionPerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextureCompressionPerformance-legacy-Cxto5fYW.js");
                    }, void 0);
                }), ComplexFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlex-legacy-v1fii4hZ.js");
                    }, void 0);
                }), ComplexFlexCapsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlexCaps-legacy-Ck3nXKQj.js");
                    }, void 0);
                }), BenchmarkPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Benchmark-legacy-7dMxbx2A.js");
                    }, void 0);
                }), RendererVersionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./RendererVersions-legacy-CIaHq33E.js");
                    }, void 0);
                }), TextCenteringPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextCentering-legacy-yFpcJpcd.js");
                    }, void 0);
                }), CountdownTimerPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CountdownTimer-legacy-DeWfXdoq.js");
                    }, void 0);
                }), CustomButtonsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CustomButtons-legacy-CGd95u5X.js");
                    }, void 0);
                }), FlexJustifyWidthPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexJustifyWidth-legacy-BnXKwtQL.js");
                    }, void 0);
                ...
                forceWebGL2 = "true" === urlParams.get("webgl2"), targetFPSParam = urlParams.get("targetFPS"), 
                targetFPS = targetFPSParam ? parseFloat(targetFPSParam) : 0, powerPreference = urlParams.get("powerPreference"), 
                framePacing = urlParams.get("framePacing"), textBaseline = urlParams.get("textBaseline"), 
                                                    ...
                                                    return [ createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./Nested-legacy-Dr8LAzYR.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./KeepAlive-legacy-CtpEvwaG.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./suspense-legacy-Guyr0eEt.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
