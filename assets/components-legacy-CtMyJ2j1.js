(function() {
    ...
    System.register([ "./render-legacy-zhspBKrd.js", "./utils-legacy-BzzMKxwG.js", "./chainFunctions-legacy-BbsnBFhX.js", "./Column-legacy-CugXt5cX.js", "./Row-legacy-BZXAAvsN.js", "./styles-legacy-Bdc4KjXs.js" ], function(_export, _context) {
        "use strict";
        ...
        function createVirtual(component, props, keyHandlers) {
            ...
            var selected = function selected() {
                ...
                if (props.wrap) return Math.max(bufferSize(), scrollIndex());
            ...
            var _createSignal3 = createSignal({
                ...
                atStart: true,
                cursor: 0
            }), _createSignal4 = _slicedToArray(_createSignal3, 2), slice = _createSignal4[0], setSlice = _createSignal4[1];
            ...
            function computeSlice(c, delta, prev) {
                ...
                if (start !== prev.start || newSlice.length === 0) newSlice = props.wrap ? Array.from({
                    length: length
                }, function(_, i) {
            ...
            var onSelectedChanged = function onSelectedChanged(_idx, elm, _active, _lastIdx) {
                ...
                queueMicrotask(function() {
                    ...
                    } else _this.lng[axis] = _this.lng[axis] + childSize * slice().shiftBy;
                });
            };
        ...
        function Poster(props) {
            return function() {
                ...
                setProp(_el$9, "onFail", function(node) {
        ...
        function PosterTitle(props) {
            return function() {
                ...
                setProp(_el$0, "onFail", function(node) {
                    return node.src = "./assets/fallback.png";
                });
        ...
        function Hero(props) {
            var _createSignal5 = createSignal(false), _createSignal6 = _slicedToArray(_createSignal5, 2), hasFocus = _createSignal6[0], setHasFocus = _createSignal6[1];
            return function() {
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                buttonStyles = _stylesLegacy00gJs.n;
