!function() {
    ...
    System.register([ "./rolldown-runtime-legacy-c5pELP7v.js", "./render-legacy-DGIMFHoj.js", "./FPSCounter-legacy-CqWX0CyR.js", "./Lazy-legacy-CPOKhmEz.js", "./ContentBlock-legacy-Ba2IgW8W.js", "./createFocusStack-legacy-C302dX_e.js", "./components-legacy-D4V4IEWy.js", "./styles-legacy--qMSUlWV.js", "./state-legacy-D3yNc7Vl.js", "./dist-legacy-DfRsX4se.js" ], function(_export, _context) {
        var __exportAll, For, closeImageBitmap, isTextureError, Config, batch, Show, activeElement, onCleanup, Texture, TextureErrorCode, createEffect, on, CoreShaderNode, createElement, CoreTextureManager, effect, memo, resolveFramePacing, resolveTargetFPS, use, createComponent, insert, setProp, clearFontPrefetch, frameTimeBucketLowerBound$1, createSignal, createTextNode, prefetchFont, insertNode, RendererMain, isAdvancedShaderProp, ImageTexture, renderer, TextureError, resolveShaderProps, TextureType, LinearGradientTemplate, RoundedTemplate, HolePunchTemplate, WebGlShaderProgram, ShadowTemplate, getBorderProps, resetCounter, BorderTemplate, RadialGradientTemplate, getShadowProps, LazyRow, LazyColumn, ContentBlock, useFocusStack, Hero, SHOW_TEXT, TitleRow, scaled, DISPLAY_SIZE, POSTER_SCALE, AssetPanel, styles_default, setGlobalBackground, debounce, _EdgeFadeTemplate, exports_exports, _histogram$FRAME_TIME, _histogram$frameTimeB, histogram, FRAME_TIME_BUCKET_COUNT, frameTimeBucketLowerBound;
        ...
        return {
            setters: [ function(_rolldownRuntimeLegacy001Js) {
                ...
                For = _renderLegacy002Js.A, closeImageBitmap = _renderLegacy002Js.Bt, isTextureError = _renderLegacy002Js.Ct, 
                Config = _renderLegacy002Js.D, batch = _renderLegacy002Js.I, Show = _renderLegacy002Js.N, 
                activeElement = _renderLegacy002Js.O, onCleanup = _renderLegacy002Js.Q, Texture = _renderLegacy002Js.Rt, 
                TextureErrorCode = _renderLegacy002Js.St, createEffect = _renderLegacy002Js.V, on = _renderLegacy002Js.Z, 
                CoreShaderNode = _renderLegacy002Js._t, createElement = _renderLegacy002Js.a, CoreTextureManager = _renderLegacy002Js.bt, 
                effect = _renderLegacy002Js.c, memo = _renderLegacy002Js.d, resolveFramePacing = _renderLegacy002Js.dt, 
                resolveTargetFPS = _renderLegacy002Js.ft, use = _renderLegacy002Js.g, createComponent = _renderLegacy002Js.i, 
                insert = _renderLegacy002Js.l, setProp = _renderLegacy002Js.m, clearFontPrefetch = _renderLegacy002Js.ot, 
                frameTimeBucketLowerBound$1 = _renderLegacy002Js.pt, createSignal = _renderLegacy002Js.q, 
                createTextNode = _renderLegacy002Js.s, prefetchFont = _renderLegacy002Js.st, insertNode = _renderLegacy002Js.u, 
                RendererMain = _renderLegacy002Js.ut, isAdvancedShaderProp = _renderLegacy002Js.vt, 
                ImageTexture = _renderLegacy002Js.wt, renderer = _renderLegacy002Js.x, TextureError = _renderLegacy002Js.xt, 
                resolveShaderProps = _renderLegacy002Js.yt, TextureType = _renderLegacy002Js.zt;
            ...
            execute: function() {
                _EdgeFadeTemplate = {
                    ...
                    resolveFramePacing: function(_resolveFramePacing) {
                        function resolveFramePacing() {
                            return _resolveFramePacing.apply(this, arguments);
                        }
                        return resolveFramePacing.toString = function() {
                            return _resolveFramePacing.toString();
                        }, resolveFramePacing;
                    }(function() {
                        return resolveFramePacing;
                    }),
                ...
                frameTimeBucketLowerBound = null !== (_histogram$frameTimeB = histogram.frameTimeBucketLowerBound) && void 0 !== _histogram$frameTimeB ? _histogram$frameTimeB : function() {
                    ...
                    return createComponent(Show, {
                        ...
                        get children() {
                            ...
                            setProp(_el$13, "zIndex", 200), setProp(_el$13, "style", overlayBgStyle), insertNode(_el$14, createTextNode("Benchmark (version: 1.9.1)")), 
