import { $ as onMount, A as For, d as memo, i as createComponent, n as Text, q as createSignal, r as View } from "./render-CAUp88iy.js";
...
function ComplexFlexCaps() {
    performance.mark("complexflexcaps-start"), onMount(() => {
        ...
        console.log(`ComplexFlexCaps Render duration: ${null == measure ? void 0 : measure.duration}ms`);
    });
