(function() {
    ...
    System.register([ "./render-legacy-D7c8BTw7.js", "./utils-legacy-CzRdMI-Y.js" ], function(_export, _context) {
        "use strict";
        var isFocused, assertTruthy, ElementNode, clamp, defaultTransitionBack, defaultTransitionForward, defaultTransitionDown, defaultTransitionUp, navigableForwardFocus, navigableHandleNavigation, InViewPort, isNotShown, scrollRow, scrollColumn, chainRefs;
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                isFocused = _renderLegacy001Js.T;
