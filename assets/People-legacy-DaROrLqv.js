(function() {
    ...
    System.register([ "./render-legacy-D7c8BTw7.js", "./Column-legacy-rnCxnZWI.js", "./components-legacy-CaYNBwMX.js", "./routing-legacy-CiZuoxoa.js", "./theme-legacy-CRa-Zkyx.js", "./styles-legacy-Bdc4KjXs.js", "./state-legacy-BYRVvbYV.js", "./api-legacy-CQ6iaaWY.js", "./ItemFormatter-legacy-WWdSuIiP.js" ], function(_export, _context) {
        "use strict";
        var createResource, Show, assertTruthy, createElement, effect, onMount, setProp, createComponent, insert, createTextNode, insertNode, Column, TileRow, useNavigate, useParams, theme_default, styles_default, setGlobalBackground, getImageUrl, api_default, convertItemsToTiles, People;
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                TileRow = _componentsLegacy00cJs.l;
            }, function(_routingLegacy00eJs) {
                useNavigate = _routingLegacy00eJs.d;
                useParams = _routingLegacy00eJs.f;
