import { $ as onMount, a as createElement, c as effect, i as createComponent, l as insert, m as setProp, s as createTextNode, u as insertNode } from "./render-DmwYINn_.js";
...
var ButtonIcon = props => (() => {
    ...
    effect(_$p => setProp(_el$2, "src", props.icon, _$p));
    return _el$;
})();
...
var CircleIcon = props => (() => {
    ...
    effect(_$p => setProp(_el$7, "src", props.icon, _$p));
    return _el$6;
})();
