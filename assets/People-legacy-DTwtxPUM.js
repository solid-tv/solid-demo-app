(function() {
    ...
    System.register([ "./index-legacy-VOFG1F7r.js" ], function(exports, module) {
        "use strict";
        var api, getImageUrl, convertItemsToTiles, useParams, useNavigate, createResource, onMount, setGlobalBackground, createComponent, Show, createElement, setProp, effect, insertNode, insert, styles, theme, Column, createTextNode, TileRow, assertTruthy;
        return {
            setters: [ function(module) {
                api = module.$;
                getImageUrl = module.a0;
                convertItemsToTiles = module.a1;
                useParams = module.a2;
                useNavigate = module.u;
                createResource = module.d;
                onMount = module.o;
                                    ...
                                    return createComponent(Show, {
                                        ...
                                        get children() {
                                            return [ function() {
                                                ...
                                                effect(function(_$p) {
                                                    return setProp(_el$6, "style", styles.RowTitle, _$p);
                                                });
                                                return _el$6;
...
//# sourceMappingURL=People-legacy-DTwtxPUM.js.map
