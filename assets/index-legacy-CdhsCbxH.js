    ...
    System.register([ "./rolldown-runtime-legacy-c5pELP7v.js", "./render-legacy-1jX59Y6X.js", "./FPSCounter-legacy-SIVR-QPN.js", "./utils-legacy-Dtp5ElZ_.js", "./mergeProps-legacy-8amjdkoE.js", "./announcer-legacy-DuyfvoA0.js", "./web-legacy-CZsMP84a.js", "./Lazy-legacy-Fi7IK0HJ.js", "./chainFunctions-legacy-Bpapim5k.js", "./Column-legacy-B6ilkF_Y.js", "./ContentBlock-legacy-BhIuJTeE.js", "./createFocusStack-legacy-CU5Kv8yw.js", "./components-legacy-Drl7FtOT.js", "./Icon-legacy-BXBAxH0J.js", "./routing-legacy-CrguWQCv.js", "./theme-legacy-Bdf29FvE.js", "./styles-legacy--qMSUlWV.js", "./state-legacy-B9YP9E7M.js", "./dist-legacy-DkoeBEbV.js", "./api-legacy-BrsqDpuo.js", "./ItemFormatter-legacy-CSpFnyiZ.js" ], function(_export, _context) {
        ...
        return {
            setters: [ function(_rolldownRuntimeLegacy001Js) {
                ...
                onMount = _renderLegacy002Js.$, createTextureCoords = _renderLegacy002Js.At, createWebGLContext = _renderLegacy002Js.Bt, 
                isElementNode = _renderLegacy002Js.C, uploadCompressedTexture = _renderLegacy002Js.Ct, 
                Config = _renderLegacy002Js.D, UNIT_TEXTURE_COORDS = _renderLegacy002Js.Dt, MAX_QUAD_BUFFER_SIZE = _renderLegacy002Js.Et, 
                getNormalizedRgbaComponents = _renderLegacy002Js.Ft, createRoot = _renderLegacy002Js.G, 
                createMemo = _renderLegacy002Js.H, batch = _renderLegacy002Js.I, getListener = _renderLegacy002Js.J, 
                children = _renderLegacy002Js.L, TextureType = _renderLegacy002Js.Lt, calcFactoredRadiusArray = _renderLegacy002Js.Mt, 
                Show = _renderLegacy002Js.N, clampUnit = _renderLegacy002Js.Nt, activeElement = _renderLegacy002Js.O, 
                WORDS_PER_QUAD = _renderLegacy002Js.Ot, compareRect = _renderLegacy002Js.Pt, onCleanup = _renderLegacy002Js.Q, 
                DIRTY_QUAD_BUFFER = _renderLegacy002Js.Rt, hasFocus = _renderLegacy002Js.S, isFunction = _renderLegacy002Js.T, 
                MAX_QUADS = _renderLegacy002Js.Tt, createEffect = _renderLegacy002Js.V, createResource = _renderLegacy002Js.W, 
                mergeProps = _renderLegacy002Js.X, getOwner = _renderLegacy002Js.Y, on = _renderLegacy002Js.Z, 
                ElementNode = _renderLegacy002Js._, createElement = _renderLegacy002Js.a, loadFonts = _renderLegacy002Js.b, 
                effect = _renderLegacy002Js.c, takeCanvasPrefetch = _renderLegacy002Js.ct, memo = _renderLegacy002Js.d, 
                rootNode = _renderLegacy002Js.f, defaultFontMetrics = _renderLegacy002Js.ft, use = _renderLegacy002Js.g, 
                spread = _renderLegacy002Js.h, CoreShaderNode = _renderLegacy002Js.ht, createComponent = _renderLegacy002Js.i, 
                untrack = _renderLegacy002Js.it, isHTMLImageElement = _renderLegacy002Js.jt, createIndexBuffer = _renderLegacy002Js.kt, 
                insert = _renderLegacy002Js.l, takeSdfPrefetch = _renderLegacy002Js.lt, setProp = _renderLegacy002Js.m, 
                normalizeFontMetrics = _renderLegacy002Js.mt, sharedConfig = _renderLegacy002Js.nt, 
                createRenderer = _renderLegacy002Js.o, mapTextLayout = _renderLegacy002Js.pt, createSignal = _renderLegacy002Js.q, 
                createTextNode = _renderLegacy002Js.s, runWithOwner = _renderLegacy002Js.tt, insertNode = _renderLegacy002Js.u, 
                focusPath = _renderLegacy002Js.v, UpdateType = _renderLegacy002Js.wt, renderer = _renderLegacy002Js.x, 
                useFocusManager = _renderLegacy002Js.y, createComputed = _renderLegacy002Js.z, _renderLegacy002Js.zt;
            ...
            execute: function() {
                ...
                nodesWaitingForFont$1 = Object.create(null), initialized$1 = !1, buildKerningTable = function(kernings) {
                    ...
                    function SdfRenderOp(renderer, shader, quadBufferCollection, renderOpTexture, worldAlpha, clippingRect, w, h) {
                        ...
                        _this3.quadBufferCollection = void 0, _this3.renderOpTexture = void 0, _this3.worldAlpha = void 0, 
                        _this3.clippingRect = void 0, _this3.w = void 0, _this3.h = void 0, _this3.numQuads = 0, 
                        _this3.time = 0, _this3.stage = void 0, _this3.startQuad = 0, _this3.translateX = 0, 
                        _this3.translateY = 0, _this3.renderer = renderer, _this3.shader = shader, _this3.quadBufferCollection = quadBufferCollection, 
                        _this3.renderOpTexture = renderOpTexture, _this3.worldAlpha = worldAlpha, _this3.clippingRect = clippingRect, 
                        _this3.w = w, _this3.h = h, _this3.stage = renderer.stage, _this3;
                    }
                ...
                WebGlCtxSubTexture = function(_WebGlCtxTexture) {
                    ...
                    function WebGlRenderer(options) {
                        ...
                        _this5.coreTextRenderOps = [], _this5.curBufferIdx = 0, _this5.curRenderOp = null, 
                        _this5.attachedShader = null, _this5.sdfBuffer = void 0, _this5.fSdfBuffer = void 0, 
                        _this5.uiSdfBuffer = void 0, _this5.sdfBufferIdx = 0, _this5.sdfQuadCount = 0, _this5.sdfQuadBufferCollection = void 0, 
                        _this5.curSdfRenderOp = null, _this5.sdfBufferChanged = !0, _this5.lastUploadedSdfSize = 0, 
                        _this5.sdfWriteSig = 0, _this5.lastUploadedSdfSig = 0, _this5.needsFullUpload = !0, 
                        _this5.defaultTextureCoords = UNIT_TEXTURE_COORDS, _this5.defaultShaderNode = null, 
                        _this5.quadBufferCollection = void 0, _this5.indexBuffer = null, _this5.clearColor = {
                            raw: 0,
                            normalized: [ 0, 0, 0, 0 ]
                    ...
                    return _inherits(WebGlRenderer, _CoreRenderer), _createClass(WebGlRenderer, [ {
                        ...
                        value: function(startQuad, glyphCount, dx, dy, atlasTexture, clippingRect, worldAlpha, width, height, sdfShader) {
                            ...
                            if (null === cur || cur.renderOpTexture !== atlasTexture || cur.translateX !== dx || cur.translateY !== dy || cur.worldAlpha !== worldAlpha || !0 !== compareRect(cur.clippingRect, clippingRect)) {
                                var opList = this.coreTextRenderOps, op = new SdfRenderOp(this, sdfShader, this.sdfQuadBufferCollection, atlasTexture, worldAlpha, clippingRect, width, height);
                ...
                Player = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Player-legacy-D9vJnSEV.js");
                    }, void 0);
                }), Grid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Grid-legacy-D0dbOd2I.js");
                    }, void 0);
                }), Loops = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Loops-legacy-gVNGSF1h.js");
                    }, void 0);
                }), Infinite = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Infinite-legacy-Dlo3E6uD.js");
                    }, void 0);
                }), TMDBGrid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TMDBGrid-legacy-DFySx97N.js");
                    }, void 0);
                }), Portal = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Portal-legacy-GlCGhlHa.js");
                    }, void 0);
                }), MatrixPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Matrix-legacy-FRq6yiuT.js");
                    }, void 0);
                }), TextPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Text-legacy-IRxw4SJq.js");
                    }, void 0);
                }), TextPosterPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextPoster-legacy-B_JvZ9UN.js");
                    }, void 0);
                }), CreatePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Create-legacy-BRU7bX-W.js");
                    }, void 0);
                }), ViewportPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Viewport-legacy-DU94LOpP.js");
                    }, void 0);
                }), PositioningPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Positioning-legacy-Cz9piPkQ.js");
                    }, void 0);
                }), LayoutPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Layout-legacy-Cf_OazTl.js");
                    }, void 0);
                }), FocusBasicsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusBasics-legacy-Idr68wEk.js");
                    }, void 0);
                }), KeyHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./KeyHandling-legacy-bQbCwyPg.js");
                    }, void 0);
                }), TransitionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Transitions-legacy-C9ev6Xjj.js");
                    }, void 0);
                }), ComponentsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Components-legacy-DfRBbR9w.js");
                    }, void 0);
                }), FocusHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusHandling-legacy-Dq2CfzdH.js");
                    }, void 0);
                }), GradientsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Gradients-legacy-BEStm8Xk.js");
                    }, void 0);
                }), FlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Flex-legacy-D_vAaz8N.js");
                    }, void 0);
                }), FlexGrowPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexGrow-legacy-DJnEfoEp.js");
                    }, void 0);
                }), FlexMenuPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexMenu-legacy-BpPvDM0z.js");
                    }, void 0);
                }), FlexSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexSize-legacy-BlCvNdT2.js");
                    }, void 0);
                }), FlexColumnSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumnSize-legacy-D5yQmdA_.js");
                    }, void 0);
                }), FlexColumnPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumn-legacy-B1F_32C8.js");
                    }, void 0);
                }), ButtonsMaterialPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ButtonsMaterial-legacy-c4UT42vm.js");
                    }, void 0);
                }), SuperFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./SuperFlex-legacy-roL-XbRV.js");
                    }, void 0);
                }), Entity = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Entity-legacy-2lOfpsnJ.js");
                    }, void 0);
                }), People = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./People-legacy-B2wflT2f.js");
                    }, void 0);
                }), FireboltPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Firebolt-legacy-CG5sJnK0.js");
                    }, void 0);
                }), LoginPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Login-legacy-ChLihtE0.js");
                    }, void 0);
                }), VirtualPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Virtual-legacy-yYfcohq0.js");
                    }, void 0);
                }), TagsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Tags-legacy-DZ-IeofQ.js");
                    }, void 0);
                }), ImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ImagePerformance-legacy-BKD6Gd0q.js");
                    }, void 0);
                }), LargeImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./LargeImagePerformance-legacy-D6e6Fq7b.js");
                    }, void 0);
                }), MixedImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./MixedImagePerformance-legacy-Cw9TpAXj.js");
                    }, void 0);
                }), TextureCompressionPerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextureCompressionPerformance-legacy-CQprwBRc.js");
                    }, void 0);
                }), ComplexFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlex-legacy-CUWNNats.js");
                    }, void 0);
                }), ComplexFlexCapsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlexCaps-legacy-BcFQNReN.js");
                    }, void 0);
                }), BenchmarkPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Benchmark-legacy-DDtF_YUz.js");
                    }, void 0);
                }), RendererVersionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./RendererVersions-legacy-BwG9g_o4.js");
                    }, void 0);
                }), TextCenteringPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextCentering-legacy-CclHJOAx.js");
                    }, void 0);
                }), CountdownTimerPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CountdownTimer-legacy-Dmi437YW.js");
                    }, void 0);
                }), CustomButtonsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CustomButtons-legacy-cuTJIiy-.js");
                    }, void 0);
                                                    ...
                                                    return [ createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./Nested-legacy-BLs3c_gU.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./KeepAlive-legacy-CUSoI0cT.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./suspense-legacy-COu0wPpB.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
