import { a as createSignal, o as onMount, s as setGlobalBackground, c as createComponent, V as View, T as Text } from "./index-BWp1BgUH.js";
...
const RendererVersionsPage = () => {
    ...
    const onEnter = () => {
        window.location.href = "https://lightning-tv.github.io/solid-demo-app/".concat(version(), "/#/benchmark");
        return true;
    };
    const Container = {
        width: 1e3,
