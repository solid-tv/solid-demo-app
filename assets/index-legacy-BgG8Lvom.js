            ...
            execute: function execute() {
                ...
                WebGlShaderNode = function(_CoreShaderNode) {
                    function WebGlShaderNode(shaderKey, config, program, stage, props) {
                        ...
                        _this2.beforeDrawFn = void 0;
                        _this2.valueKey = "";
                        _this2.additionalTextureCount = 0;
                        _this2.uniforms = {
                        ...
                        if (config.beforeDraw !== void 0) {
                            _this2.beforeDrawFn = config.beforeDraw;
                            _this2.beforeDraw = function() {
                                _this2.additionalTextureCount = 0;
                                _this2.beforeDrawFn(_this2.node, _this2.props);
                            };
                        }
                        return _this2;
                    }
                    ...
                    return _createClass(WebGlShaderNode, [ {
                        key: "bindTexture",
                        value: function bindTexture(location, texture) {
                            var glw = this.program.glw;
                            var targetId = this.additionalTextureCount + this.node.renderOpTextures.length;
                            this.uniform1i(location, targetId);
                            this.additionalTextureCount++;
                            if (texture.state === "loaded") {
                                glw.activeTexture(targetId);
                                var nativeTexture = texture.ctxTexture.ctxTexture;
                    ...
                    return _createClass(WebGlCtxTexture, [ {
                        ...
                        value: function() {
                            var _onLoadRequest = _asyncToGenerator(_regenerator().m(function _callee4() {
                                var glw, textureData, w, h, tdata, format, formatBytes, memoryPadding, isImageBitmap, isHTMLCanvas, unpackPremultiply, _textureData$premulti, _mipmaps$0$byteLength, _mipmaps$, mipmaps, _type, blockInfo;
                                return _regenerator().w(function(_context5) {
                                    while (1) switch (_context5.n) {
                                      ...
                                      case 1:
                                        ...
                                        isHTMLCanvas = typeof HTMLCanvasElement !== "undefined" && tdata instanceof HTMLCanvasElement;
                ...
                SDF_PLAIN_FLOATS_PER_VERTEX = 6;
                SDF_RICH_FLOATS_PER_VERTEX = 7;
                SdfBuffer = function() {
                    function SdfBuffer(glw, layout) {
                        var initialBytes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 512 * 1024;
                        this.layout = void 0;
                    ...
                    return _createClass(SdfBuffer, [ {
                        key: "ensureCapacity",
                        value: function ensureCapacity(requiredFloats) {
                            var f = this.fBuffer;
                            if (requiredFloats <= f.length) return;
                            var newCapacity = f.length * 2;
                            while (newCapacity < requiredFloats) newCapacity *= 2;
                            var newBuffer = new ArrayBuffer(newCapacity * Float32Array.BYTES_PER_ELEMENT);
                            var newF = new Float32Array(newBuffer);
                            newF.set(f);
                        ...
                        key: "createBufferCollection",
                        value: function createBufferCollection(glw, glBuffer) {
                            var floatsPerVertex = this.floatsPerVertex;
                ...
                SdfRenderOp = function(_CoreRenderOp) {
                    function SdfRenderOp(renderer, shader, sdfBuffer, worldAlpha, clippingRect, w, h, rtt, parentHasRenderTexture, framebufferDimensions) {
                        var _this5;
                        _this5 = _callSuper(this, SdfRenderOp);
                        _this5.renderer = void 0;
                        _this5.shader = void 0;
                        _this5.sdfBuffer = void 0;
                        _this5.worldAlpha = void 0;
                        _this5.clippingRect = void 0;
                        _this5.w = void 0;
                        _this5.h = void 0;
                        _this5.rtt = void 0;
                        _this5.parentHasRenderTexture = void 0;
                        _this5.framebufferDimensions = void 0;
                        _this5.numQuads = 0;
                        _this5.isCoreNode = false;
                        _this5.renderOpTextures = [];
                        _this5.time = 0;
                        _this5.stage = void 0;
                        _this5.startQuad = 0;
                        _this5.renderer = renderer;
                        _this5.shader = shader;
                        _this5.sdfBuffer = sdfBuffer;
                        _this5.worldAlpha = worldAlpha;
                        _this5.clippingRect = clippingRect;
                        _this5.w = w;
                        _this5.h = h;
                        _this5.rtt = rtt;
                        _this5.parentHasRenderTexture = parentHasRenderTexture;
                        _this5.framebufferDimensions = framebufferDimensions;
                        _this5.stage = renderer.stage;
                        return _this5;
                    }
                    ...
                    return _createClass(SdfRenderOp, [ {
                        ...
                        value: function addTexture(texture) {
                            ...
                            for (var i = 0; i < length; i++) if (renderOpTextures[i] === texture) return i;
                ...
                WebGlCtxRenderTexture = function(_WebGlCtxTexture2) {
                    function WebGlCtxRenderTexture(glw, memManager, textureSource) {
                        var _this6;
                        _this6 = _callSuper(this, WebGlCtxRenderTexture, [ glw, memManager, textureSource ]);
                        _this6.framebuffer = null;
                        _this6.txCoords = {
                            x1: 0,
                            y1: 1,
                            x2: 1,
                ...
                _PACKED_WHITE$1 = 4294967295;
                _mergeSdfSpanColor = function _mergeSdfSpanColor(nodeColor, spanColor) {
                    if (spanColor === _PACKED_WHITE$1) return nodeColor;
                    var nr = nodeColor & 255;
                    var ng = nodeColor >>> 8 & 255;
                    var nb = nodeColor >>> 16 & 255;
                    var na = nodeColor >>> 24 & 255;
                    var sr = spanColor & 255;
                    var sg = spanColor >>> 8 & 255;
                    var sb = spanColor >>> 16 & 255;
                    var sa = spanColor >>> 24 & 255;
                    var r = nr * sr + 127 >> 8;
                    var g = ng * sg + 127 >> 8;
                    var b = nb * sb + 127 >> 8;
                    var a = na * sa + 127 >> 8;
                ...
                WebGlRenderer = function(_CoreRenderer) {
                    function WebGlRenderer(stage) {
                        var _this7;
                        _this7 = _callSuper(this, WebGlRenderer, [ stage ]);
                        _this7.glw = void 0;
                        _this7.system = void 0;
                        _this7.quadBuffer = void 0;
                        _this7.fQuadBuffer = void 0;
                        _this7.uiQuadBuffer = void 0;
                        _this7.renderOps = [];
                        _this7.curBufferIdx = 0;
                        _this7.curRenderOp = null;
                        _this7.rttNodes = [];
                        _this7.activeRttNode = null;
                        _this7.needsFullUpload = true;
                        _this7.lastUploadedBufferSize = 0;
                        _this7.dirtyQuadCount = 0;
                        _this7.rttQuadBuffer = null;
                        _this7.fRttQuadBuffer = null;
                        _this7.uiRttQuadBuffer = null;
                        _this7._quadScratchBuffer = new ArrayBuffer(20 * Float32Array.BYTES_PER_ELEMENT);
                        _this7._quadScratchF = new Float32Array(_this7._quadScratchBuffer);
                        _this7.sdfBufferPlain = void 0;
                        _this7.sdfBufferRich = void 0;
                        _this7.curSdfRenderOp = null;
                        _this7.defaultTextureCoords = {
                            x1: 0,
                            y1: 0,
                            x2: 1,
                            y2: 1
                        };
                        _this7.defaultShaderNode = null;
                        _this7.quadBufferCollection = void 0;
                        _this7.stencilClipProgram = null;
                        _this7.stencilDepth = 0;
                        _this7.stencilQuadBufferCollection = null;
                        _this7.stencilOpPool = [];
                        _this7.stencilOpPoolIdx = 0;
                        _this7._stencilScratchBuffer = new ArrayBuffer(20 * Float32Array.BYTES_PER_ELEMENT);
                        _this7._stencilScratchF = new Float32Array(_this7._stencilScratchBuffer);
                        _this7._stencilScratchU = new Uint32Array(_this7._stencilScratchBuffer);
                        _this7.clearColor = {
                            raw: 0,
                            normalized: [ 0, 0, 0, 0 ]
                        };
                        _this7.quadBufferUsage = 0;
                        _this7.numQuadsRendered = 0;
                        _this7.renderToTextureActive = false;
                        _this7.quadBuffer = new ArrayBuffer(stage.options.quadBufferSize);
                        _this7.fQuadBuffer = new Float32Array(_this7.quadBuffer);
                        _this7.uiQuadBuffer = new Uint32Array(_this7.quadBuffer);
                        _this7.mode = "webgl";
                        var platform = stage.platform;
                        var canvas = platform.canvas;
                        var glw = _this7.glw = platform.createContext();
                        glw.viewport(0, 0, canvas.width, canvas.height);
                        _this7.updateClearColor(stage.clearColor);
                        glw.setBlend(true);
                        glw.blendFunc(glw.ONE, glw.ONE_MINUS_SRC_ALPHA);
                        createIndexBuffer(glw, stage.bufferMemory);
                        _this7.system = {
                            parameters: getWebGlParameters(_this7.glw),
                            extensions: getWebGlExtensions(_this7.glw)
                        };
                        var quadBuffer = glw.createBuffer();
                        var stride = 5 * Float32Array.BYTES_PER_ELEMENT;
                        var maxQuads = ~~(_this7.stage.bufferMemory / 80);
                        ...
                        _this7.quadBufferCollection = new BufferCollection([ {
                            buffer: quadBuffer,
                            attributes: {
                                a_position: {
                                    name: "a_position",
                        ...
                        var stencilStride = 5 * Float32Array.BYTES_PER_ELEMENT;
                        glw.arrayBufferData(stencilBuf, new Float32Array(20), glw.DYNAMIC_DRAW);
                        _this7.stencilQuadBufferCollection = new BufferCollection([ {
                            buffer: stencilBuf,
                            attributes: {
                                a_position: {
                                    name: "a_position",
                        ...
                        _this7.sdfBufferPlain = new SdfBuffer(glw, "plain");
                        _this7.sdfBufferRich = new SdfBuffer(glw, "rich");
                        return _this7;
                    }
                    ...
                    return _createClass(WebGlRenderer, [ {
                        ...
                        value: function addQuad(node) {
                            var isRTT = this.renderToTextureActive === true;
                        ...
                        key: "addSdfQuads",
                        value: function addSdfQuads(sdfBuffer, glyphs, glyphCount, fontScale, transform, color, worldAlpha, distanceRange, atlasTexture, clippingRect, width, height, parentHasRenderTexture, framebufferDimensions, sdfShader) {
                            if (glyphCount === 0) return;
                            sdfBuffer.changed = true;
                            var isRich = sdfBuffer.layout === "rich";
                            var floatsPerVertex = sdfBuffer.floatsPerVertex;
                            var glyphStride = isRich ? 12 : 8;
                            var idx = sdfBuffer.idx;
                            sdfBuffer.ensureCapacity(idx + glyphCount * floatsPerVertex * 4);
                            var f = sdfBuffer.fBuffer;
                            var u = sdfBuffer.uiBuffer;
                            var uGlyphs = new Uint32Array(glyphs.buffer, glyphs.byteOffset, glyphs.length);
                            ...
                            var packedNodeColor = (r | g << 8 | b << 16 | a << 24) >>> 0;
                            ...
                            var m6 = transform[6];
                            var m7 = transform[7];
                            var startQuad = sdfBuffer.quadCount;
                            var go = 0;
                            for (var gi = 0; gi < glyphCount; gi++) {
                                ...
                                var packedColor = packedNodeColor;
                                var style = 0;
                                var shearTop = 0;
                                var shearBot = 0;
                                if (isRich) {
                                ...
                                go += glyphStride;
                                var sx1t = gx1 + shearTop;
                                var sx2t = gx2 + shearTop;
                                var sx1b = gx1 + shearBot;
                                var sx2b = gx2 + shearBot;
                                var wx_tl = m0 * sx1t + m3 * gy1 + m6;
                                var wy_tl = m1 * sx1t + m4 * gy1 + m7;
                                var wx_tr = m0 * sx2t + m3 * gy1 + m6;
                                var wy_tr = m1 * sx2t + m4 * gy1 + m7;
                                var wx_bl = m0 * sx1b + m3 * gy2 + m6;
                                var wy_bl = m1 * sx1b + m4 * gy2 + m7;
                                var wx_br = m0 * sx2b + m3 * gy2 + m6;
                                var wy_br = m1 * sx2b + m4 * gy2 + m7;
                                f[idx] = wx_tl;
                                f[idx + 1] = wy_tl;
                                f[idx + 2] = u1;
                                f[idx + 3] = v1;
                        ...
                        value: function addSdfCachedQuads(sdfBuffer, cachedVertices, numGlyphs, atlasTexture, clippingRect, worldAlpha, width, height, parentHasRenderTexture, framebufferDimensions, sdfShader) {
                        ...
                        value: function addSdfTranslatedQuads(sdfBuffer, cachedVertices, numGlyphs, dx, dy, atlasTexture, clippingRect, worldAlpha, width, height, parentHasRenderTexture, framebufferDimensions, sdfShader) {
                            if (numGlyphs === 0) return;
                            sdfBuffer.changed = true;
                            var startQuad = sdfBuffer.quadCount;
                            var idx = sdfBuffer.idx;
                            ...
                            var floatsPerVertex = sdfBuffer.floatsPerVertex;
                            for (var i = idx; i < end; i += floatsPerVertex) {
                                f[i] = f[i] + dx;
                                f[i + 1] = f[i + 1] + dy;
                            }
                            sdfBuffer.idx = end;
                        ...
                        value: function finalizeSdfBatch(sdfBuffer, startQuad, glyphCount, atlasTexture, clippingRect, worldAlpha, width, height, parentHasRenderTexture, framebufferDimensions, sdfShader) {
                            ...
                            if (canBatch === false) {
                                var op = new SdfRenderOp(this, sdfShader, sdfBuffer, worldAlpha, clippingRect, width, height, false, parentHasRenderTexture, framebufferDimensions);
                        ...
                        key: "uploadSdfBufferLayout",
                        value: function uploadSdfBufferLayout(sdfBuffer) {
                            if (sdfBuffer.idx === 0) return;
                            if (sdfBuffer.changed === false && sdfBuffer.idx === sdfBuffer.lastUploadedSize) return;
                            var glw = this.glw;
                            var sdfBuf = sdfBuffer.quadBufferCollection.getBuffer("a_position") || null;
                            var sdfArr = new Float32Array(sdfBuffer.buffer, 0, sdfBuffer.idx);
                        ...
                        value: function render() {
                            ...
                            var nodes = this.stage.renderListNodes;
                            if (fullUpload === true) {
                                ...
                                for (var i = 0; i < this.stage.renderListLen; i++) nodes[i].isQuadDirty = false;
                            } else {
                                var scratch = this._quadScratchF;
                                var f = this.fQuadBuffer;
                                for (var _i6 = 0; _i6 < this.stage.renderListLen; _i6++) {
                                    var node = nodes[_i6];
                                    if (node.isQuadDirty === true && node.quadBufferIndex !== -1) {
                                        var slot = node.quadBufferIndex;
                                        for (var j = 0; j < 20; j++) scratch[j] = f[slot + j];
                            ...
                            for (var _i7 = 0, length = this.renderOps.length; _i7 < length; _i7++) {
                                var op = this.renderOps[_i7];
                            ...
                            var QUAD_SIZE_IN_BYTES = 4 * (5 * BYTES);
                        ...
                        value: function renderRTTNodes() {
                            ...
                            for (var i = 0; i < this.rttNodes.length; i++) {
                                ...
                                this.curBufferIdx = 0;
                                this.curRenderOp = null;
                                for (var _i8 = 0; _i8 < node.children.length; _i8++) {
                                    var child = node.children[_i8];
                        ...
                        value: function invalidateQuadBuffer() {
                            var nodes = this.stage.renderListNodes;
                            for (var i = 0; i < this.stage.renderListLen; i++) {
                                var node = nodes[i];
                ...
                SdfPlain = {
                    vertex: "\n    # ifdef GL_FRAGMENT_PRECISION_HIGH\n    precision highp float;\n    # else\n    precision mediump float;\n    # endif\n    ".concat(sharedVertexAttributes, "\n    ").concat(sharedVertexMain, "\n  "),
                ...
                renderQuads$1 = function renderQuads$1(renderer, layout, _vertexBuffer, renderProps) {
                    ...
                    var isRich = layout.richText === true;
                    var sdfBuffer = isRich ? webGlRenderer.sdfBufferRich : webGlRenderer.sdfBufferPlain;
                    var shader = isRich ? sdfShader : sdfPlainShader;
                    ...
                    if (cache !== void 0) {
                        ...
                        if (len > 0) {
                            ...
                            cache.lastWriteDirty = false;
                            var _t2 = renderProps.globalTransform;
                ...
                _writeDecoRecord = function _writeDecoRecord(glyphs, u32Glyphs, di, x1, x2, y1, y2, color, shear1, shear2) {
                    glyphs[di] = x1;
                    glyphs[di + 1] = y1;
                    glyphs[di + 2] = x2 - x1;
                    glyphs[di + 3] = y2 - y1;
                ...
                generateTextLayout = function generateTextLayout(props, fontCache) {
                    ...
                    if (richText === false) {
                        ...
                        var _glyphs = new Float32Array(_glyphCount * 8);
                        var go = 0;
                        var _currentX = 0;
                        var _currentY = 0;
                        for (var _i9 = 0; _i9 < lineAmount; _i9++) {
                            ...
                            try {
                                for (_iterator8.s(); !(_step8 = _iterator8.n()).done; ) {
                                    ...
                                    _glyphs[go] = x1;
                                    _glyphs[go + 1] = y1;
                                    _glyphs[go + 2] = glyph.width;
                                    _glyphs[go + 3] = glyph.height;
                                    _glyphs[go + 4] = u1;
                                    _glyphs[go + 5] = v1;
                                    _glyphs[go + 6] = glyph.width / atlasWidth;
                                    _glyphs[go + 7] = glyph.height / atlasHeight;
                                    go += 8;
                    ...
                    var glyphs = new Float32Array(totalQuadCount * 12);
                    var u32Glyphs = new Uint32Array(glyphs.buffer);
                    var gi = 0;
                    var di = glyphCount * 12;
                    strippedPos = 0;
                    curSpanIdx = 0;
                    var currentX = 0;
                    var currentY = 0;
                    for (var _i1 = 0; _i1 < lineAmount; _i1++) {
                        var _line3 = lines[_i1];
                        ...
                        try {
                            for (_iterator0.s(); !(_step0 = _iterator0.n()).done; ) {
                                ...
                                var shearBot = spanItalic ? (baseline - y2) * ITALIC_SHEAR : 0;
                                var style = spanBold ? 1 : 0;
                                glyphs[gi] = _x3;
                                glyphs[gi + 1] = _y;
                                glyphs[gi + 2] = _glyph.width;
                                glyphs[gi + 3] = _glyph.height;
                                glyphs[gi + 4] = _u;
                                glyphs[gi + 5] = _v;
                                glyphs[gi + 6] = _glyph.width / atlasWidth;
                                glyphs[gi + 7] = _glyph.height / atlasHeight;
                                ...
                                if (spanStrikethrough === true) {
                                    ...
                                    di = _writeDecoRecord(glyphs, u32Glyphs, di, decoX1, decoX1 + advance, _dy, _dy2, packedColor, _dShear, _dShear2);
                                }
                                strippedPos++;
                            }
                        } catch (err) {
                ...
                _loadFont = function() {
                    ...
                    return function _loadFont(_x4, _x5) {
                ...
                _measureText = function _measureText(text, _fontFamily, letterSpacing) {
                ...
                renderText = function renderText(props) {
                    ...
                    var letterSpacing = props.letterSpacing || 0;
                    ...
                    } else for (var _i10 = 0; _i10 < lineAmount; _i10++) {
                        var _line4 = lines[_i10];
                                ...
                                return _regenerator().w(function(_context9) {
                                    while (1) switch (_context9.p = _context9.n) {
                                      ...
                                      case 4:
                                        _context9.p = 4;
                                        _t3 = _context9.v;
                                        this.textureSource.setState("failed", _t3);
                                        this.textureSource.freeTextureData();
                                        throw _t3;
                            ...
                            var _onLoadRequest4 = _asyncToGenerator(_regenerator().m(function _callee9(data) {
                                ...
                                return _regenerator().w(function(_context0) {
                                    while (1) switch (_context0.n) {
                                      ...
                                      case 1:
                                        if (!(typeof ImageBitmap !== "undefined" && data instanceof ImageBitmap || typeof HTMLCanvasElement !== "undefined" && data instanceof HTMLCanvasElement || data instanceof HTMLImageElement)) {
                                            _context0.n = 2;
                                            break;
                                        }
                                        this.image = data;
                    ...
                    function CanvasShaderNode(shaderKey, config, stage, props) {
                        ...
                        if (config.update !== void 0) {
                            ...
                            _this9.update = function() {
                                ...
                                if (prevKey.length > 0) stage.shManager.mutateShaderValueUsage(prevKey, -1);
                                var computed = stage.shManager.getShaderValues(_this9.valueKey);
                                if (computed !== void 0) _this9.computed = computed;
                                _this9.computed = {};
                                _this9.updater(_this9.node);
                                stage.shManager.setShaderValues(_this9.valueKey, _this9.computed);
                            };
                        }
                        return _this9;
                    }
                ...
                CanvasRenderer = function(_CoreRenderer2) {
                    function CanvasRenderer(stage) {
                        var _this0;
                        _this0 = _callSuper(this, CanvasRenderer, [ stage ]);
                        _this0.context = void 0;
                        _this0.canvas = void 0;
                        _this0.pixelRatio = void 0;
                        _this0.clearColor = void 0;
                        _this0.renderToTextureActive = false;
                        _this0.activeRttNode = null;
                        _this0.mode = "canvas";
                        var canvas = stage.platform.canvas;
                        _this0.canvas = canvas;
                        _this0.context = canvas.getContext("2d");
                        _this0.pixelRatio = stage.pixelRatio;
                        _this0.clearColor = normalizeCanvasColor(stage.clearColor);
                        return _this0;
                    }
                        ...
                        value: function addQuad(node) {
                            ...
                            if (hasShader === true) {
                                var renderContext = function renderContext() {
                                    _this1.renderContext(node, texture);
                                };
                ...
                Player = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Player-legacy-Fn1ybW3p.js");
                    }, void 0);
                });
                Grid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Grid-legacy-DgR8JgXY.js");
                    }, void 0);
                });
                Loops = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Loops-legacy-BuAdiD5c.js");
                    }, void 0);
                });
                Infinite = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Infinite-legacy-DwzLq0-u.js");
                    }, void 0);
                });
                TMDBGrid = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TMDBGrid-legacy-BBXv1iJ4.js");
                    }, void 0);
                });
                Portal = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Portal-legacy-BThHALiR.js");
                    }, void 0);
                });
                MatrixPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Matrix-legacy-DAhzu8xF.js");
                    }, void 0);
                });
                TextPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Text-legacy-C-PobNOx.js");
                    }, void 0);
                });
                TextPosterPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextPoster-legacy-DPIa-rkn.js");
                    }, void 0);
                });
                CreatePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Create-legacy-DYYUOdrx.js");
                    }, void 0);
                });
                ViewportPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Viewport-legacy-BmZdxJNq.js");
                    }, void 0);
                });
                PositioningPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Positioning-legacy-zz_6J7gt.js");
                    }, void 0);
                });
                LayoutPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Layout-legacy-BEHEmc0N.js");
                    }, void 0);
                });
                FocusBasicsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusBasics-legacy-DowN_FUI.js");
                    }, void 0);
                });
                KeyHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./KeyHandling-legacy-C_3y8a9-.js");
                    }, void 0);
                });
                TransitionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Transitions-legacy-Odaf41P1.js");
                    }, void 0);
                });
                ComponentsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Components-legacy-NE4shwMV.js");
                    }, void 0);
                });
                FocusHandlingPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FocusHandling-legacy-CoscA3u_.js");
                    }, void 0);
                });
                GradientsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Gradients-legacy-Cy_X2-Sj.js");
                    }, void 0);
                });
                FlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Flex-legacy-lQS8FKb6.js");
                    }, void 0);
                });
                FlexGrowPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexGrow-legacy-BS9EcCIx.js");
                    }, void 0);
                });
                FlexMenuPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexMenu-legacy-MczVqQmz.js");
                    }, void 0);
                });
                FlexSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexSize-legacy-DA3Ez15B.js");
                    }, void 0);
                });
                FlexColumnSizePage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumnSize-legacy-Dw9cYmrB.js");
                    }, void 0);
                });
                FlexColumnPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./FlexColumn-legacy-BYrY3u1e.js");
                    }, void 0);
                });
                ButtonsMaterialPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ButtonsMaterial-legacy-Dtq75Dws.js");
                    }, void 0);
                });
                SuperFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./SuperFlex-legacy-BlG8VXYW.js");
                    }, void 0);
                });
                Entity = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Entity-legacy-BOET3G3S.js");
                    }, void 0);
                });
                People = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./People-legacy-D41pnSbK.js");
                    }, void 0);
                });
                FireboltPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Firebolt-legacy-C6V6-poJ.js");
                    }, void 0);
                });
                LoginPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Login-legacy-DLQ-807E.js");
                    }, void 0);
                });
                VirtualPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Virtual-legacy-DR3heuCs.js");
                    }, void 0);
                });
                TagsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Tags-legacy-C-V5KBWo.js");
                    }, void 0);
                });
                ImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ImagePerformance-legacy-CHtN5Z1q.js");
                    }, void 0);
                });
                LargeImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./LargeImagePerformance-legacy-D1TqvEsC.js");
                    }, void 0);
                });
                MixedImagePerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./MixedImagePerformance-legacy-tthAHLOR.js");
                    }, void 0);
                });
                TextureCompressionPerformance = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextureCompressionPerformance-legacy-CvF15NzE.js");
                    }, void 0);
                });
                ComplexFlexPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlex-legacy-DYFpua-P.js");
                    }, void 0);
                });
                ComplexFlexCapsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./ComplexFlexCaps-legacy-BNjHQuOo.js");
                    }, void 0);
                });
                BenchmarkPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./Benchmark-legacy-Gl4xoMg-.js");
                    }, void 0);
                });
                RendererVersionsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./RendererVersions-legacy-BH22oLxq.js");
                    }, void 0);
                });
                TextCenteringPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./TextCentering-legacy-DPhnY2Ah.js");
                    }, void 0);
                });
                CountdownTimerPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CountdownTimer-legacy-Cc9MBHqf.js");
                    }, void 0);
                });
                CustomButtonsPage = lazy(function() {
                    return __vitePreload(function() {
                        return _context.import("./CustomButtons-legacy-DYvYasdj.js");
                    }, void 0);
                });
                                                    ...
                                                    return [ createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./Nested-legacy-D8D72hXX.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./KeepAlive-legacy-CSEsM4ym.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
                                                        ...
                                                        get component() {
                                                            return lazy(function() {
                                                                return __vitePreload(function() {
                                                                    return _context.import("./suspense-legacy-DK_MEs2U.js");
                                                                }, void 0);
                                                            });
                                                        }
                                                    }), createComponent(Route, {
