...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        settings = {
            ...
            textBaselineMode: (_i = settings.textBaselineMode) != null ? _i : "optical",
...
async function loadFonts(fonts2) {
    ...
    await Promise.all(fonts2.map(font2 => {
        if (renderer$2.stage.renderer.mode === "webgl" && "type" in font2 && (font2.type === "msdf" || font2.type === "ssdf")) {
            return renderer$2.stage.loadFont("sdf", font2);
        }
        if ("fontUrl" in font2) {
            if (enableDomRenderer) {
                loadFontToDom(font2);
            } else if (renderer$2.stage.renderer.mode !== "webgl") {
                return renderer$2.stage.loadFont("canvas", font2);
            }
        }
    }));
}
...
const [activeElement, setActiveElementSignal] = createSignal(void 0);
...
const generateTextLayout = (props2, fontCache2) => {
    ...
    const trimmedHeight = lineAmount > 0 ? metrics.capHeight - metrics.descender + (lineAmount - 1) * lineHeightPx : 0;
    return {
        glyphs: glyphs,
...
function TitleRow(props2) {
    ...
    return (() => {
        ...
        insertNode(_el$, _el$2);
        setProp(_el$, "forwardFocus", 1);
        setProp(_el$, "marginTop", 30);
        setProp(_el$2, "skipFocus", true);
        setProp(_el$2, "style", titleRowStyles);
        insert(_el$2, () => props2.title);
        insert(_el$, createComponent(VirtualRow, {
            gap: 20,
            displaySize: 8,
            bufferSize: 3,
            get each() {
        ...
        effect(_$p => setProp(_el$, "height", props2.height, _$p));
        return _el$;
    })();
}
...
const Player = lazy(() => __vitePreload(() => import("./Player-BjuSVnmx.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-Dpj_mJ2a.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-BzG4yGCf.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BvU8oZmX.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-C5qDa4a0.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-C3WzW43r.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BtKYpZUd.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-BZ5ynRn2.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DUg2Mzvn.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-CSWTSKJ4.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-Bof6xang.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-C1qNgKfL.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-COZTr4HR.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-D389H8Bp.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DDbG55vF.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-C3OEM7pF.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BmAayw0O.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Pf0GCtuE.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-eveTCMVy.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-B5gJ1XHz.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-DQeW9Ebl.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-C3AKpyEr.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-DamzvcRG.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-D7oWrbqD.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-BuQZgfWg.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DJRjBUj3.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Bj5Oh6bm.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-B0qg35aW.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DXRcbLO8.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-b5d9B3F7.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CHA93QQE.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-B-aANald.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-BDARWAvx.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-C_Va8UDw.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-Duixyq86.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-B7Hs68LC.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-Dk0JGerC.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-BS5A9KYB.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-B5h3wtl9.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-Fpm84jJ9.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-DmtY6xZ4.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-7ZnAwTCb.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-B3tCRaYS.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-B_rjAK5E.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
