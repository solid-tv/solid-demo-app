(function() {
    ...
    System.register([ "./index-legacy-CH_leuvv.js" ], function(exports, module) {
        "use strict";
        var createSignal, createResource, createComputed, batch, theme, createSelector, createEffect, on, onMount, setGlobalBackground, createElement, setProp, insert, createComponent, Column, Index, effect, insertNode;
        return {
            setters: [ function(module) {
                createSignal = module.b;
                createResource = module.d;
                createComputed = module.e;
                batch = module.f;
                theme = module.t;
            ...
            execute: function execute() {
                ...
                var Grid = exports("default", function() {
                    ...
                    return function() {
                        ...
                        effect(function(_$p) {
                            return setProp(_el$5, "style", styles.itemsContainer, _$p);
                        });
                        return _el$5;
                    }();
                });
...
//# sourceMappingURL=Grid-legacy-CKMd5nxv.js.map
