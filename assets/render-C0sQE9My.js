...
var CoreNode = class extends EventEmitter {
    ...
    updateBoundingRect() {
        ...
        const renderCoords = this.renderCoords;
    ...
    draw(renderer) {
        ...
        const quadIdx = this.renderOpBufferIdx / 16 * 6 * 2;
...
var AnimationManager = class {
    ...
    applyValues(anim) {
        ...
        if (anim.shaderProps && anim.node.shader) for (const key in anim.shaderProps) {
...
export { onMount as $, For as A, createContext as B, isElementNode as C, mergeColorAlpha as Ct, Config as D, isInteger as E, Switch as F, createRoot as G, createMemo as H, batch as I, getListener as J, createSelector as K, children as L, Match as M, Show as N, activeElement as O, Suspense as P, onCleanup as Q, createComponent$1 as R, hasFocus as S, createWebGLContext as St, isFunction as T, createRenderEffect as U, createEffect as V, createResource as W, mergeProps as X, getOwner as Y, on as Z, ElementNode as _, compareRect as _t, createElement as a, useContext as at, loadFonts as b, DIRTY_QUAD_BUFFER as bt, effect as c, defaultFontMetrics as ct, memo as d, CoreShaderNode as dt, resetErrorBoundaries as et, rootNode as f, SubTexture as ft, use as g, clampUnit as gt, spread as h, calcFactoredRadiusArray as ht, createComponent as i, untrack as it, Index as j, $TRACK as k, insert as l, mapTextLayout as lt, setProp as m, UpdateType as mt, Text as n, sharedConfig as nt, createRenderer as o, takeCanvasPrefetch as ot, scheduleTask as p, uploadCompressedTexture as pt, createSignal as q, View as r, startTransition as rt, createTextNode as s, takeSdfPrefetch as st, Dynamic as t, runWithOwner as tt, insertNode as u, normalizeFontMetrics as ut, focusPath as v, getNormalizedRgbaComponents as vt, isFocused as w, renderer$1 as x, assertTruthy as xt, useFocusManager as y, TextureType as yt, createComputed as z };