            ...
            execute: function execute() {
                function Grid(props) {
                    ...
                    createEffect(function() {
                        ...
                        if (props.selected !== void 0 && ((_props$items = props.items) == null ? void 0 : _props$items.length) > props.selected) {
                            moveFocus(props.selected - currentIndex);
                        }
                    });
                    var itemWidth = function itemWidth() {
                        var _props$itemWidth;
                        return (_props$itemWidth = props.itemWidth) != null ? _props$itemWidth : 300;
                    };
                    var itemHeight = function itemHeight() {
                        var _props$itemHeight;
                        return (_props$itemHeight = props.itemHeight) != null ? _props$itemHeight : 300;
                    };
                    ...
                    var totalWidth = createMemo(function() {
                        ...
                        return itemWidth() + ((_props$itemOffset = props.itemOffset) != null ? _props$itemOffset : 0);
                    });
                    var totalHeight = createMemo(function() {
                        var _props$itemOffset2;
                        return itemHeight() + ((_props$itemOffset2 = props.itemOffset) != null ? _props$itemOffset2 : 0);
                    });
                    ...
                    var scrollY = createMemo(function() {
                        var _props$y;
                        return props.scroll === "none" ? (_props$y = props.y) != null ? _props$y : 0 : -Math.floor(focusedIndex() / columns()) * totalHeight() + (props.y || 0);
                    });
                    var gridRef;
                    return function() {
