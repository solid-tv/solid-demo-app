...
const Player = lazy(() => __vitePreload(() => import("./Player-DQKsveRQ.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-Ez4W9Pvh.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-ZbbRwk1z.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-CUKahHkg.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CMnvGJlz.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-CN5Em5lv.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-R9GT9EkI.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-DdRTzlkU.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-colzH-JT.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create--5cr5Gl-.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-CFsiKZtF.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-B5oymz7m.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CX3fE6MN.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-DZc3O8-x.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-DOLys7x_.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DI0Dsq_s.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DS37oCGo.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Bu9FvYzZ.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-BSh1ejv3.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-CApaaCH4.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-z9shcsDF.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-MybMx8U8.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-D1QnO4ai.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-fYW9ZOjf.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-SiBGZFNZ.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-C9HiL1an.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-VPCzhiNv.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-BivBivou.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DyYLLMdB.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-DkuUwQWj.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-ClTNPIvC.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DTGcdB2g.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DrbdoAcL.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-D18rqSMS.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-BWWoDWjw.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-Bs814nq1.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-C0wpXcR4.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-DZgg75oT.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-Ckt6TIEz.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-lkAW_xeq.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-B78Fv-F6.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-CuLg249k.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-RcFdhaLA.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-DlIalfkL.js"), true ? [] : void 0));
                        ...
                        return [ createComponent(Route, {
                            ...
                            get children() {
                                return [ createComponent(Route, {
                                    ...
                                    path: "nested",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./Nested-BcVX-HoZ.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "textposter",
                                    ...
                                    path: "keepalive",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./KeepAlive-YbpmhYxT.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "suspense",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./suspense-BYmhOgWR.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "superflex",
