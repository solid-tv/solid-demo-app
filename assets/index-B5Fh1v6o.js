...
const DOM_RENDERING = typeof SOLIDTV_DOM_RENDERING === "boolean" && SOLIDTV_DOM_RENDERING;

const SHADERS_ENABLED = !(typeof SOLIDTV_DISABLE_SHADERS === "boolean" && SOLIDTV_DISABLE_SHADERS);
...
function updateNodeStyles(node) {
    ...
    }
    {
        ...
        if (hasMountX) transform += "translateX(".concat(-props2.mountX * 100, "%)");
        if (y !== 0) transform += "translateY(".concat(y, "px)");
        if (hasMountY) transform += "translateY(".concat(-props2.mountY * 100, "%)");
        ...
        let pivotX = (_c = (_b = props2.pivotX) != null ? _b : props2.pivot) != null ? _c : .5;
        let pivotY = (_e = (_d = props2.pivotY) != null ? _d : props2.pivot) != null ? _e : .5;
    ...
    if (node instanceof DOMText) {
        ...
        if (rawImgSrc) {
            ...
            if ((_f = props2.textureOptions.resizeMode) == null ? void 0 : _f.type) {
                ...
                const clipX = (_g = resizeMode.clipX) != null ? _g : .5;
                const clipY = (_h = resizeMode.clipY) != null ? _h : .5;
        ...
        if (((_i = props2.shader) == null ? void 0 : _i.props) != null) {
            let shaderProps = props2.shader.props;
            let borderWidth = shaderProps["border-w"];
            let borderColor = shaderProps["border-color"];
            let borderGap = (_j = shaderProps["border-gap"]) != null ? _j : 0;
            let borderAlign = (_k = shaderProps["border-align"]) != null ? _k : "inside";
            ...
            if (borderWidthHasValue && typeof borderColor === "number" && borderColor !== 0) {
                ...
                if (borderWidthIsNumber) {
                    ...
                    const topWidth = (_l = shaderProps["border-top"]) != null ? _l : borderWidth[0];
                    const rightWidth = (_m = shaderProps["border-right"]) != null ? _m : borderWidth[1];
                    const bottomWidth = (_n = shaderProps["border-bottom"]) != null ? _n : borderWidth[2];
                    const leftWidth = (_o = shaderProps["border-left"]) != null ? _o : borderWidth[3];
                ...
                if (colors.length > 0) {
                    ...
                    if (gradientStops) {
                        if (colors.length === 1) {
                            ...
                            const pivotX = ((_p = pivot[0]) != null ? _p : .5) * 100;
                            const pivotY = ((_q = pivot[1]) != null ? _q : .5) * 100;
                            let sizePart = "";
                            if (width > 0 && height > 0) {
        ...
        if (needsBackgroundLayer) {
            ...
            if (rawImgSrc) {
                ...
                if (!srcPos && node.imgEl.complete && (!supportsObjectFit || !supportsObjectPosition) && node.imgEl.dataset.rawSrc === rawImgSrc) {
                    const resizeMode = (_r = node.props.textureOptions) == null ? void 0 : _r.resizeMode;
                    const clipX = (_s = resizeMode == null ? void 0 : resizeMode.clipX) != null ? _s : .5;
                    const clipY = (_t = resizeMode == null ? void 0 : resizeMode.clipY) != null ? _t : .5;
...
function PosterTitle(props2) {
    var _a2;
    console.log((_a2 = props2.item) == null ? void 0 : _a2.title);
    return createComponent(View, mergeProps(props2, {
        get src() {
            var _a3;
            return (_a3 = props2.item) == null ? void 0 : _a3.src;
        },
        get backdrop() {
            var _a3;
            return (_a3 = props2.item) == null ? void 0 : _a3.backdrop;
        },
        onFail: node => node.src = "./assets/fallback.png",
        style: posterStyles,
        forwardStates: true,
        get children() {
            return createComponent(Text, {
                ...
                get children() {
                    var _a3;
                    return (_a3 = props2.item) == null ? void 0 : _a3.title;
                }
            });
        }
    }));
...
const Player = lazy(() => __vitePreload(() => import("./Player-Bx8muDKY.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DDO_A5H7.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DqlyBV0d.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BnDRnOCc.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-CWyuIIm2.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-RTko-1Mk.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-DbxWMFC2.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-D0Obu2Wo.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-aVw31OgH.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-yg6zvZEq.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-2OCAutqB.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CGRi8iuS.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-FJ62Hhiu.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-I0DdASaI.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-3Qd2FiDC.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-BrYQFZZg.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-CyqsBFUG.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Bj0SW2NU.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-CzKzi0GR.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-Cie7RDJA.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-BZoLSf-a.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-BbKNWjiS.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BP0QouM3.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Ckb7NnpG.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-DImetsSP.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CYgkVg_7.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-Cup8dMrk.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-HrdZezNA.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DYR9UuG5.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-D5_PR9jH.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-4kz67RBf.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-D_ygtzDO.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DW5QLbwo.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-B8YPydjw.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-CZyXNKNF.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-B0zgM2N5.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-BUOL6X2b.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-BfCXhp5d.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-ggHpccVg.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-BRZwvN0h.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-BJ7lOOGh.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-DgM0vp00.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-CRP5FT86.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
