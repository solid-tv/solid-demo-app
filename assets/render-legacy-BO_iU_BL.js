(function() {
    ...
    System.register([], function(_export, _context) {
        ...
        function startLightningRenderer(options) {
            ...
            _export("C", renderer$1 = DOM_RENDERING && Config.domRendererEnabled ? new DOMRendererMain(options, rootId) : new RendererMain(options, rootId));
            flushPendingFonts();
            return renderer$1;
        }
        ...
        function runPostMutationTimed() {
            ...
            flushDeletes();
            var afterDelete = performance.now();
            flushLayout();
            var afterLayout = performance.now();
            flushFocus();
            var end = performance.now();
            var deleteTime = afterDelete - start;
            var layoutTime = afterLayout - afterDelete;
            var focusTime = end - afterLayout;
        ...
        _export({
            $: on,
            At: createWebGLContext,
            B: createComponent$1,
            Ct: calcFactoredRadiusArray,
            E: isFocused,
            F: Show,
            G: createRenderEffect,
            H: createContext,
            I: Suspense,
            J: createSelector,
            K: createResource,
            ...
            Z: getOwner,
            at: startTransition,
            bt: createIndexBuffer,
            et: onCleanup,
            kt: assertTruthy,
            nt: resetErrorBoundaries,
            o: createRenderer,
            ot: untrack,
            p: scheduleTask,
            q: createRoot,
            ...
            tt: onMount,
            wt: clampUnit,
            xt: createTextureCoords,
            y: resetPostMutationTiming,
            z: children,
            Dt: void 0,
            ht: void 0,
            C: void 0
        ...
        return {
            ...
            execute: function execute() {
                ...
                _export("Ot", DIRTY_QUAD_BUFFER = typeof __dirtyQuadBuffer__ !== "undefined" ? __dirtyQuadBuffer__ : true);
                ...
                })(TextureType || _export("Dt", TextureType = {}));
                ...
                _export("Et", getNormalizedRgbaComponents = function getNormalizedRgbaComponents(rgba) {
                    var r = rgba >>> 24;
                    var g = rgba >>> 16 & 255;
                    var b = rgba >>> 8 & 255;
                    var a = rgba & 255;
                ...
                BYTES_PER_VERTEX = 16;
                BYTES_PER_QUAD = 16 * 4;
                _export("yt", WORDS_PER_QUAD = 64 / Uint32Array.BYTES_PER_ELEMENT);
                UV_QUANT_MAX = 65535;
                _export("vt", UNIT_TEXTURE_COORDS = createTextureCoords(0, 0, 1, 1));
                _export("gt", MAX_QUADS = 16384);
                _export("_t", MAX_QUAD_BUFFER_SIZE = MAX_QUADS * 64);
                ...
                })(UpdateType || _export("ht", UpdateType = {}));
                ...
                _export("pt", CoreShaderNode = function() {
                ...
                _export("ft", normalizeFontMetrics = function normalizeFontMetrics(metrics, fontSize) {
                ...
                _export("dt", mapTextLayout = function mapTextLayout(measureText, metrics, text, textAlign, fontFamily, lineHeight, overflowSuffix, wordBreak, letterSpacing, maxLines, maxWidth, maxHeight) {
                ...
                _export("j", $TRACK = Symbol("solid-track"));
                signalOptions = {
                    equals: equalFn
                };
                ERROR = null;
                ...
                activeElement = _createSignal18[0], _setActiveElement = _createSignal18[1], _export("A", activeElement);
                isDev = !!(true, false);
                ...
                _export("D", isFunction = function isFunction(obj) {
                    return typeof obj === "function";
                });
                _export("w", hasFocus = isFocused);
                ...
                focusPath = _createSignal20[0], setFocusPath = _createSignal20[1], _export("b", focusPath);
                ...
                _export("x", useFocusManager = function useFocusManager(userKeyMap) {
