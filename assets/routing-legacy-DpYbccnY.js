(function() {
    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./web-legacy-Dt_TNc5h.js" ], function(_export, _context) {
        "use strict";
        var on, createComponent, createRenderEffect, createContext, batch, createMemo, createSignal, getOwner, startTransition, resetErrorBoundaries, untrack, runWithOwner, useContext, voidFn, depth, hasSchemeRegex, trimPathRegex, mockBase, MAX_REDIRECTS, RouterContextObj, RouteContextObj, useRouter, useNavigate, useLocation, usePreloadRoute, useMatch, useParams, intent, inPreloadFn;
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                createComponent = _renderLegacy001Js.B;
                createRenderEffect = _renderLegacy001Js.G;
                createContext = _renderLegacy001Js.H;
                batch = _renderLegacy001Js.R;
                createMemo = _renderLegacy001Js.W;
                createSignal = _renderLegacy001Js.Y;
                getOwner = _renderLegacy001Js.Z;
                startTransition = _renderLegacy001Js.at;
                resetErrorBoundaries = _renderLegacy001Js.nt;
                untrack = _renderLegacy001Js.ot;
                runWithOwner = _renderLegacy001Js.rt;
                useContext = _renderLegacy001Js.st;
...
//# sourceMappingURL=routing-legacy-DpYbccnY.js.map