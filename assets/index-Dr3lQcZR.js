const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Loops-B0fO0GvU.js","assets/index-Dj4TuHiB.js","assets/Infinite-DxNPePtK.js"])))=>i.map(i=>d[i]);
...
class CoreNode extends EventEmitter {
    constructor(stage, props2) {
        ...
        const {texture: texture, shader: shader, src: src, rtt: rtt, boundsMargin: boundsMargin, interactive: interactive, parent: parent} = props2;
...
class CoreTextureManager extends EventEmitter {
    ...
    async processSome(maxProcessingTime) {
        ...
        const fillPrefetch = () => {
            while (pending.length < prefetchLimit && this.uploadTextureQueue.size > 0) {
...
function updateNodeStyles(node) {
    ...
    }
    {
        ...
        const pivotX = (_c = (_b = props2.pivotX) != null ? _b : props2.pivot) != null ? _c : .5;
        const pivotY = (_e = (_d = props2.pivotY) != null ? _d : props2.pivot) != null ? _e : .5;
    ...
    if (node instanceof DOMText) {
        ...
        if (((_i = props2.shader) == null ? void 0 : _i.props) != null) {
            ...
            const borderGap = (_j = shaderProps["border-gap"]) != null ? _j : 0;
            const borderAlign = (_k = shaderProps["border-align"]) != null ? _k : "inside";
...
const getLayoutCacheKey = props2 => "".concat(props2.fontFamily, "-").concat(props2.fontSize, "-").concat(props2.letterSpacing, "-").concat(props2.lineHeight, "-").concat(props2.maxHeight, "-").concat(props2.maxWidth, "-").concat(props2.maxLines, "-").concat(props2.textAlign, "-").concat(props2.wordBreak, "-").concat(props2.overflowSuffix, "-").concat(props2.text);
...
function findElementByActiveElement(e) {
    ...
    while (parent) {
        if (isFunc(parent.onMouseClick) && testCollision(px, py, parent.lng.absX || 0, parent.lng.absY || 0, parent.width || 0, parent.height || 0)) {
            return parent;
        }
        parent = parent.parent;
    }
...
const Player = lazy(() => __vitePreload(() => import("./Player-DKDH188q.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-C9tKqdHr.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-B0fO0GvU.js"), true ? __vite__mapDeps([0,1]) : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-DxNPePtK.js"), true ? __vite__mapDeps([2,1]) : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-tRdN-vMc.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-DD8unmMw.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BEsGN5u7.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-rI5IHbgm.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DC_FJe3H.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-BnZoi1LG.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-B4q3pYVI.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-BR12e9ue.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-0a94ANgQ.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-xN-xr164.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-BAKsfod8.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-BK6DNceb.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-B3ANieKi.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-DU8qmc8U.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-y8N20mUP.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BI_3xgAA.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-DdtcNdi1.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-DAlOV46C.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-C9VUGC3x.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-BvrxDR9f.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-CJzjV_F3.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DRpMsOfy.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-C752FZ-e.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-rfRGwPIx.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-CkHa9cZ4.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-Dqa3XUyI.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-DmXqbL3o.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DYM--kux.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-D73nvQRX.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-x0wVX6VW.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-DDXoXzEw.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-DpEqrMIj.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-Dv40P3Zq.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-BxzTltBk.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-DwJscH7x.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-mSBcicfj.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-Dh6mjkkl.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-EUfvOopR.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-CEHdutHF.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
...
export { $TRACK as $, activeElement as A, ContentBlock as B, Column as C, useFocusStack as D, ElementNode as E, For as F, useMatch as G, Announcer as H, Index as I, memo as J, styles$1 as K, LazyRow as L, assertTruthy as M, combineStyles as N, children as O, Poster as P, Block as Q, Row as R, Show as S, Text as T, Dynamic as U, View as V, Button as W, MaterialButtonText as X, TileRow as Y, api as Z, getImageUrl as _, __vite_legacy_guard, createSignal as a, convertItemsToTiles as a0, useParams as a1, Switch as a2, Match as a3, LazyColumn as a4, TitleRow as a5, setProp as a6, rootNode as a7, effect as a8, renderer$2 as a9, Hero as aa, AssetPanel as ab, resetCounter as ac, insertNode as ad, getOwner as ae, Config as af, Suspense as ag, createTextNode as ah, createResource as b, createComponent as c, createComputed as d, batch as e, createSelector as f, createEffect as g, hexColor as h, on as i, createMemo as j, onCleanup as k, untrack as l, mergeProps as m, createRoot as n, onMount as o, createElement as p, chainRefs as q, hasFocus as r, setGlobalBackground as s, theme as t, useNavigate as u, use as v, spread as w, chainFunctions as x, insert as y, debounce as z };
//# sourceMappingURL=index-Dr3lQcZR.js.map
