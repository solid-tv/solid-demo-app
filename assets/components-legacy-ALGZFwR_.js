(function() {
    ...
    System.register([ "./render-legacy-BO_iU_BL.js", "./utils-legacy-1IaxYt88.js", "./mergeProps-legacy-BFxfnQ9V.js", "./chainFunctions-legacy-CYxFNoxR.js", "./Column-legacy-BwcQFsOy.js", "./Row-legacy-r3NfeHdw.js", "./styles-legacy-BOzjtbic.js" ], function(_export, _context) {
        "use strict";
        var on, Show, Index, batch, createEffect, createMemo, createSignal, ElementNode, createElement, effect, onCleanup, use, spread, createComponent, $TRACK, Config, insert, setProp, untrack, createRoot, Dynamic, insertNode, hasFocus, mod, combineStyles, clamp, mergeProps, defaultTransitionForward, navigableForwardFocus, defaultTransitionUp, chainRefs, defaultTransitionBack, defaultTransitionDown, chainFunctions, handleNavigation, Column, Row, buttonStyles, styles_default, SHOW_TEXT, DISPLAY_SIZE, heroTransition, titleRowStyles, posterStyles, posterTitleStyles, heroStyles, heroTextStyles, typeToComponent, BlockStyle;
