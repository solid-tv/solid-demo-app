import { o as onMount, s as setGlobalBackground, t as theme, l as createComponent, c as createElement, n as insertNode, p as createTextNode, a as setProp, m as effect, k as insert, F as For, A as spread, q as mergeProps } from "./index-72fgd6Y6.js";
...
function CenterLine(props) {
    return (() => {
        ...
        effect(_p$ => {
            var _v$ = props.y, _v$2 = props.width, _v$3 = theme.color.red;
            ...
            children: mode => {
                ...
                return (() => {
                    ...
                    insert(_el$9, isActive ? (() => {
                        ...
                        effect(_$p => setProp(_el$1, "color", theme.textPrimary, _$p));
                        return _el$1;
                    })() : (() => {
                        ...
                        effect(_$p => setProp(_el$11, "color", theme.textSecondary, _$p));
                        return _el$11;
                    })(), null);
                    ...
                    setProp(_el$0, "y", boxH + 14);
                    insert(_el$0, isActive ? "'".concat(mode, "' (active)") : "'".concat(mode, "'"));
                    effect(_$p => setProp(_el$0, "color", isActive ? theme.color.blue : theme.textSecondary, _$p));
                    return _el$8;
                })();
            }
        }));
    ...
    return (() => {
        ...
        insert(_el$18, createComponent(For, {
            ...
            children: align => (() => {
                ...
                setProp(_el$23, "y", boxH + 12);
                insert(_el$23, align, _el$25);
                effect(_$p => setProp(_el$21, "color", theme.textPrimary, _$p));
                return _el$19;
            })()
        }));
        return _el$13;
    ...
    const Row = props => (() => {
        ...
        insert(_el$28, createComponent(For, {
            ...
            children: l => props.useLineHeight ? (() => {
                ...
                insert(_el$30, () => l.ch);
                effect(_p$ => {
                    var _v$7 = l.size, _v$8 = theme.textPrimary;
                ...
                insert(_el$31, () => l.ch);
                effect(_p$ => {
                    var _v$9 = l.size, _v$0 = theme.textPrimary;
        ...
        effect(_p$ => {
            var _v$4 = props.y, _v$5 = theme.textPrimary, _v$6 = {
                ...Caption,
                width: 460
            };
...
//# sourceMappingURL=TextCentering-CWcpROOu.js.map
