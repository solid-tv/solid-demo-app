                ...
                _export("default", Benchmark = function Benchmark(props) {
                    ...
                    function _runBenchmark() {
                        _runBenchmark = _asyncToGenerator(_regenerator().m(function _callee() {
                            var _props$data, totalRows, cycle, i, _i3, avgAnimatedFps, avgFps, minFps, maxFps, animP95, animP99, allP95, allP99, avgActiveAnims, meanUploadCost, calculatedStats, animRateStr;
                                    ...
                                    insert(_el$19, createComponent(Show, {
                                        ...
                                        get children() {
                                            return [ createComponent(ResultRow, {
                                                ...
                                                label: "Image Workers",
                                                get value() {
                                                    return "".concat(getImageWorkersCount());
                                                }
                                            }) ];
                                        }
                                    }), null);
...
//# sourceMappingURL=Benchmark-legacy-BuMvCjNC.js.map