import { A as For, a as createElement, g as use, i as createComponent, j as Index, l as insert, m as setProp, q as createSignal, s as createTextNode, u as insertNode } from "./render-D3oWDwIw.js";

import { t as mergeProps } from "./mergeProps-ByK4Yd-J.js";

import { n as LazyRow } from "./Lazy-CfzmQFvj.js";

import { t as Column } from "./Column-D_V6Zjrw.js";

import { t as Row } from "./Row-DImilOGr.js";

import { d as List, o as Poster } from "./components-OGTneqSt.js";
        ...
        get children() {
            return [ (() => {
                ...
                insert(_el$1, createComponent(Row, {
                    ...
                    get children() {
                        var _activeRow3;
                        return (_activeRow3 = activeRow()) == null || (_activeRow3 = _activeRow3.items()) == null ? void 0 : _activeRow3.map((item, index) => createComponent(Poster, mergeProps({
                            x: index * 210
                        }, item)));
                    }
                }), null);
