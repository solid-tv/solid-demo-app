(function() {
    ...
    System.register([], function(_export, _context) {
        ...
        function createTextureUploadQueue() {
            var list = [];
            var set = new Set;
            var head = 0;
            function compact() {
            ...
            return {
                ...
                has: function has(texture) {
                    return set.has(texture);
                },
                enqueue: function enqueue(texture) {
                ...
                remove: function remove(texture) {
                    if (set.delete(texture) === false) return;
                    var idx = list.indexOf(texture);
        ...
        return {
            ...
            execute: function execute() {
                ...
                premultiplyRGB = true;
                nextId = 1;
                _export("gt", BufferCollection = function() {
                ...
                EventEmitter = function() {
                    ...
                    return _createClass(EventEmitter, [ {
                        ...
                        value: function hasListeners(event) {
                            ...
                            for (var key in map) {
                                var _listeners = map[key];
                                if (_listeners !== void 0 && _listeners.length > 0) return true;
                            }
                            return false;
                        }
                    }, {
                ...
                })(TextureType || _export("ht", TextureType = {}));
                Texture = function(_EventEmitter) {
                    function Texture(txManager) {
                        ...
                        _this3.renderableOwners = new Set;
                    ...
                    return _createClass(Texture, [ {
                        ...
                        value: function setRenderableOwner(owner, renderable) {
                            ...
                            if (renderable === true) {
                                ...
                                if (owners.has(owner) === false) return;
                                owners.delete(owner);
                                if (owners.size === 0) {
                ...
                _export("mt", getNormalizedRgbaComponents = function getNormalizedRgbaComponents(rgba) {
                    var r = rgba >>> 24;
                    var g = rgba >>> 16 & 255;
                    var b = rgba >>> 8 & 255;
                    var a = rgba & 255;
                ...
                })(CoreNodeRenderState || _export("ut", CoreNodeRenderState = {}));
                NO_CLIPPING_RECT = Object.freeze({
                    x: 0,
                    y: 0,
                    w: 0,
                    h: 0,
                ...
                })(UpdateType || _export("dt", UpdateType = {}));
                ...
                CoreNode = function(_EventEmitter2) {
                    function CoreNode(stage, props) {
                        ...
                        _this4.quadBufferIndex = -1;
                        _this4.isQuadDirty = false;
                        ...
                        _this4.clippingRect = NO_CLIPPING_RECT;
                        ...
                        _this4.isSimple = true;
                        _this4._localIsTranslate = false;
                        _this4._globalIsTranslate = false;
                        _this4._hasContainResize = false;
                        _this4.worldAlpha = 1;
                        ...
                        if (props.texture !== null) _this4.texture = props.texture;
                        if (props.shader === null || props.shader === _this4.stage.defShaderNode) p.shader = _this4.stage.defShaderNode; else _this4.shader = props.shader;
                        if (props.src !== null) _this4.src = props.src;
                        if (props.rtt !== false) _this4.rtt = props.rtt;
                        if (props.boundsMargin !== null) _this4.boundsMargin = props.boundsMargin;
                        if (props.interactive !== false) _this4.interactive = props.interactive;
                    ...
                    return _createClass(CoreNode, [ {
                        ...
                        value: function updateIsSimple() {
                            ...
                            var p = this.props;
                            this._hasContainResize = p.texture !== null && p.textureOptions !== null && ((_p$textureOptions$res = p.textureOptions.resizeMode) == null ? void 0 : _p$textureOptions$res.type) === "contain";
                        ...
                        value: function update(delta, parentClippingRect) {
                            ...
                            if (updateType & UpdateType.Global) {
                                var _this$globalTransform;
                                var lt = this.localTransform;
                                var gt = (_this$globalTransform = this.globalTransform) !== null && _this$globalTransform !== void 0 ? _this$globalTransform : this.globalTransform = new Matrix3d;
                                var fastPathApplied = false;
                                if (this.parentHasRenderTexture === true && (parent == null ? void 0 : parent.rtt) === true) {
                                    Matrix3d.identity(gt);
                                    this.sceneGlobalTransform = Matrix3d.copy((parent == null ? void 0 : parent.globalTransform) || Matrix3d.identity(Matrix3d.temp), this.sceneGlobalTransform).translateOrMultiply(lt);
                                    this._globalIsTranslate = this.isSimple;
                                } else if (this.parentHasRenderTexture === true && (parent == null ? void 0 : parent.rtt) === false) {
                                    this.sceneGlobalTransform = Matrix3d.copy((parent == null ? void 0 : parent.sceneGlobalTransform) || lt, this.sceneGlobalTransform).translateOrMultiply(lt);
                                    Matrix3d.copy((parent == null ? void 0 : parent.globalTransform) || lt, gt);
                                    this._globalIsTranslate = false;
                                } else {
                                    var parentGT = parent == null ? void 0 : parent.globalTransform;
                                    if (this.isSimple === true && parent !== null && parent._globalIsTranslate === true && parentGT !== void 0) {
                                        ...
                                        this._globalIsTranslate = this.isSimple === true && parent !== null && parent._globalIsTranslate === true;
                                    }
                                }
                                if (fastPathApplied === false) {
                                    if (parent !== null) if (this.isSimple === true) gt.translate(lt.tx, lt.ty); else gt.translateOrMultiply(lt);
                                }
                        ...
                        value: function calculateClippingRect(parentClippingRect) {
                            ...
                            var needsMutableRect = clipping === true && isRotated === false || parentClippingRect.valid === true;
                        ...
                        value: function destroy() {
                            ...
                            for (var i = children.length - 1; i > -1; i--) children[i].destroy();
                        ...
                        set: function set(value) {
                            ...
                            if (value === true) this.stage.interactiveNodes.add(this); else this.stage.interactiveNodes.delete(this);
                        }
                    }, {
                        key: "setRTTUpdates",
                        ...
                        value: function draw(renderer) {
                            ...
                            var quadIdx = this.renderOpBufferIdx / (5 * 4) * 6 * 2;
                ...
                CoreAnimationController = function(_EventEmitter4) {
                    function CoreAnimationController() {
                        ...
                        _this6.onTick = function() {
                            if (_this6.hasListeners("tick") === false) return;
                            _this6.tickPayload.progress = _this6.animation["progress"];
                            _this6.emit("tick", _this6.tickPayload);
                        };
                        _this6.state = "stopped";
                        return _this6;
                    }
                ...
                subTextureId = 0;
                _export("lt", SubTexture = function(_Texture4) {
                    function SubTexture(txManager, props) {
                        ...
                        if (_this1.renderableOwners.size > 0) _this1.parentTexture.setRenderableOwner(_this1.subtextureId, true);
                        queueMicrotask(function() {
                ...
                _export("ct", RenderTexture = function(_Texture5) {
                ...
                CoreTextureManager = function(_EventEmitter5) {
                    function CoreTextureManager(stage, settings) {
                        ...
                        _this13.uploadTextureQueue = createTextureUploadQueue();
                    ...
                    return _createClass(CoreTextureManager, [ {
                        ...
                        key: "processSome",
                        value: function() {
                            var _processSome = _asyncToGenerator(_regenerator().m(function _callee9(maxProcessingTime, maxCount) {
                                var platform, startTime, count, texture, _t4;
                                return _regenerator().w(function(_context0) {
                                    while (1) switch (_context0.p = _context0.n) {
                                      ...
                                      case 1:
                                        if (!(this.uploadTextureQueue.size > 0 && count < maxCount && platform.getTimeStamp() - startTime < maxProcessingTime)) {
                                            _context0.n = 6;
                                            break;
                                        }
                                        texture = this.uploadTextureQueue.dequeue();
                                        if (!(texture === void 0)) {
                                            _context0.n = 2;
                                            break;
                                        }
                ...
                _export("st", CoreShaderNode = function() {
                ...
                CoreTextNode = function(_CoreNode) {
                    ...
                    return _createClass(CoreTextNode, [ {
                        key: "releaseSdfCache",
                        value: function releaseSdfCache() {
                            this._sdfCache = null;
                        }
                    }, {
                        ...
                        value: function renderQuads(renderer) {
                            ...
                            var layout = this._renderInfo.layout;
                            this.textRenderer.renderQuads(renderer, layout, null, {
                                ...
                                stage: this.stage,
                                sdfCache: (_this$_sdfCache = this._sdfCache) !== null && _this$_sdfCache !== void 0 ? _this$_sdfCache : void 0
                            });
                        }
                    }, {
                        key: "updateRenderState",
                        value: function updateRenderState(renderState) {
                            ...
                            if (this._renderInfo !== null && this._renderInfo.type === "sdf" && renderState === CoreNodeRenderState.OutOfBounds) this.releaseSdfCache();
                        }
                    }, {
                        key: "destroy",
                        value: function destroy() {
                ...
                Stage = function() {
                    function Stage(options) {
                        ...
                        this.renderListOps = new Uint8Array(256);
                    ...
                    return _createClass(Stage, [ {
                        ...
                        value: function drawFrame() {
                            ...
                            if (this.txManager.hasUpdates() === true) {
                                var cap = this.options.maxTextureUploadsDuringAnimation;
                                var maxCount = this.activeAnimationCount > 0 && cap > 0 ? cap : 2147483647;
                                this.txManager.processSome(this.options.textureProcessingTimeLimit, maxCount).catch(function(err) {
                            ...
                            if (this.renderListDirty === true) {
                                ...
                                var nodes = this.renderListNodes;
                                var ops = this.renderListOps;
                                var len = this.renderListLen;
                                for (var i = 0; i < len; i++) {
                                    var op = ops[i];
                                    var node = nodes[i];
                                    if (op === 0) node.renderQuads(renderer); else if (op === 1) renderer.beginRoundedClip(node); else renderer.endRoundedClip(node);
                                }
                            }
                            renderer.render();
                            this.calculateFps();
                        ...
                        key: "pushRenderOp",
                        value: function pushRenderOp(node, op) {
                            var idx = this.renderListLen;
                            if (idx >= this.renderListOps.length) {
                                var newOps = new Uint8Array(this.renderListOps.length * 2);
                        ...
                        value: function buildRenderList(node) {
                            ...
                            if (hasRoundedClip === true) {
                                ...
                                if (cache === true) this.pushRenderOp(node, 1);
                            }
                            if (node.isRenderable === true) {
                                node.renderQuads(renderer);
                                if (cache === true) this.pushRenderOp(node, 0);
                            }
                            var children = node.children;
                            ...
                            if (hasRoundedClip === true) {
                                ...
                                if (cache === true) this.pushRenderOp(node, 2);
                            }
                        }
                    }, {
                        key: "addSubtreeQuads",
                        value: function addSubtreeQuads(node) {
                ...
                _loadCompressedTexture = function() {
                    ...
                    return function loadCompressedTexture(_x0) {
                ...
                WebPlatform = function(_Platform) {
                    ...
                    return _createClass(WebPlatform, [ {
                        ...
                        value: function createOffscreenCanvas() {
                            if (typeof OffscreenCanvas !== "undefined") return new OffscreenCanvas(0, 0);
                            return null;
                        }
                    }, {
                        key: "createContext",
                        ...
                        value: function() {
                            ...
                            function createImage(_x12, _x13, _x14, _x15, _x16, _x17) {
                        ...
                        value: function() {
                            ...
                            function loadImage(_x18, _x19, _x20, _x21, _x22, _x23) {
                        ...
                        value: function() {
                            ...
                            function loadSvg(_x24, _x25, _x26, _x27, _x28, _x29, _x30) {
                        ...
                        value: function() {
                            ...
                            function loadCompressedTexture(_x31) {
                        ...
                        value: function() {
                            ...
                            function loadFontFace(_x32, _x33) {
                ...
                RendererMain = function(_EventEmitter6) {
                    function RendererMain(settings, target) {
                        var _this24;
                        var _settings$clearColor, _settings$enableClear, _settings$enableConte, _settings$forceWebGL, _settings$inspector, _settings$inspectorOp, _settings$quadBufferS, _settings$fontEngines, _settings$maxTextureU, _settings$maxRetryCou, _settings$maxRetryCou2;
                        ...
                        settings = {
                            ...
                            maxTextureUploadsDuringAnimation: (_settings$maxTextureU = settings.maxTextureUploadsDuringAnimation) !== null && _settings$maxTextureU !== void 0 ? _settings$maxTextureU : 1,
                        ...
                        _this24.stage = new Stage({
                            ...
                            maxTextureUploadsDuringAnimation: settings.maxTextureUploadsDuringAnimation,
                    ...
                    return _createClass(RendererMain, [ {
                        ...
                        key: "unregisterAnimation",
                        value: function unregisterAnimation() {
                            if (this.stage.activeAnimationCount > 0) this.stage.activeAnimationCount--;
                        }
                    }, {
                        key: "close",
