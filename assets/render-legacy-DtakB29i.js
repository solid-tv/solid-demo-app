    ...
    System.register([], function(_export, _context) {
        ...
        function createImageWorker() {
            ...
            self.onmessage = function(event) {
                ...
                var supportsOptionsCreateImageBitmap = event.data.supportsOptionsCreateImageBitmap;
                var supportsFullCreateImageBitmap = event.data.supportsFullCreateImageBitmap;
        ...
        function validateCreateImageBitmap(_x2) {
            return _validateCreateImageBitmap.apply(this, arguments);
        }
        function _validateCreateImageBitmap() {
            _validateCreateImageBitmap = _asyncToGenerator(_regenerator().m(function _callee20(platform) {
                var _bitmap$close, pngBinaryData, support, blob, bitmap, _bitmapWithOptions$cl, bitmapWithOptions, _bitmapWithFullOption, bitmapWithFullOptions, _t12, _t13;
                return _regenerator().w(function(_context21) {
                    while (1) switch (_context21.p = _context21.n) {
                      ...
                      case 3:
                        bitmapWithOptions = _context21.v;
                      ...
                      case 6:
                        bitmapWithFullOptions = _context21.v;
        ...
        function detectPremultiplyAlphaHonored(_x3) {
            return _detectPremultiplyAlphaHonored.apply(this, arguments);
        }
        function _detectPremultiplyAlphaHonored() {
            _detectPremultiplyAlphaHonored = _asyncToGenerator(_regenerator().m(function _callee21(platform) {
                var _bitmap$close3, _gl$getExtension, bitmap, blob, canvas, gl, _bitmap$close2, tex, fb, result, px, _t14;
        ...
        function loadFonts(_x4) {
            return _loadFonts.apply(this, arguments);
        }
        function _loadFonts() {
            _loadFonts = _asyncToGenerator(_regenerator().m(function _callee22(fonts) {
        ...
        return {
            ...
            execute: function execute() {
                ...
                ENABLE_AUTOSIZE = typeof __enableAutosize__ !== "undefined" ? __enableAutosize__ : false;
                ENABLE_INSPECTOR = typeof __enableInspector__ !== "undefined" ? __enableInspector__ : false;
                _export("xt", DIRTY_QUAD_BUFFER = typeof __dirtyQuadBuffer__ !== "undefined" ? __dirtyQuadBuffer__ : true);
                ...
                })(TextureType || _export("bt", TextureType = {}));
                Texture = function(_EventEmitter) {
                    function Texture(txManager) {
                        var _this5;
                        _this5 = _callSuper(this, Texture);
                        _this5.txManager = void 0;
                        _this5._dimensions = null;
                        _this5._error = null;
                        _this5.state = "initial";
                        _this5.renderableOwners = new Set;
                        _this5.renderable = false;
                        _this5.type = TextureType.generic;
                        _this5.preventCleanup = false;
                        _this5.ctxTexture = void 0;
                        _this5.textureData = null;
                        _this5.cacheKey = null;
                        _this5.memUsed = 0;
                        _this5.retryCount = 0;
                        _this5.maxRetryCount = void 0;
                        _this5.createdAt = Date.now();
                        _this5.gracePeriodExpired = false;
                        _this5.freeTextureDataTask = function() {
                            _this5.textureData = null;
                        };
                        _this5.releaseTask = function() {
                            _this5.release();
                        };
                        _this5.txManager = txManager;
                        _this5.maxRetryCount = _this5.txManager.maxRetryCount;
                        return _this5;
                    }
                ...
                _export("yt", getNormalizedRgbaComponents = function getNormalizedRgbaComponents(rgba) {
                    var r = rgba >>> 24;
                    var g = rgba >>> 16 & 255;
                    var b = rgba >>> 8 & 255;
                    var a = rgba & 255;
                ...
                })(CoreNodeRenderState || _export("ht", CoreNodeRenderState = {}));
                NO_CLIPPING_RECT = {
                    x: 0,
                    y: 0,
                    w: 0,
                ...
                })(UpdateType || _export("gt", UpdateType = {}));
                CoreNode = function(_EventEmitter2) {
                    function CoreNode(stage, props) {
                        ...
                        _this6._id = getNewId();
                        _this6.props = void 0;
                        _this6.isCoreNode = true;
                        _this6._animations = null;
                        _this6.renderOpBufferIdx = 0;
                        _this6.numQuads = 0;
                        _this6.renderOpTextures = [];
                        _this6.quadBufferIndex = -1;
                        _this6.isQuadDirty = true;
                        _this6.hasShaderUpdater = false;
                        _this6.hasShaderTimeFn = false;
                        _this6.hasColorProps = false;
                        _this6.textureLoaded = false;
                        _this6.textureOwnership = false;
                        _this6.placeholderActive = false;
                        _this6.updateType = UpdateType.All;
                        _this6.childUpdateType = UpdateType.None;
                        _this6.globalTransform = void 0;
                        _this6.localTransform = void 0;
                        _this6.sceneGlobalTransform = void 0;
                        _this6.renderCoords = void 0;
                        _this6.sceneRenderCoords = void 0;
                        _this6.renderBound = void 0;
                        _this6.strictBound = void 0;
                        _this6.preloadBound = void 0;
                        _this6.clippingRect = NO_CLIPPING_RECT;
                        _this6.textureCoords = void 0;
                        _this6.updateShaderUniforms = false;
                        _this6.isRenderable = false;
                        _this6.renderState = CoreNodeRenderState.Init;
                        _this6.isSimple = true;
                        _this6._localIsTranslate = true;
                        _this6._hasContainResize = false;
                        _this6._hasMount = false;
                        _this6._globalIsTranslate = true;
                        _this6.worldAlpha = 1;
                        _this6.premultipliedColorTl = 0;
                        _this6.premultipliedColorTr = 0;
                        _this6.premultipliedColorBl = 0;
                        _this6.premultipliedColorBr = 0;
                        _this6.calcZIndex = 0;
                        _this6.hasRTTupdates = false;
                        _this6.parentHasRenderTexture = false;
                        _this6.rttParent = null;
                        _this6.framebufferDimensions = null;
                        _this6.autosizer = null;
                        _this6.parentAutosizer = null;
                        _this6.destroyed = false;
                        _this6.loadTextureTask = function() {
                            var _this$props$textureOp, _this$props$textureOp2;
                            var texture = _this6.props.texture;
                            if (texture === null) return;
                            if (_this6.textureOptions.preload === true) _this6.stage.txManager.loadTexture(texture);
                            texture.preventCleanup = (_this$props$textureOp = (_this$props$textureOp2 = _this6.props.textureOptions) == null ? void 0 : _this$props$textureOp2.preventCleanup) !== null && _this$props$textureOp !== void 0 ? _this$props$textureOp : false;
                            texture.on("loaded", _this6.onTextureLoaded);
                            texture.on("failed", _this6.onTextureFailed);
                            texture.on("freed", _this6.onTextureFreed);
                            if (_this6.parentHasRenderTexture) {
                                _this6.notifyParentRTTOfUpdate();
                                return;
                            }
                            if (texture.state === "loaded") _this6.onTextureLoaded(texture, texture.dimensions); else if (texture.state === "failed") _this6.onTextureFailed(texture, texture.error); else if (texture.state === "freed") _this6.onTextureFreed(texture);
                        };
                        _this6.onTextureLoaded = function(_, dimensions) {
                            var _this$props$textureOp3;
                            if (_this6.autosizer !== null) _this6.autosizer.update();
                            _this6.textureLoaded = true;
                            _this6.updatePlaceholderActive();
                            _this6.setUpdateType(UpdateType.IsRenderable);
                            _this6.stage.requestRender();
                            if (_this6.parentHasRenderTexture) _this6.notifyParentRTTOfUpdate();
                            if (dimensions.w > 1 && dimensions.h > 1) _this6.emit("loaded", {
                                type: "texture",
                                dimensions: dimensions
                            });
                            if (_this6.stage.calculateTextureCoord === true && _this6.props.textureOptions !== null) _this6.textureCoords = _this6.stage.renderer.getTextureCoords(_this6);
                            if (((_this$props$textureOp3 = _this6.props.textureOptions) == null || (_this$props$textureOp3 = _this$props$textureOp3.resizeMode) == null ? void 0 : _this$props$textureOp3.type) === "contain") _this6.setUpdateType(UpdateType.Local);
                        };
                        _this6.onTextureFailed = function(_, error) {
                            _this6.textureLoaded = false;
                            _this6.isRenderable = false;
                            _this6.updatePlaceholderActive();
                            _this6.updateTextureOwnership(false);
                            _this6.setUpdateType(UpdateType.IsRenderable);
                            if (_this6.parentHasRenderTexture) _this6.notifyParentRTTOfUpdate();
                            if (_this6.texture !== null && _this6.texture.retryCount > _this6.texture.maxRetryCount) _this6.emit("failed", {
                                type: "texture",
                                error: error
                            });
                        };
                        ...
                        _this6.stage = stage;
                        _this6.localTransform = Matrix3d.identity();
                        _this6.globalTransform = Matrix3d.identity();
                        var initialUpdateType = UpdateType.Local | UpdateType.RenderBounds | UpdateType.RenderState;
                        var texture = props.texture, shader = props.shader, src = props.src, rtt = props.rtt, boundsMargin = props.boundsMargin, parent = props.parent;
                        var p = _this6.props = props;
                        p.texture = null;
                        p.shader = null;
                        p.src = null;
                        p.rtt = false;
                        ...
                        if (p.color > 0 || p.colorTop > 0 || p.colorBottom > 0 || p.colorLeft > 0 || p.colorRight > 0 || p.colorTl > 0 || p.colorTr > 0 || p.colorBl > 0 || p.colorBr > 0) {
                            _this6.hasColorProps = true;
                            initialUpdateType |= UpdateType.PremultipliedColors;
                        }
                        if (p.zIndex !== 0) _this6.zIndex = p.zIndex;
                        if (parent !== null) parent.addChild(_this6);
                        if (texture !== null) _this6.texture = texture;
                        if (shader === null || shader === _this6.stage.defShaderNode) p.shader = _this6.stage.defShaderNode; else _this6.shader = shader;
                        if (src !== null) _this6.src = src;
                        if (rtt !== false) _this6.rtt = rtt;
                        if (boundsMargin !== null) _this6.boundsMargin = boundsMargin;
                        if (p.autosize === true) _this6.autosizer = new Autosizer(_this6);
                        _this6.setUpdateType(initialUpdateType);
                    ...
                    return _createClass(CoreNode, [ {
                        ...
                        value: function update(delta, parentClippingRect) {
                            ...
                            if (ENABLE_AUTOSIZE && updateType & UpdateType.Autosize && this.autosizer !== null) this.autosizer.update();
                            this.updateType = 0;
                            ...
                            if (true && updateType & UpdateType.RenderTexture && this.rtt === true) this.hasRTTupdates = true;
                            if (updateType & UpdateType.Global) {
                                var lt = this.localTransform;
                                var gt = this.globalTransform;
                                var fastPathApplied = false;
                                if (true && this.parentHasRenderTexture === true && parent.rtt === true) {
                                ...
                                } else if (true && this.parentHasRenderTexture === true && parent.rtt === false) {
                                ...
                                if (fastPathApplied === false) if (this.isSimple) gt.translate(lt.tx, lt.ty); else gt.translateOrMultiply(lt);
                            ...
                            if (ENABLE_AUTOSIZE && updateType & UpdateType.Global && this.isRenderable === true && this.parentAutosizer !== null) this.parentAutosizer.patch(this.id);
                            ...
                            if (updateType & UpdateType.Children && this.children.length > 0) {
                                ...
                                if (true && this.rtt === true) childClippingRect = NO_CLIPPING_RECT;
                                var _children3 = this.children;
                                var length = _children3.length;
                            ...
                            if (true === true && parentHasRenderTexture === true) this.notifyParentRTTOfUpdate();
                            ...
                            if (newRenderState === CoreNodeRenderState.OutOfBounds) {
                                ...
                                if (true === true && this.rtt === true && newRenderState === CoreNodeRenderState.OutOfBounds) this.notifyChildrenRTTOfUpdate(newRenderState);
                            }
                            if (updateType & (UpdateType.Global | UpdateType.PremultipliedColors | UpdateType.WorldAlpha)) this.isQuadDirty = true;
                        }
                    }, {
                        ...
                        value: function createRenderBounds() {
                            ...
                            if (boundInsideBound(this.renderBound, this.strictBound) === false) return;
                        ...
                        value: function updateIsRenderable() {
                            ...
                            } else if ((this.props.shader !== this.stage.renderer.getDefaultShaderNode() || this.hasColorProps === true) && this.hasDimensions() === true) newIsRenderable = true;
                            if (newIsRenderable === true && this.stage.renderOnlyInViewport === true && this.renderState !== CoreNodeRenderState.InViewport) newIsRenderable = false;
                        ...
                        value: function calculateRenderCoords() {
                            ...
                            if (!true || this.sceneGlobalTransform === void 0) return;
                        ...
                        value: function destroy() {
                            ...
                            if (true && this.rtt === true) this.stage.renderer.removeRTTNode(this);
                        ...
                        value: function removeChild(node) {
                            ...
                            if (targetParent === null) {
                                if (true && this.props.rtt === true && this.parentHasRenderTexture === true) node.clearRTTInheritance();
                                if (ENABLE_AUTOSIZE) {
                        ...
                        value: function addChild(node) {
                            ...
                            var inRttCluster = true && (this.props.rtt === true || this.parentHasRenderTexture === true);
                            ...
                            if (previousParent !== null) {
                                var previousParentInRttCluster = true && (previousParent.props.rtt === true || previousParent.parentHasRenderTexture === true);
                                ...
                                if (ENABLE_AUTOSIZE) {
                                    ...
                                    if (previousAutosizer !== null) {
                                        if (!autosizeTarget || previousAutosizer.id !== autosizeTarget.id) previousAutosizer.detach(node);
                                        attachToAutosizer = false;
                                    }
                                }
                            }
                            if (ENABLE_AUTOSIZE && attachToAutosizer === true && autosizeTarget) autosizeTarget.attach(node);
                        ...
                        set: function set(value) {
                            ...
                            p.color = value;
                            var has = value > 0;
                            if (has !== this.hasColorProps) this.setUpdateType(UpdateType.IsRenderable);
                        ...
                        value: function draw(renderer) {
                            ...
                            if (this.clippingRect.valid === true) {
                                var pixelRatio = true && this.parentHasRenderTexture ? 1 : stage.pixelRatio;
                                ...
                                if (true && this.parentHasRenderTexture) {
                    ...
                    return _createClass(AnimationManager, [ {
                        ...
                        value: function applyValues(anim) {
                            ...
                            if (anim.props) for (var key in anim.props) {
                                ...
                                if (anim.progress === 1) anim.node[key] = value.target; else if (anim.progress === 0) anim.node[key] = value.start; else if (value.isColor) anim.node[key] = mergeColorProgress(value.start, value.target, easedProgress); else anim.node[key] = value.start + (value.target - value.start) * easedProgress;
                            }
                            if (anim.shaderProps && anim.node.shader) {
                                var updated = false;
                                for (var _key7 in anim.shaderProps) {
                                    var _value = anim.shaderProps[_key7];
                                    if (anim.progress === 1) anim.node.shader.props[_key7] = _value.target; else if (anim.progress === 0) anim.node.shader.props[_key7] = _value.start; else if (_value.isColor) anim.node.shader.props[_key7] = mergeColorProgress(_value.start, _value.target, easedProgress); else anim.node.shader.props[_key7] = _value.start + (_value.target - _value.start) * easedProgress;
                                    updated = true;
                                }
                                if (updated) anim.node.setUpdateType(4096);
                            }
                        }
                    }, {
                        key: "reverseValues",
                        value: function reverseValues(anim) {
                            ...
                            if (anim.shaderProps) for (var _key8 in anim.shaderProps) {
                                var _v3 = anim.shaderProps[_key8];
                                var _t = _v3.start;
                    ...
                    return _createClass(ImageWorkerManager, [ {
                        ...
                        value: function spawnWorker() {
                            ...
                            worker.onerror = function(event) {
                                return _this8.handleWorkerError(event, index);
                            };
                            ...
                            return new Promise(function(resolve, reject) {
                                try {
                                    ...
                                    if (nextWorkerIndex === -1) {
                                        _this9.spawnWorkers();
                                        nextWorkerIndex = _this9.getNextWorkerIndex();
                                    }
                                    if (nextWorkerIndex === -1) {
                                    ...
                                    worker.postMessage({
                                        ...
                                        sw: sw,
                                        sh: sh,
                                        supportsOptionsCreateImageBitmap: _this9.createImageBitmapSupport.options,
                                        supportsFullCreateImageBitmap: _this9.createImageBitmapSupport.full,
                                        premultiplyAlphaHonored: _this9.createImageBitmapSupport.premultiplyHonored
                                    });
                                } catch (error) {
                                    reject(error);
                                }
                ...
                loadCompressedTexture = function() {
                    ...
                    return function loadCompressedTexture(_x5) {
                ...
                _export("mt", uploadCompressedTexture = {
                    ktx: uploadKTX,
                    pvr: uploadPVR,
                    astc: uploadASTC
                });
                loadSvg = function() {
                    ...
                    return function loadSvg(_x9, _x0, _x1, _x10, _x11, _x12, _x13, _x14) {
                ...
                ImageTexture = function(_Texture2) {
                    function ImageTexture(txManager, props) {
                        ...
                        _this1.platform = void 0;
                        _this1.props = void 0;
                        _this1.type = TextureType.image;
                    ...
                    return _createClass(ImageTexture, [ {
                        ...
                        value: function() {
                            ...
                            function loadImageFallback(_x15, _x16) {
                        ...
                        value: function() {
                            ...
                            function createImageBitmap(_x17, _x18, _x19, _x20, _x21, _x22) {
                        ...
                        value: function() {
                            var _loadImage = _asyncToGenerator(_regenerator().m(function _callee0(src) {
                                var _this$props3, premultiplyAlpha, sx, sy, sw, sh, isBase64, blob, _t1;
                        ...
                        value: function() {
                            var _getTextureSource2 = _asyncToGenerator(_regenerator().m(function _callee1() {
                                var _this$txManager$rende, _ref, _resp$premultiplyAlph, _this$props4, src, type, err, resp, _t10;
                                return _regenerator().w(function(_context10) {
                                    while (1) switch (_context10.p = _context10.n) {
                                      case 0:
                                        ...
                                        _this$props4 = this.props, src = _this$props4.src, type = _this$props4.type;
                ...
                NoiseTexture = function(_Texture3) {
                    function NoiseTexture(txManager, props) {
                        ...
                        _this10.type = TextureType.noise;
                        _this10.props = props;
                        return _this10;
                    }
                ...
                subTextureId = 0;
                _export("pt", SubTexture = function(_Texture4) {
                    function SubTexture(txManager, props) {
                        var _this11;
                        _this11 = _callSuper(this, SubTexture, [ txManager ]);
                        _this11.props = void 0;
                        _this11.parentTexture = void 0;
                        _this11.type = TextureType.subTexture;
                        _this11.subtextureId = "subtexture-".concat(subTextureId++);
                        _this11.onParentTxLoaded = function() {
                            _this11.setState("loaded", {
                                w: _this11.props.w,
                                h: _this11.props.h
                            });
                        };
                        _this11.onParentTxFailed = function(target, error) {
                            _this11.retryCount = _this11.parentTexture.retryCount - 1;
                            _this11.setState("failed", error);
                        };
                        _this11.onParentTxLoading = function() {
                            _this11.setState("loading");
                        };
                        _this11.onParentTxFreed = function() {
                            _this11.setState("freed");
                        };
                        _this11.props = props;
                        assertTruthy(_this11.props.texture, "SubTexture requires a parent texture");
                        assertTruthy(_this11.props.texture instanceof ImageTexture, "SubTexture requires an ImageTexture parent");
                        _this11.parentTexture = txManager.resolveParentTexture(_this11.props.texture);
                        if (_this11.renderableOwners.size > 0) _this11.parentTexture.setRenderableOwner(_this11.subtextureId, true);
                        queueMicrotask(function() {
                            var parentTx = _this11.parentTexture;
                            if (parentTx.state === "loaded" && parentTx.dimensions !== null) _this11.onParentTxLoaded(parentTx, parentTx.dimensions); else if (parentTx.state === "loading") _this11.onParentTxLoading(); else if (parentTx.state === "failed" && parentTx.error !== null) _this11.onParentTxFailed(parentTx, parentTx.error); else if (parentTx.state === "freed") _this11.onParentTxFreed();
                ...
                _export("ft", RenderTexture = function(_Texture5) {
                    function RenderTexture(txManager, props) {
                        var _this13;
                        _this13 = _callSuper(this, RenderTexture, [ txManager ]);
                        _this13.props = void 0;
                        _this13.type = TextureType.renderToTexture;
                        _this13.props = props;
                        return _this13;
                    }
                ...
                CoreTextureManager = function(_EventEmitter3) {
                    function CoreTextureManager(stage, settings) {
                        var _this16;
                        _this16 = _callSuper(this, CoreTextureManager);
                        _this16.keyCache = new Map;
                        _this16.txConstructors = {};
                        _this16.maxRetryCount = void 0;
                        _this16.uploadTextureQueue = new TextureUploadQueue;
                        _this16.initialized = false;
                        _this16.stage = void 0;
                        _this16.numImageWorkers = void 0;
                        _this16.imageDecodeConcurrency = void 0;
                        _this16.decodeGate = null;
                        _this16.platform = void 0;
                        _this16.imageWorkerManager = null;
                        _this16.hasCreateImageBitmap = false;
                        _this16.imageBitmapSupported = {
                            basic: false,
                            options: false,
                            full: false,
                            premultiplyHonored: null
                        };
                        _this16.hasWorker = !!self.Worker;
                        _this16.renderer = void 0;
                        _this16.frameTime = 0;
                        ...
                        _this16.stage = stage;
                        _this16.platform = stage.platform;
                        _this16.numImageWorkers = numImageWorkers;
                        _this16.maxRetryCount = maxRetryCount;
                        _this16.imageDecodeConcurrency = imageDecodeConcurrency;
                        if (createImageBitmapSupport === "auto") validateCreateImageBitmap(_this16.platform).then(function(result) {
                            _this16.resolvePremultiplyAndInit(result, premultiplyAlphaHonored);
                        }).catch(function() {
                            ...
                            _this16.emit("initialized");
                        }); else _this16.resolvePremultiplyAndInit({
                        ...
                        _this16.registerTextureType("ImageTexture", ImageTexture);
                        _this16.registerTextureType("ColorTexture", ColorTexture);
                        _this16.registerTextureType("NoiseTexture", NoiseTexture);
                        _this16.registerTextureType("SubTexture", SubTexture);
                        _this16.registerTextureType("RenderTexture", RenderTexture);
                        return _this16;
                    }
                    ...
                    return _createClass(CoreTextureManager, [ {
                        ...
                        value: function initialize(support) {
                            ...
                            if (this.uploadTextureQueue.size > 0) this.processUntil(Infinity).catch(function(err) {
                        ...
                        value: function() {
                            var _loadTexture = _asyncToGenerator(_regenerator().m(function _callee13(texture, priority) {
                                ...
                                return _regenerator().w(function(_context14) {
                                    while (1) switch (_context14.p = _context14.n) {
                                      ...
                                      case 3:
                                        ...
                                        gate = priority === true ? null : this.decodeGate;
                                        if (!(gate !== null)) {
                                            _context14.n = 4;
                                            break;
                                        }
                                      ...
                                      case 5:
                                        textureDataResult = _context14.v;
                                ...
                                }, _callee13, this, [ [ 4, , 6, 7 ] ]);
                            }));
                            function loadTexture(_x24, _x25) {
                        ...
                        key: "processOne",
                        value: function() {
                            var _processOne = _asyncToGenerator(_regenerator().m(function _callee15() {
                                var texture;
                        ...
                        key: "processUntil",
                        value: function() {
                            var _processUntil = _asyncToGenerator(_regenerator().m(function _callee16(maxProcessingTime) {
                        ...
                        key: "uploadQueued",
                        value: function() {
                            var _uploadQueued = _asyncToGenerator(_regenerator().m(function _callee17(texture) {
                                var _t11;
                                return _regenerator().w(function(_context18) {
                                    while (1) switch (_context18.p = _context18.n) {
                                      ...
                                      case 5:
                                        _context18.p = 5;
                                        _t11 = _context18.v;
                                        console.error("Failed to upload texture:", _t11);
                    ...
                    return _createClass(CoreShaderNode, [ {
                        ...
                        value: function defineProps(props) {
                            ...
                            var _loop5 = function _loop5(key) {
                                var propConfig = _this18.shaderType.props[key];
                                var isAdvancedProp = isAdvancedShaderProp(propConfig);
                                Object.defineProperty(definedProps, key, {
                                    get: function get() {
                                        return _this18.resolvedProps[key];
                                    },
                                    set: function set(value) {
                                        if (isAdvancedProp === true && propConfig.resolve !== void 0) _this18.resolvedProps[key] = propConfig.resolve(value, _this18.resolvedProps); else if (isAdvancedProp === true && propConfig.set !== void 0) propConfig.set(value, _this18.resolvedProps); else _this18.resolvedProps[key] = value;
                                        _this18._valueKeyDirty = true;
                                        if (_this18.update !== void 0 && _this18.node !== null) _this18.node.setUpdateType(UpdateType.RecalcUniforms); else _this18.stage.requestRender();
                                    }
                                });
                            };
                ...
                _export("lt", mapTextLayout = function mapTextLayout(measureText, metrics, text, textAlign, fontFamily, lineHeight, overflowSuffix, wordBreak, letterSpacing, maxLines, maxWidth, maxHeight) {
                    ...
                    var _ref23 = maxWidth > 0 === true ? wrapText(measureText, text, fontFamily, maxWidth, letterSpacing, overflowSuffix, wordBreak, effectiveMaxLines) : measureLines(measureText, text.split("\n"), fontFamily, letterSpacing, effectiveMaxLines), _ref24 = _slicedToArray(_ref23, 3), lines = _ref24[0], remainingLines = _ref24[1], remainingText = _ref24[2];
                    ...
                    if (effectiveLineAmount > 0) {
                        ...
                        if (effectiveLineAmount > 1) for (var _i0 = 1; _i0 < effectiveLineAmount; _i0++) effectiveMaxWidth = Math.max(effectiveMaxWidth, lines[_i0][1]);
                    }
                    if (textAlign !== "left") for (var _i1 = 0; _i1 < effectiveLineAmount; _i1++) {
                        var _line = lines[_i1];
                        var w = _line[1];
                    ...
                    for (var _i10 = 0; _i10 < effectiveLineAmount; _i10++) {
                        var _line2 = lines[_i10];
                        _line2[4] = firstBaselineY + lineHeightPx * _i10;
                    }
                ...
                wrapText = function wrapText(measureText, text, fontFamily, maxWidth, letterSpacing, overflowSuffix, wordBreak, maxLines) {
                    ...
                    for (var i = 0; i < lines.length; i++) {
                        var line = lines[i];
                        if (line === void 0) continue;
                        var _ref25 = line.length > 0 ? wrapLine(measureText, line, fontFamily, maxWidth, letterSpacing, spaceWidth, overflowSuffix, overflowWidth, wordBreak, remainingLines) : [ [ [ "", 0, false, 0, 0 ] ], remainingLines, i < lines.length - 1 ];
                        var _ref26 = _slicedToArray(_ref25, 3);
                        wrappedLine = _ref26[0];
                        remainingLines = _ref26[1];
                        hasRemainingText = _ref26[2];
                        remainingLines--;
                    ...
                    while ((pendingWord.length > 0 || wordIdx < words.length) && remainingLines > 0) {
                        ...
                        if (currentLineWidth === 0) {
                            if (wordWidth > maxWidth) {
                                ...
                                var _ref27 = isLastLine ? truncateWord(measureText, word, wordWidth, maxWidth, fontFamily, letterSpacing, overflowSuffix, overflowWidth) : splitWord(measureText, word, wordWidth, maxWidth, fontFamily, letterSpacing);
                                var _ref28 = _slicedToArray(_ref27, 3);
                                word = _ref28[0];
                                remainingWord = _ref28[1];
                                wordWidth = _ref28[2];
                ...
                breakAll = function breakAll(measureText, word, wordWidth, fontFamily, letterSpacing, wrappedLines, currentLine, currentLineWidth, remainingLines, remainingWord, maxWidth, space, spaceWidth, overflowSuffix, overflowWidth) {
                    ...
                    var _ref29 = truncate ? truncateWord(measureText, word, wordWidth, remainingSpace, fontFamily, letterSpacing, overflowSuffix, overflowWidth) : splitWord(measureText, word, wordWidth, remainingSpace, fontFamily, letterSpacing);
                    var _ref30 = _slicedToArray(_ref29, 3);
                    word = _ref30[0];
                    remainingWord = _ref30[1];
                    wordWidth = _ref30[2];
                    currentLine += space + word;
                    currentLineWidth += spaceWidth + wordWidth;
                ...
                truncateWord = function truncateWord(measureText, word, wordWidth, maxWidth, fontFamily, letterSpacing, overflowSuffix, overflowWidth) {
                    ...
                    var currentWidth = 0;
                    for (var _i11 = 0; _i11 < word.length; _i11++) {
                ...
                splitWord = function splitWord(measureText, word, wordWidth, maxWidth, fontFamily, letterSpacing) {
                    ...
                    var currentWidth = 0;
                    for (var _i12 = 0; _i12 < word.length; _i12++) {
                ...
                TextureMemoryManager = function() {
                    ...
                    return _createClass(TextureMemoryManager, [ {
                        ...
                        value: function evictOrphanedTextures() {
                            ...
                            var _iterator17 = _createForOfIteratorHelper(keyCache.values()), _step17;
                            try {
                                for (_iterator17.s(); !(_step17 = _iterator17.n()).done; ) {
                                    var texture = _step17.value;
                        ...
                        value: function getMemoryInfo() {
                            ...
                            var _iterator18 = _createForOfIteratorHelper(this.loadedTextures), _step18;
                            try {
                        ...
                        value: function updateSettings(settings) {
                            ...
                            if (settings.debugLogging && !this.loggingID) {
                                ...
                                this.loggingID = setInterval(function() {
                                    if (lastMemUse !== _this19.memUsed) {
                                        lastMemUse = _this19.memUsed;
                                        console.log("[TextureMemoryManager] Memory used: ".concat(bytesToMb(_this19.memUsed), " mb / ").concat(bytesToMb(_this19.criticalThreshold), " mb (").concat((_this19.memUsed / _this19.criticalThreshold * 100).toFixed(1), "%)"));
                                    }
                                }, 1e3);
                            }
                ...
                CoreTextNode = function(_CoreNode) {
                    function CoreTextNode(stage, props, textRenderer) {
                        var _this20;
                        _this20 = _callSuper(this, CoreTextNode, [ stage, props ]);
                        _this20.textRenderer = void 0;
                        _this20.fontHandler = void 0;
                        _this20._layoutGenerated = false;
                        _this20._waitingForFont = false;
                        _this20._containType = TextConstraint.none;
                        _this20._cachedLayout = null;
                        _this20._sdfCache = {
                            vertices: null,
                            glyphCount: 0,
                            color: 0,
                        ...
                        _this20.textProps = void 0;
                        _this20._renderInfo = {
                            width: 0,
                            height: 0
                        };
                        _this20._type = "sdf";
                        _this20.onTextureLoaded = function(_, dimensions) {
                            if (true && _this20.parentHasRenderTexture) _this20.notifyParentRTTOfUpdate();
                            if (dimensions.w > 1 && dimensions.h > 1) _this20.emit("loaded", {
                                type: "texture",
                                dimensions: dimensions
                            });
                            _this20.textureLoaded = true;
                            _this20.setUpdateType(UpdateType.IsRenderable);
                        };
                        _this20.emitTextLoadedEvent = function() {
                            _this20.emit("loaded", {
                                type: "text",
                                dimensions: {
                                    w: _this20._renderInfo.width,
                                    h: _this20._renderInfo.height
                                }
                            });
                        };
                        _this20.textRenderer = textRenderer;
                        _this20.fontHandler = textRenderer.font;
                        _this20._type = textRenderer.type;
                        _this20.textProps = props;
                        _this20._containType = TextConstraint[props.contain];
                        _this20.setUpdateType(UpdateType.All);
                        return _this20;
                    }
                    ...
                    return _createClass(CoreTextNode, [ {
                        ...
                        value: function renderQuads(renderer) {
                            ...
                            this.textRenderer.renderQuads(renderer, this._cachedLayout, null, {
                                ...
                                width: this.props.w,
                                height: this.props.h,
                                parentHasRenderTexture: true && this.parentHasRenderTexture,
                                framebufferDimensions: true && this.parentHasRenderTexture === true ? this.parentFramebufferDimensions : null,
                                stage: this.stage,
                ...
                Stage = function() {
                    function Stage(options) {
                        ...
                        this.renderOnlyInViewport = void 0;
                        ...
                        if (this.singleFontEngine === null) fontEngines.filter(function(fontEngine) {
                            ...
                            if (type === "canvas") _this21.hasCanvasEngine = true;
                            return true;
                        }).sort(function(a, b) {
                            ...
                            var type = fontEngine.type;
                            _this21.textRenderers[type] = fontEngine;
                            _this21.textRenderers[type].init(_this21);
                            _this21.fontHandlers[type] = fontEngine.font;
                        }); else {
                    ...
                    return _createClass(Stage, [ {
                        ...
                        value: function drawFrame() {
                            ...
                            if (this.txManager.hasUpdates() === true) (hasActiveAnimations === true ? this.txManager.processOne() : this.txManager.processUntil(this.options.textureProcessingTimeLimit)).catch(function(err) {
                                console.error("Error processing textures:", err);
                            });
                            if (sampling === true) renderStart = platform.getTimeStamp();
                            renderer.reset();
                            if (true && renderer.rttNodes.length > 0) renderer.renderRTTNodes();
                            if (this.renderListDirty === true) {
                                ...
                                for (var _i13 = 0, len = renderList.length; _i13 < len; _i13++) renderList[_i13].renderQuads(renderer);
                            }
                            renderer.render();
                            if (sampling === true) {
                                var renderEnd = platform.getTimeStamp();
                                ...
                                var frameRenderMs = renderEnd - renderStart;
                        ...
                        value: function flushFrameEvents() {
                            var _iterator19 = _createForOfIteratorHelper(this.frameEventQueue), _step19;
                            try {
                ...
                RendererMain = function(_EventEmitter4) {
                    function RendererMain(settings, target) {
                        ...
                        _this23 = _callSuper(this, RendererMain);
                        _this23.root = void 0;
                        _this23.canvas = void 0;
                        _this23.stage = void 0;
                        _this23.inspector = null;
                        var resolvedTxSettings = _this23.resolveTxSettings(settings.textureMemory || {});
                        settings = {
                            appWidth: settings.appWidth || 1920,
                            appHeight: settings.appHeight || 1080,
                            textureMemory: resolvedTxSettings,
                            boundsMargin: settings.boundsMargin || 0,
                            renderOnlyInViewport: (_settings$renderOnlyI = settings.renderOnlyInViewport) !== null && _settings$renderOnlyI !== void 0 ? _settings$renderOnlyI : true,
                            deviceLogicalPixelRatio: settings.deviceLogicalPixelRatio || 1,
                            devicePhysicalPixelRatio: settings.devicePhysicalPixelRatio || _this23.windowDevicePixelRatio() || 1,
                            ...
                            quadBufferSize: (_settings$quadBufferS = settings.quadBufferSize) !== null && _settings$quadBufferS !== void 0 ? _settings$quadBufferS : 1310720,
                        ...
                        _this23.root = _this23.stage.root;
                        if (target) {
                            var targetEl;
                        ...
                        if (inspector && ENABLE_INSPECTOR) _this23.inspector = new inspector(canvas, settings);
                        return _this23;
                    }
                ...
                DOMNode = function(_EventEmitter5) {
                    function DOMNode(stage, props) {
                        var _this25;
                        _this25 = _callSuper(this, DOMNode);
                        _this25.stage = void 0;
                        _this25.props = void 0;
                        _this25.div = document.createElement("div");
                        _this25.divBg = void 0;
                        _this25.divBorder = void 0;
                        _this25.imgEl = void 0;
                        _this25.imageLoading = false;
                        _this25.lazyImagePendingSrc = null;
                        _this25.lazyImageSubTextureProps = null;
                        _this25.boundsDirty = true;
                        _this25.children = new Set;
                        _this25._lastStyleStr = "";
                        _this25.id = ++lastNodeId;
                        _this25.renderState = 0;
                        _this25.preventCleanup = true;
                        _this25.animate = animate;
                        _this25.stage = stage;
                        _this25.props = props;
                        _this25.div._node = _this25;
                        _this25.div.setAttribute("data-id", String(_this25.id));
                        elMap.set(_this25, _this25.div);
                        var parent = _this25.props.parent;
                        if (parent instanceof DOMNode) parent.children.add(_this25);
                        updateNodeParent(_this25);
                        updateNodeStyles(_this25);
                        updateNodeData(_this25);
                        return _this25;
                    }
                ...
                DOMText = function(_DOMNode) {
                    function DOMText(stage, props) {
                        var _this26;
                        _this26 = _callSuper(this, DOMText, [ stage, props ]);
                        _this26.props = void 0;
                        _this26.loaded = false;
                        _this26.props = props;
                        _this26.div.innerText = props.text;
                        updateNodeStyles(_this26);
                        updateDOMTextSize(_this26, false);
                        syncContainTextNodeTracking(_this26);
                        scheduleUpdateDOMTextMeasurement(_this26);
                        return _this26;
                    }
                ...
                DOMRendererMain = function() {
                    function DOMRendererMain(settings, rawTarget) {
                        ...
                        this.stage = {
                            ...
                            loadFont: function() {
                                var _loadFont = _asyncToGenerator(_regenerator().m(function _callee18() {
                    ...
                    return _createClass(DOMRendererMain, [ {
                        ...
                        value: function once(event, listener) {
                            ...
                            var _wrappedListener = function wrappedListener(target, data) {
                                _this27.off(event, _wrappedListener);
                                listener(target, data);
                            };
                ...
                States = function(_Array) {
                    function States(callback) {
                        ...
                        var _super = function _super() {
                            for (var _len7 = arguments.length, _args = new Array(_len7), _key0 = 0; _key0 < _len7; _key0++) {
                                _args[_key0] = arguments[_key0];
                            }
                            return _this28 = _callSuper(_this29, States, [].concat(_args)), _this28.onChange = void 0, 
                            _assertThisInitialized(_this28);
                        };
                        if (isArray(initialState)) _super.apply(void 0, _toConsumableArray(initialState)); else if (isString(initialState)) _super(initialState); else _super.apply(void 0, _toConsumableArray(Object.entries(initialState).filter(function(_ref31) {
                            var _ref32 = _slicedToArray(_ref31, 2), _key = _ref32[0], value = _ref32[1];
                            return value;
                        }).map(function(_ref33) {
                            var _ref34 = _slicedToArray(_ref33, 1), key = _ref34[0];
                            return key;
                        })));
                ...
                flattenKeyMap = function flattenKeyMap(keyMap, targetMap) {
                    ...
                    for (var _i16 = 0, _Object$entries2 = Object.entries(keyMap); _i16 < _Object$entries2.length; _i16++) {
                        _loop6();
                    }
                    return newTargetMap;
                };
                ...
                findSuppression = function findSuppression(ids) {
                    var _iterator22 = _createForOfIteratorHelper(ids), _step22;
                    try {
                ...
                liftSuppression = function liftSuppression(ids) {
                    ...
                    if (!found) return;
                    var _iterator23 = _createForOfIteratorHelper(found.ids), _step23;
                    try {
                ...
                parseAndAssignShaderProps = function parseAndAssignShaderProps(prefix, obj) {
                    ...
                    Object.entries(obj).forEach(function(_ref35) {
                        var _ref36 = _slicedToArray(_ref35, 2), key = _ref36[0], value = _ref36[1];
                ...
                _export("_", ElementNode = function() {
                    ...
                    return _createClass(ElementNode, [ {
                        ...
                        set: function set(v) {
                            ...
                            var _iterator24 = _createForOfIteratorHelper(EFFECT_SHADER_KEYS), _step24;
                            try {
                            ...
                            if (this._undoStyles || keyExists(this, states)) {
                                ...
                                if (this._undoStyles && this._undoStyles.length) {
                                    ...
                                    this._undoStyles.forEach(function(styleKey) {
                                        ...
                                        if (fallbackValue === void 0) fallbackValue = _this34.style[styleKey];
                                        if (false) {
                        ...
                        value: function render(topNode) {
                            ...
                            if (isElementText(node)) {
                                ...
                                if (node._hasRenderedChildren) {
                                    ...
                                    var _iterator25 = _createForOfIteratorHelper(node.children), _step25;
                                    try {
                            ...
                            if (node.onEvent) {
                                var _loop7 = function _loop7() {
                                    var _Object$entries3$_i = _slicedToArray(_Object$entries3[_i17], 2), name = _Object$entries3$_i[0], handler = _Object$entries3$_i[1];
                                    if (typeof node.lng.on === "function") node.lng.on(name, function(_inode, data) {
                                        return handler.call(node, node, data);
                                    });
                                };
                                for (var _i17 = 0, _Object$entries3 = Object.entries(node.onEvent); _i17 < _Object$entries3.length; _i17++) {
                                    _loop7();
                                }
                            }
                            ...
                            if (node._type === NodeType.Element) {
                                ...
                                for (var _i18 = 0; _i18 < numChildren; _i18++) {
                                    var c = node.children[_i18];
                ...
                var _iterator26 = _createForOfIteratorHelper(LightningRendererNumberProps), _step26;
                try {
                ...
                var _iterator27 = _createForOfIteratorHelper(LightningRendererNonAnimatingProps), _step27;
                try {
