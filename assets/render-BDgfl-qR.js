...
var NO_CLIPPING_RECT = Object.freeze({
    x: 0,
    y: 0,
    w: 0,
    h: 0,
...
var CoreNode = class extends EventEmitter {
    constructor(stage, props) {
        ...
        if (props.texture !== null) this.texture = props.texture;
        if (props.shader === null || props.shader === this.stage.defShaderNode) p.shader = this.stage.defShaderNode; else this.shader = props.shader;
        if (props.src !== null) this.src = props.src;
        if (props.rtt !== false) this.rtt = props.rtt;
        if (props.boundsMargin !== null) this.boundsMargin = props.boundsMargin;
        if (props.interactive !== false) this.interactive = props.interactive;
    ...
    update(delta, parentClippingRect) {
        ...
        if (updateType & UpdateType.Global) {
            ...
            const gt = (_this$globalTransform = this.globalTransform) !== null && _this$globalTransform !== void 0 ? _this$globalTransform : this.globalTransform = new Matrix3d;
            ...
            if (this.parentHasRenderTexture === true && (parent == null ? void 0 : parent.rtt) === true) {
                ...
                const parentGT = parent == null ? void 0 : parent.globalTransform;
    ...
    calculateClippingRect(parentClippingRect) {
        ...
        const needsMutableRect = clipping === true && isRotated === false || parentClippingRect.valid === true;
    ...
    destroy() {
        ...
        const {children: children, parent: parent} = this;
    ...
    draw(renderer) {
        ...
        const quadIdx = this.renderOpBufferIdx / (5 * 4) * 6 * 2;
...
var CoreAnimationController = class CoreAnimationController extends EventEmitter {
    constructor() {
        ...
        this.onTick = () => {
            if (this.hasListeners("tick") === false) return;
...
var CoreTextureManager = class extends EventEmitter {
    constructor(stage, settings) {
        ...
        this.txConstructors = {};
        this.maxRetryCount = void 0;
        this.uploadTextureQueue = createTextureUploadQueue();
        this.stage = void 0;
        this.platform = void 0;
    ...
    async processSome(maxProcessingTime, maxCount) {
        const platform = this.platform;
        const startTime = platform.getTimeStamp();
        let count = 0;
        while (this.uploadTextureQueue.size > 0 && count < maxCount && platform.getTimeStamp() - startTime < maxProcessingTime) {
...
var Stage = class {
    ...
    drawFrame() {
        ...
        if (this.txManager.hasUpdates() === true) {
            ...
            const maxCount = this.activeAnimationCount > 0 && cap > 0 ? cap : 2147483647;
            this.txManager.processSome(this.options.textureProcessingTimeLimit, maxCount).catch(err => {
    ...
    buildRenderList(node, cache = true) {
...
export { onCleanup as $, $TRACK as A, createComputed as B, hasFocus as C, isInteger as D, isFunction as E, Suspense as F, createResource as G, createEffect as H, Switch as I, createSignal as J, createRoot as K, batch as L, Index as M, Match as N, Config as O, Show as P, on as Q, children as R, renderer$1 as S, isFocused as T, createMemo as U, createContext as V, createRenderEffect as W, getOwner as X, getListener as Y, mergeProps$1 as Z, use as _, assertTruthy as _t, createElement as a, untrack as at, useFocusManager as b, effect as c, RenderTexture as ct, memo as d, UpdateType as dt, onMount as et, mergeProps as f, calcFactoredRadiusArray as ft, spread as g, BufferCollection as gt, setProp as h, TextureType as ht, createComponent as i, startTransition as it, For as j, activeElement as k, insert as l, SubTexture as lt, scheduleTask as m, getNormalizedRgbaComponents as mt, Text as n, runWithOwner as nt, createRenderer as o, useContext as ot, rootNode as p, compareRect as pt, createSelector as q, View as r, sharedConfig as rt, createTextNode as s, CoreShaderNode as st, Dynamic as t, resetErrorBoundaries as tt, insertNode as u, CoreNodeRenderState as ut, ElementNode as v, mergeColorAlpha as vt, isElementNode as w, loadFonts as x, focusPath as y, createComponent$1 as z };