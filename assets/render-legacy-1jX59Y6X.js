!function() {
    ...
    System.register([], function(_export, _context) {
        ...
        return _export({
            ...
            Mt: function(radius, width, height) {
            ...
            _t: resolveShaderProps,
            at: useContext,
            b: function(_x3) {
                return _loadFonts.apply(this, arguments);
            },
            et: function() {},
            gt: isAdvancedShaderProp,
            it: untrack,
            j: function(props) {
                var fallback = "fallback" in props && {
                    fallback: function() {
            ...
            execute: function() {
                ...
                _export("Rt", "undefined" == typeof __dirtyQuadBuffer__ || __dirtyQuadBuffer__), 
                ...
                }(TextureType || _export("Lt", TextureType = {})), _export("It", Texture = function(_EventEmitter) {
                ...
                }, _export("Ot", WORDS_PER_QUAD = 64 / Uint32Array.BYTES_PER_ELEMENT), UV_QUANT_MAX = 65535, 
                _export("Dt", createTextureCoords(0, 0, 1, 1)), _export("Tt", MAX_QUADS = 16384), 
                _export("Et", 64 * MAX_QUADS), function(CoreNodeRenderState) {
                ...
                }(UpdateType || _export("wt", UpdateType = {})), CoreNode = function(_EventEmitter2) {
                ...
                }(), _export("St", ImageTexture = function(_Texture2) {
                ...
                _export("yt", TextureError = function(_Error) {
                ...
                }(), _export("vt", CoreTextureManager = function(_EventEmitter3) {
                    ...
                    var _loadTexture;
                }(EventEmitter)), _export("ht", function() {
                ...
                }(), spaceRegex = /[ \u200B]+/g, _export("ft", {
                    ascender: 800,
                    descender: -200,
                    lineGap: 200,
                    unitsPerEm: 1e3
                }), _export("mt", function(metrics, fontSize) {
                    ...
                    baselineMode = mode;
                }, _export("pt", function(measureText, metrics, text, textAlign, fontFamily, lineHeight, overflowSuffix, wordBreak, letterSpacing, maxLines, maxWidth, maxHeight) {
