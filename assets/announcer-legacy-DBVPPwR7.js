(function() {
    ...
    System.register([ "./render-legacy-BO_iU_BL.js" ], function(_export, _context) {
        "use strict";
        var getListener, createSignal, getOwner, focusPath, onCleanup, untrack, ARIA_PARENT_ID, ariaLabelPhrases, currentSeries, debounce, throttle, resetFocusPathTimer, prevFocusPath, currentlySpeaking, voiceOutDisabled, fiveMinutes, Announcer;
