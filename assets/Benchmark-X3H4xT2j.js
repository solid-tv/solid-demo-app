import { A as For, I as batch, N as Show, O as activeElement, Q as onCleanup, V as createEffect, Z as on, a as createElement, c as effect, d as memo, g as use, i as createComponent, l as insert, m as setProp, q as createSignal, s as createTextNode, u as insertNode, x as renderer } from "./render-C0sQE9My.js";

import { n as LazyRow, t as LazyColumn } from "./Lazy-Bg5UUPjB.js";

import { n as resetCounter } from "./FPSCounter-Bd9dujLi.js";

import { t as ContentBlock } from "./ContentBlock-_hytYxLK.js";

import { n as useFocusStack } from "./createFocusStack-CeFQ9E0B.js";

import { c as TitleRow, i as Hero, t as AssetPanel } from "./components-DEamwBSf.js";
...
var Benchmark = props => {
    ...
    async function runBenchmark() {
        ...
        if (fpsValues.length > 0) {
            ...
            setBenchmarkStatus(`Avg: ${avg.toFixed(1)} FPS  |  Min: ${min.toFixed(1)}  |  Max: ${max.toFixed(1)}  |  Samples: ${fpsValues.length}`);
            ...
            insert(_el$4, createComponent(Show, {
                ...
                get children() {
                    ...
                    insert(_el$16, createComponent(ResultRow, {
                        ...
                        label: "Draw Calls",
                        get value() {
                            return memo(() => !!drawStats())() ? `${drawStats().renderOps}` : "—";
                        }
                    }), _el$19);
                    insert(_el$16, createComponent(ResultRow, {
                        y: 88,
                        label: "Quads",
                        get value() {
                            return memo(() => !!drawStats())() ? `${drawStats().quads}` : "—";
                        }
                    }), _el$19);
                    ...
                    insert(_el$16, createComponent(Show, {
                        ...
                        get children() {
                            return [ createComponent(ResultRow, {
                                ...
                                get value() {
                                    return `${capabilities().maxTextureUnits}`;
                                }
                            }) ];
                        }
                    }), null);
