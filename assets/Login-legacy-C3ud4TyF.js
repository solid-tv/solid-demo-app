(function() {
    ...
    System.register([ "./render-legacy-D7c8BTw7.js", "./chainFunctions-legacy-BzIdGfsv.js", "./Column-legacy-rnCxnZWI.js", "./Row-legacy-Dr8qONdd.js", "./state-legacy-BYRVvbYV.js" ], function(_export, _context) {
        "use strict";
        var createEffect, Switch, createSignal, Index, Match, Show, on, createMemo, createElement, effect, memo, onMount, mergeProps, spread, setProp, createComponent, insert, createTextNode, insertNode, chainFunctions, Column, Row, setGlobalBackground, ContainerStyle, TextStyle, getformatValueText, Input, actionKeyContainerStyle, ActionKeyIconStyle, keyContainerStyle, BaseKeyTextStyle, KeyText, Key, ActionKey, Keyboard, formats, LoginPage;
        return {
            setters: [ function(_renderLegacy001Js) {
                createEffect = _renderLegacy001Js.H;
                Switch = _renderLegacy001Js.I;
                createSignal = _renderLegacy001Js.J;
                Index = _renderLegacy001Js.M;
                Match = _renderLegacy001Js.N;
