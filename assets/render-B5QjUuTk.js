...
var Stage = class {
    constructor(options) {
        ...
        this.fpsAnimationMs = 0;
        this.fpsFlushMs = 0;
        this.fpsMaxAnimationMs = 0;
        this.fpsMaxFlushMs = 0;
        this.frameAnimationMs = 0;
        this.frameFlushMs = 0;
    ...
    updateAnimations() {
        ...
        const start = sampling === true ? this.platform.getTimeStamp() : 0;
        animationManager.update(this.deltaTime);
        const active = hadAnimations || animationManager.activeAnimations.length > 0;
        if (sampling === true) this.frameAnimationMs = this.platform.getTimeStamp() - start;
        return active;
    }
    hasSceneUpdates() {
    ...
    drawFrame(hasActiveAnimations = false) {
        ...
        if (sampling === true) {
            ...
            const frameAnimationMs = this.frameAnimationMs;
            const frameFlushMs = this.frameFlushMs;
            this.fpsUpdateMs += frameUpdateMs;
            this.fpsRenderMs += frameRenderMs;
            this.fpsUploadMs += frameUploadMs;
            this.fpsAnimationMs += frameAnimationMs;
            this.fpsFlushMs += frameFlushMs;
            ...
            if (frameAnimationMs > this.fpsMaxAnimationMs) this.fpsMaxAnimationMs = frameAnimationMs;
            if (frameFlushMs > this.fpsMaxFlushMs) this.fpsMaxFlushMs = frameFlushMs;
    ...
    flushFrameEvents() {
        ...
        if (sampling === true) this.frameFlushMs = this.platform.getTimeStamp() - start;
    }
    ...
    emitFpsUpdate() {
        ...
        const animationMs = this.fpsAnimationMs;
        const flushMs = this.fpsFlushMs;
        const maxAnimationMs = this.fpsMaxAnimationMs;
        const maxFlushMs = this.fpsMaxFlushMs;
        ...
        this.queueFrameEvent("fpsUpdate", {
            ...
            flushMs: flushMs,
            maxAnimationMs: maxAnimationMs,
            maxFlushMs: maxFlushMs,
...
export { onMount as $, For as A, createContext as B, isElementNode as C, compareRect as Ct, Config as D, assertTruthy as Dt, isInteger as E, DIRTY_QUAD_BUFFER as Et, Switch as F, createRoot as G, createMemo as H, batch as I, getListener as J, createSelector as K, children as L, Match as M, Show as N, activeElement as O, createWebGLContext as Ot, Suspense as P, onCleanup as Q, createComponent$1 as R, hasFocus as S, clampUnit as St, isFunction as T, TextureType as Tt, createRenderEffect as U, createEffect as V, createResource as W, mergeProps as X, getOwner as Y, on as Z, ElementNode as _, WORDS_PER_QUAD as _t, createElement as a, useContext as at, loadFonts as b, isHTMLImageElement as bt, effect as c, defaultFontMetrics as ct, memo as d, CoreShaderNode as dt, resetErrorBoundaries as et, rootNode as f, uploadCompressedTexture as ft, use as g, UNIT_TEXTURE_COORDS as gt, spread as h, MAX_QUAD_BUFFER_SIZE as ht, createComponent as i, untrack as it, Index as j, $TRACK as k, mergeColorAlpha as kt, insert as l, mapTextLayout as lt, setProp as m, MAX_QUADS as mt, Text as n, sharedConfig as nt, createRenderer as o, takeCanvasPrefetch as ot, scheduleTask as p, UpdateType as pt, createSignal as q, View as r, startTransition as rt, createTextNode as s, takeSdfPrefetch as st, Dynamic as t, runWithOwner as tt, insertNode as u, normalizeFontMetrics as ut, focusPath as v, createIndexBuffer as vt, isFocused as w, getNormalizedRgbaComponents as wt, renderer$1 as x, calcFactoredRadiusArray as xt, useFocusManager as y, createTextureCoords as yt, createComputed as z };