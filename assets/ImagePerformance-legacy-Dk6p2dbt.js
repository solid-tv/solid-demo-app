(function() {
    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./api-legacy-CQ6iaaWY.js", "./imagePerf-legacy-CDsIaUnk.js" ], function(_export, _context) {
        "use strict";
        var For, createSignal, createElement, effect, createComponent, insert, setProp, onMount, insertNode, getImageUrl, api_default, createImagePerfRun, ImagePerformance;
        return {
            ...
            execute: function execute() {
                _export("default", ImagePerformance = function ImagePerformance() {
                    ...
                    var imageLoadTimes = {};
                    var totalImages = 40;
                    var perf = createImagePerfRun("image-40", totalImages);
                            ...
                            return _regenerator().w(function(_context2) {
                                while (1) switch (_context2.p = _context2.n) {
                                  case 0:
                                    ...
                                    _context2.n = 1;
                                    return api_default.get("/movie/popular?page=1");

                                  case 1:
                                    page1 = _context2.v;
                                    _context2.n = 2;
                                    return api_default.get("/movie/popular?page=2");

                                  case 2:
                                    page2 = _context2.v;
                                    newImages = [].concat(_toConsumableArray(page1.results), _toConsumableArray(page2.results)).slice(0, 40).map(function(item) {
                                        return {
                                            id: item.id,
                    ...
                    var handleImageLoaded = function handleImageLoaded(index, id) {
                        ...
                        if (currentCount % 10 === 0) performance.mark("images-loaded-".concat(currentCount));
...
//# sourceMappingURL=ImagePerformance-legacy-Dk6p2dbt.js.map