import { A as For, D as Config, I as batch, N as Show, O as activeElement, Q as onCleanup, V as createEffect, Z as on, a as createElement, c as effect, d as memo, g as use, i as createComponent, l as insert, m as setProp, q as createSignal, s as createTextNode, u as insertNode, x as renderer } from "./render-B5QjUuTk.js";

import { n as LazyRow, t as LazyColumn } from "./Lazy-CzmJKAAs.js";

import { n as resetCounter } from "./FPSCounter-Mxchg_cL.js";

import { t as ContentBlock } from "./ContentBlock-BSHaHMnO.js";

import { n as useFocusStack } from "./createFocusStack-HwvMWIQG.js";

import { c as TitleRow, i as Hero, t as AssetPanel } from "./components-C7XnKDAv.js";
...
var Benchmark = props => {
    ...
    let totalAnimationMs = 0;
    let totalFlushMs = 0;
    let worstMaxAnimationMs = 0;
    let worstMaxFlushMs = 0;
        ...
        root.on("fpsUpdate", (_target, fpsData) => {
            ...
            if (typeof fps === "number" && fps > 5 && benchmarkRunning()) {
                ...
                if (typeof fpsData === "object" && fpsData !== null) {
                    ...
                    totalAnimationMs += payload.animationMs || 0;
                    totalFlushMs += payload.flushMs || 0;
                    if (typeof payload.maxAnimationMs === "number") worstMaxAnimationMs = Math.max(worstMaxAnimationMs, payload.maxAnimationMs);
                    if (typeof payload.maxFlushMs === "number") worstMaxFlushMs = Math.max(worstMaxFlushMs, payload.maxFlushMs);
    ...
    async function runBenchmark() {
        ...
        const calculatedStats = {
            ...
            totalAnimationMs: totalAnimationMs,
            totalFlushMs: totalFlushMs,
            maxAnimationMs: worstMaxAnimationMs,
            maxFlushMs: worstMaxFlushMs,
        ...
        const benchmarkResultsJson = {
            ...
            frameWorkSplit: {
                ...
                totalAnimationMs: parseFloat(calculatedStats.totalAnimationMs.toFixed(2)),
                maxAnimationMs: parseFloat(calculatedStats.maxAnimationMs.toFixed(2)),
                totalFlushMs: parseFloat(calculatedStats.totalFlushMs.toFixed(2)),
                maxFlushMs: parseFloat(calculatedStats.maxFlushMs.toFixed(2))
            },
            inputDispatch: {
    ...
    const overlayHeight = () => capsStartY() + 8 * ROW_H + 18;
    return createComponent(Show, {
        ...
        get children() {
            ...
            effect(_p$ => {
                var _v$ = bundleType.indexOf("LEGACY") !== -1 ? 4291559679 : 16746751, _v$2 = benchmarkDone() ? 16746751 : benchmarkRunning() ? 4291559679 : 2863311615;
                _v$ !== _p$.e && (_p$.e = setProp(_el$16, "color", _v$, _p$.e));
                _v$2 !== _p$.t && (_p$.t = setProp(_el$17, "color", _v$2, _p$.t));
                return _p$;
            }, {
                e: void 0,
                t: void 0
