(function() {
    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./state-legacy-2LKtSLYa.js" ], function(_export, _context) {
        "use strict";
        var Suspense, createResource, createEffect, createSignal, createElement, onCleanup, use, createComponent, insert, setProp, createTextNode, onMount, insertNode, setGlobalBackground;
        function fadeIn(el) {
            el.alpha = 0;
            el.animate({
                alpha: 1
        ...
        _export("default", SuspensePage);
        return {
            setters: [ function(_renderLegacy001Js) {
                Suspense = _renderLegacy001Js.I;
...
//# sourceMappingURL=suspense-legacy-B1yPr_7P.js.map