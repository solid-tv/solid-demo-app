(function() {
    ...
    System.register([ "./render-legacy-zhspBKrd.js", "./web-legacy-Dt_TNc5h.js" ], function(_export, _context) {
        "use strict";
        var createSignal, batch, on, createMemo, createContext, createRenderEffect, getOwner, untrack, startTransition, runWithOwner, useContext, resetErrorBoundaries, createComponent, voidFn, depth, hasSchemeRegex, trimPathRegex, mockBase, MAX_REDIRECTS, RouterContextObj, RouteContextObj, useRouter, useNavigate, useLocation, usePreloadRoute, useMatch, useParams, intent, inPreloadFn;
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                createContext = _renderLegacy001Js.V;
                createRenderEffect = _renderLegacy001Js.W;
                getOwner = _renderLegacy001Js.X;
                untrack = _renderLegacy001Js.at;
                startTransition = _renderLegacy001Js.it;
                runWithOwner = _renderLegacy001Js.nt;
                useContext = _renderLegacy001Js.ot;
                resetErrorBoundaries = _renderLegacy001Js.tt;
                createComponent = _renderLegacy001Js.z;
