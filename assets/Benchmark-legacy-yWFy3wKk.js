                ...
                _export("default", Benchmark = function Benchmark(props) {
                    ...
                    function _runBenchmark() {
                        _runBenchmark = _asyncToGenerator(_regenerator().m(function _callee() {
                            var _props$data, _currentCaps$webGlVer, _currentCaps$vertexAr, totalRows, cycle, i, _i3, avgAnimatedFps, avgFps, minFps, maxFps, animP95, animP99, allP95, allP99, avgActiveAnims, meanUploadCost, meanKeyDispatch, calculatedStats, currentCaps, benchmarkResultsJson, animRateStr;
