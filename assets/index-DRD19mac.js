...
const _isHandlerConsumed = result => result !== false;
...
const runCapturePhase = (fp, e, mappedEvent, isUp, sameKey, currentTime) => {
    ...
    for (let i = fp.length - 1; i >= 0; i--) {
        ...
        if (isFunction(captureHandler)) {
            const result = captureHandler.call(elm, e, elm, finalFocusElm, mappedEvent);
    ...
    for (let i = 0; i < fp.length; i++) {
        ...
        if (eventHandlerKey) {
            ...
            if (isFunction(eventHandler)) {
                lastHandlerSeen = elm;
                handled = _isHandlerConsumed(eventHandler.call(elm, e, elm, finalFocusElm));
            }
        }
        if (!handled && fallbackHandlerKey) {
            ...
            if (isFunction(fallbackHandler)) {
                lastHandlerSeen = elm;
                handled = _isHandlerConsumed(fallbackHandler.call(elm, e, mappedEvent, elm, finalFocusElm));
            }
        }
        if (handled) {
            elm._lastAnyKeyPressTime = currentTime;
...
const Player = lazy(() => __vitePreload(() => import("./Player-7pwNIqvY.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-CFEkFymP.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DtnjVk3M.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-OW8nADXW.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-hlCxNDUN.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-B-BBFled.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-CWmL8OSu.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-BMWRNGqe.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DCnWCK3H.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-BjYJTuiB.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-CGSAKOW3.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-Bj7pWqRF.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-COEuvHeV.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-QPt-ywF0.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-TUYsrAHG.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-BdOkwF6s.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BT_JKsSs.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-CuWoObeB.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-OQXtfUpU.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-BNAxAehE.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-zbnFV6BC.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-_n4mqmJ4.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-DZEMEyhZ.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-eWukxtcp.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-CGgmWu4b.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DusOXuSK.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CLFonG9s.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-CVe2OI2O.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-DB1ZbgZv.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-CoV-s6uC.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-CeayjBte.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-DB4QxWpq.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-DPt5bFaM.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-ytHF3pot.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-B4vqttc8.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-DKa-0TAY.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-B0mNDO-P.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-DIgPW_zb.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-DfCVFkZQ.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-B6mzIlFo.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-B1V6L4nl.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-C9kjCrOd.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-BxqOrjuE.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-DI3sJvwW.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-BKEV4Ot1.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-BXq2z8gj.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-7Svnd_HL.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
...
//# sourceMappingURL=index-DRD19mac.js.map
