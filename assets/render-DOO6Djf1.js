function createWebGLContext(canvas, forceWebGL2 = !1, contextSpy = null, powerPreference = "default") {
    const config = {
        alpha: !0,
        antialias: !1,
        depth: !1,
...
var ENABLE_INSPECTOR = "undefined" != typeof __enableInspector__ && __enableInspector__, EMIT_BOUNDS_EVENTS = "undefined" != typeof __emitBoundsEvents__ && __emitBoundsEvents__;
...
var TextureType, EventEmitter = class {
    ...
    emit(event, data) {
        ...
        if (1 === len) return void listeners[0](this, data);
...
var Texture = class Texture extends EventEmitter {
    constructor(txManager) {
        ...
        this.gracePeriodExpired = !1, this.freeTextureDataTask = () => {
            ...
            null !== textureData && closeImageBitmap(textureData.data), this.textureData = null;
        }, this.detachTextureDataTask = () => {
...
var PROTOCOL_REGEX = /^(data|ftps?|https?):/, IS_FILE_PROTOCOL = "undefined" != typeof self && "file:" === self.location.protocol, getNormalizedRgbaComponents = rgba => [ (rgba >>> 24) / 255, (rgba >>> 16 & 255) / 255, (rgba >>> 8 & 255) / 255, (255 & rgba) / 255 ];
...
function createAnimation(manager, node, props, settings) {
    ...
    let propValues = null, shaderPropValues = null, propKeys = null, propList = null, shaderPropKeys = null, shaderPropList = null;
    for (const key in props) if ("shaderProps" !== key) {
        ...
        shaderPropValues || (shaderPropValues = {}, shaderPropKeys = [], shaderPropList = []);
        for (const shaderKey in props.shaderProps) {
            ...
            shaderPropValues[shaderKey] = value, shaderPropKeys.push(shaderKey), shaderPropList.push(value);
        }
    }
...
function createTextureCoords(x1, y1, x2, y2) {
    return function(tc) {
        const u1 = quantizeUv(tc.x1), u2 = quantizeUv(tc.x2), v1 = quantizeUv(tc.y1), v2 = quantizeUv(tc.y2);
        return tc.qTl = (v1 << 16 | u1) >>> 0, tc.qTr = (v1 << 16 | u2) >>> 0, tc.qBl = (v2 << 16 | u1) >>> 0, 
...
var CoreNodeRenderState, UNIT_TEXTURE_COORDS = createTextureCoords(0, 0, 1, 1), MAX_QUADS = 16384, MAX_QUAD_BUFFER_SIZE = 1048576;

function createIndexBuffer(glw) {
    const indices = new Uint16Array(98304);
    for (let i = 0, j = 0; i < 98304; i += 6, j += 4) indices[i] = j, indices[i + 1] = j + 1, 
...
function isHTMLImageElement(obj) {
    return null !== obj && ("object" == typeof obj && obj.constructor && "HTMLImageElement" === obj.constructor.name || "undefined" != typeof HTMLImageElement && obj instanceof HTMLImageElement);
}
...
var CoreNode = class extends EventEmitter {
    constructor(stage, props) {
        ...
        this._animations = null, this.renderOpBufferIdx = 0, this.numQuads = 0, this.renderOpTexture = null, 
        this.hasShaderUpdater = !1, this.hasShaderTimeFn = !1, this.hasColorProps = !1, 
        this.textureLoaded = !1, this.textureOwnership = !1, this.placeholderActive = !1, 
        this.updateType = 0, this.childUpdateType = 0, this.globalTransform = void 0, this.localTransform = void 0, 
        this.renderCoords = void 0, this.renderBound = void 0, this.clippingRect = NO_CLIPPING_RECT, 
        ...
        this._hasContainResize = !1, this._hasMount = !1, this._globalIsTranslate = !0, 
        this.worldAlpha = 1, this.premultipliedColorTl = 0, this.premultipliedColorTr = 0, 
        this.premultipliedColorBl = 0, this.premultipliedColorBr = 0, this.calcZIndex = 0, 
        this.destroyed = !1, this.loadTextureTask = () => {
            ...
            texture.on("freed", this.onTextureFreed), "loaded" === texture.state ? this.onTextureLoaded(texture, texture.dimensions) : "failed" === texture.state ? this.onTextureFailed(texture, texture.error) : "freed" === texture.state && this.onTextureFreed(texture));
        }, this.onTextureLoaded = (_, dimensions) => {
            var _this$props$textureOp3;
            this.applyAutosizeDimensions(dimensions.w, dimensions.h), this.textureLoaded = !0, 
            this.updatePlaceholderActive(), this.setUpdateType(UpdateType.IsRenderable), this.stage.requestRender(), 
            ...
            this.updateTextureOwnership(!1), this.setUpdateType(UpdateType.IsRenderable), null !== this.texture && this.texture.retryCount > this.texture.maxRetryCount && this.emit("failed", {
                type: "texture",
                error: error
            });
        }, this.onTextureFreed = () => {
            this.textureLoaded = !1, this.isRenderable = !1, this.updatePlaceholderActive(), 
            this.updateTextureOwnership(!1), this.setUpdateType(UpdateType.IsRenderable), this.emit("freed", {
                type: "texture"
            });
        ...
        const {texture: texture, shader: shader, src: src, parent: parent} = props, p = this.props = props;
        p.texture = null, p.shader = null, p.src = null, p.scale = null, this.hasColorProps = this.computeHasColorProps(), 
        0 !== p.zIndex && (this.zIndex = p.zIndex), null !== parent && parent.addChild(this), 
        null !== texture && (this.texture = texture), null === shader || shader === this.stage.defShaderNode ? p.shader = this.stage.defShaderNode : this.shader = shader, 
        null !== src && (this.src = src), this.setUpdateType(initialUpdateType), this.updateIsSimple();
    }
    ...
    update(delta, parentClippingRect) {
        const props = this.props, parent = props.parent;
        let newRenderState = null, checkRenderState = !1, updateType = this.updateType, childUpdateType = this.childUpdateType;
        ...
        updateType |= UpdateType.Global), updateType & UpdateType.Global) {
            const lt = this.localTransform, gt = this.globalTransform, parentGT = parent.globalTransform;
        ...
        !0 === checkRenderState && (newRenderState = this.checkRenderBounds(), newRenderState !== this.renderState ? (updateType |= UpdateType.IsRenderable, 
        ...
        this.shader.update()), updateType & UpdateType.Children && this.children.length > 0) {
            const childClippingRect = this.clippingRect, children = this.children, length = children.length;
    ...
    checkRenderBounds() {
        ...
        let x1 = 0, y1 = 0, x2 = stage.viewportW, y2 = stage.viewportH;
    ...
    updateGlobalGeometry() {
        const {w: w, h: h} = this.props, g = this.globalTransform, tx = g.tx, ty = g.ty, tb = g.tb, tc = g.tc;
        if (0 === tb && 0 === tc) {
            const maxX = tx + w * g.ta, maxY = ty + h * g.td;
        ...
        const x2 = tx + w * g.ta, y2 = ty + w * tc, x3 = x2 + h * tb, y3 = y2 + h * g.td, x4 = tx + h * tb, y4 = ty + h * g.td;
    ...
    set texture(value) {
        ...
        this.textureOwnership = this.isRenderable, this.loadTexture()), this.setUpdateType(UpdateType.IsRenderable), 
        this.updateIsSimple());
    }
    ...
    flush() {}
    draw(renderer) {
        const {glw: glw, stage: stage} = renderer, shader = this.props.shader;
    ...
    applyValues(anim) {
        const progress = anim.progress, easedProgress = anim.timingFunction(progress) || progress, propKeys = anim.propKeys;
    ...
    writeValues(target, keys, values, progress, easedProgress) {
        ...
        if (1 !== progress) if (0 !== progress) for (let i = 0; i < len; i++) {
            const value = values[i], start = value.start;
            !0 === value.isColor ? target[keys[i]] = mergeColorProgress(start, value.target, easedProgress) : target[keys[i]] = start + (value.target - start) * easedProgress;
        } else for (let i = 0; i < len; i++) target[keys[i]] = values[i].start; else for (let i = 0; i < len; i++) target[keys[i]] = values[i].target;
    }
    reverseValues(anim) {
...
var ImageWorkerManager = class {
    ...
    handleMessage(event) {
        const {id: id, data: data, error: error} = event.data, msg = this.messageManager.get(id);
        if (void 0 !== msg) {
    ...
    spawnWorker() {
        if (!0 === this.spawnAttempted) return;
        this.spawnAttempted = !0;
        const blob = this.createWorkerBlob(), urlFactory = self.URL ? URL : webkitURL, blobURL = urlFactory.createObjectURL(blob), worker = new Worker(blobURL);
        urlFactory.revokeObjectURL(blobURL), worker.onmessage = event => this.handleMessage(event), 
        worker.onerror = event => this.handleWorkerError(event), worker.onmessageerror = event => this.handleWorkerError(event), 
        worker.postMessage({
            init: !0,
    ...
    getImage(src, premultiplyAlpha, sx, sy, sw, sh) {
        return new Promise((resolve, reject) => {
            ...
            if (null === worker) return void reject(new Error("No image worker available"));
            const id = this.nextId++;
            this.messageManager.set(id, [ resolve, reject ]), worker.postMessage({
                id: id,
                src: src,
...
var TextureErrorCode, STRAIGHT_ALPHA_TEST_PNG = new Uint8Array([ 137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0, 1, 0, 0, 0, 1, 8, 6, 0, 0, 0, 31, 21, 196, 137, 0, 0, 0, 13, 73, 68, 65, 84, 120, 156, 99, 248, 207, 192, 208, 0, 0, 4, 129, 1, 128, 44, 85, 206, 176, 0, 0, 0, 0, 73, 69, 78, 68, 174, 66, 96, 130 ]);
...
var TextureUploadQueue = class {
...
}, ConcurrencyGate = class {
    constructor(limit) {
        this.limit = void 0, this.inFlight = 0, this.waiters = [], this.limit = limit;
    }
    acquire() {
        return this.inFlight < this.limit ? (this.inFlight++, Promise.resolve()) : new Promise(resolve => {
    ...
    constructor(stage, settings) {
        ...
        this.uploadTextureQueue = new TextureUploadQueue, this.pendingLoads = 0, this.initialized = !1, 
        this.stage = void 0, this.numImageWorkers = void 0, this.imageDecodeConcurrency = void 0, 
        this.decodeGate = null, this.platform = void 0, this.imageWorkerManager = null, 
        this.hasCreateImageBitmap = !1, this.imageBitmapSupported = {
            basic: !1,
            options: !1,
            full: !1,
            premultiplyHonored: null
        }, this.hasWorker = !!self.Worker, this.renderer = void 0;
        ...
        this.maxRetryCount = maxRetryCount, this.imageDecodeConcurrency = imageDecodeConcurrency, 
        "auto" === createImageBitmapSupport ? async function(platform) {
            var _bitmap$close;
    ...
    async loadTexture(texture) {
        ...
        if (!0 !== isImage || !1 !== this.initialized) {
            texture.setState("loading"), this.pendingLoads++;
            try {
                const gate = !0 === isImage ? this.decodeGate : null;
                let textureDataResult;
                null !== gate && await gate.acquire();
                try {
                    textureDataResult = await texture.getTextureData().catch(err => (console.error(err), 
                    texture.setState("failed", new TextureError(TextureErrorCode.TEXTURE_DATA_NULL)), 
                    null));
                } finally {
                    null !== gate && gate.release();
                }
                if (null === textureDataResult || "failed" === texture.state) return;
                if (!1 === isImage) return void this.uploadTexture(texture);
                this.enqueueUploadTexture(texture);
            } finally {
                this.pendingLoads--;
            }
        } else this.uploadTextureQueue.add(texture);
    }
    ...
    refetchAndUpload(texture) {
        ...
        (null !== gate ? gate.acquire().then(() => texture.getTextureData()) : texture.getTextureData()).then(() => {
            this.isTextureDead(texture) || null === texture.textureData || this.uploadTexture(texture);
        }).catch(error => {
            console.error("Failed to upload texture:", error);
        }).then(() => {
            null !== gate && gate.release(), this.pendingLoads--;
        });
    }
...
function resolveShaderProps(props, propsConfig) {
    for (const key in propsConfig) {
        ...
        if (void 0 === pConfig.resolve) {
            if (hasValue && void 0 !== pConfig.set) pConfig.set(props[key], props); else if (!hasValue) {
                if (void 0 === props[key] && void 0 === pConfig.get) {
...
var TextConstraint, CoreShaderNode = class {
    ...
    const words = line.split(spaceRegex), spaces = line.match(spaceRegex) || [];
    if ("" === words[0] && words.length > 1) {
        var _spaces$shift, _words$;
        const leadingSpace = null !== (_spaces$shift = spaces.shift()) && void 0 !== _spaces$shift ? _spaces$shift : "";
    ...
    for (;(pendingWord.length > 0 || wordIdx < words.length) && remainingLines > 0; ) {
        ...
        const space = spaces[spaceIdx++] || "", effectiveSpaceWidth = " " === space ? spaceWidth : space.length > 0 ? measureText(space, fontFamily, letterSpacing) : 0, totalWidth = currentLineWidth + effectiveSpaceWidth + wordWidth;
...
}, frameTimeBucketLowerBound = index => index < 32 ? 1 * index : 32 + 8 * (index - 32), TextureMemoryManager = class {
    constructor(stage, settings) {
...
var CoreTextNode = class extends CoreNode {
    ...
    updateIsRenderable() {
        "canvas" !== this._type ? this.setRenderable(!0 === this.checkBasicRenderability() && null !== this._cachedLayout && this.renderState === CoreNodeRenderState.InViewport) : super.updateIsRenderable();
    }
...
var EMPTY_TEXTURE_OPTIONS = Object.freeze({}), Stage = class {
    constructor(options) {
        ...
        }(renderMode), this.txManager.renderer = this.renderer, this.createDefaultTexture(), 
    ...
    updateFrameTime(frameTime) {
        const newFrameTime = void 0 !== frameTime && frameTime > 0 ? frameTime : this.platform.getTimeStamp();
    ...
    createDefaultTexture() {
        const dt = this.txManager.createTexture("ColorTexture", {
            color: 4294967295
        });
    ...
    drawFrame(hasActiveAnimations = !1) {
        const {renderer: renderer, renderRequested: renderRequested, root: root, platform: platform} = this, sampling = this.options.fpsUpdateInterval > 0;
        let updateStart = 0, renderStart = 0, uploadStart = 0, uploadEnd = 0;
        ...
        if (renderer.render(), !0 === sampling && (uploadStart = platform.getTimeStamp(), 
        uploadEnd = uploadStart), !0 === this.txManager.hasUpdates()) {
            if (!0 === sampling) {
        ...
        if (!0 === sampling) {
            ...
            const frameUpdateMs = renderStart - updateStart, frameRenderMs = uploadStart - renderStart, frameUploadMs = uploadEnd - uploadStart;
        ...
        !0 === renderRequested && (this.renderRequested = !1);
        const timedNodes = this.timedNodes;
        for (let i = 0, len = timedNodes.length; i < len; i++) if (!0 === timedNodes[i].isRenderable) {
            this.requestRender();
            break;
        }
    ...
    flushFrameEvents() {
        const queue = this.frameEventQueue, len = queue.length;
        if (0 !== len) {
    ...
    calculateFps(rendered, animating = !1) {
    ...
    requestRenderListUpdate() {
        this.requestRender(), !0 !== this.renderListDirty && (void 0 !== this.renderer.invalidateRenderListCaches && this.renderer.invalidateRenderListCaches(), 
    ...
    untrackTimedNode(node) {
        const timedNodes = this.timedNodes, last = timedNodes.length - 1;
        for (let i = 0; i <= last; i++) if (timedNodes[i] === node) return timedNodes[i] = timedNodes[last], 
    ...
    startLoop(stage) {
        let isIdle = !1, lastFrameTime = 0, lastTickTime = 0, scheduled = !1;
        let nextFrameTime = 0;
        const requestLoop = () => requestAnimationFrame(runLoop), scheduleOnGrid = (currentTime, targetFrameTime) => {
            nextFrameTime += targetFrameTime, nextFrameTime - currentTime < targetFrameTime / 2 && (nextFrameTime = currentTime + targetFrameTime);
            const delay = nextFrameTime - this.getTimeStamp();
            setTimeout(requestLoop, Math.min(Math.max(delay, 0), targetFrameTime));
        }, runLoop = (currentTime = 0) => {
            scheduled = !1;
            try {
                (currentTime => {
                    if (!0 === stage.isContextLost) return;
                    const targetFrameTime = stage.targetFrameTime, timerPacing = targetFrameTime > 0 && "timer" === stage.options.framePacing;
                    if (!0 === timerPacing) {
                        if (currentTime - lastTickTime < targetFrameTime / 2) return setTimeout(requestLoop, lastTickTime + targetFrameTime - currentTime), 
                        void (scheduled = !0);
                        ...
                        if (elapsed < targetFrameTime - 2) {
                            ...
                            return wait > 4 ? setTimeout(requestLoop, wait - 4) : requestAnimationFrame(runLoop), 
                            void (scheduled = !0);
                        }
                        lastFrameTime = currentTime + 2 - (elapsed + 2) % targetFrameTime;
                    } else lastFrameTime = currentTime;
                    lastTickTime = currentTime, stage.updateFrameTime(currentTime);
                    ...
                    isIdle = !1, !0 === timerPacing && (scheduleOnGrid(currentTime, targetFrameTime), 
                    scheduled = !0), stage.drawFrame(hasActiveAnimations), stage.flushFrameEvents(), 
                    !1 === timerPacing && (requestAnimationFrame(runLoop), scheduled = !0);
                })(currentTime);
            } catch (error) {
...
}, noop = () => {}, normalizeBoundsMargin$1 = value => {
    if (!1 === Array.isArray(value)) return value;
    const arr = value;
    let max = 0;
    for (let i = 0; i < arr.length; i++) arr[i] > max && (max = arr[i]);
    return console.warn(`boundsMargin array form is no longer supported, using the largest edge value: ${max}`), 
    max;
}, resolveTargetFPS = fps => void 0 === fps ? 60 : fps > 0 ? fps : 0, resolveFramePacing = pacing => "timer" === pacing ? "timer" : "raf", RendererMain = class extends EventEmitter {
    constructor(settings, target) {
        var _settings$boundsMargi, _settings$clearColor, _settings$textLayoutC, _settings$enableConte, _settings$forceWebGL, _settings$disableVert, _settings$powerPrefer, _settings$inspector, _settings$inspectorOp, _settings$quadBufferS, _settings$fontEngines, _settings$textBaselin, _settings$maxRetryCou, _settings$handleLoopE, _settings$maxRetryCou2;
        ...
        settings = {
            ...
            framePacing: resolveFramePacing(settings.framePacing),
            ...
            powerPreference: null !== (_settings$powerPrefer = settings.powerPreference) && void 0 !== _settings$powerPrefer ? _settings$powerPrefer : "default",
    ...
    get framePacing() {
        return this.stage.options.framePacing;
    }
    set framePacing(pacing) {
        this.stage.options.framePacing = resolveFramePacing(pacing);
    }
    windowDevicePixelRatio() {
        return "undefined" != typeof window ? window.devicePixelRatio : void 0;
    }
}, sdfPrefetch = new Map, canvasPrefetch = new Map, orNull = promise => promise.then(value => value, () => null), normalizeSdfData = response => {
    let data = response;
    ...
    return null === data || "object" != typeof data ? null : void 0 !== data.chars ? data : null;
}, prefetchFont = options => {
    const {fontFamily: fontFamily, fontUrl: fontUrl, atlasUrl: atlasUrl, atlasDataUrl: atlasDataUrl} = options, names = Array.isArray(fontFamily) ? fontFamily : [ fontFamily ], primary = names[0];
    if (void 0 !== primary) if (void 0 === atlasDataUrl || "canvas" === options.type) {
        ...
        sdfPrefetch.set(primary, {
            ...
            atlas: void 0 !== atlasUrl ? orNull(fetchJson(atlasUrl, "blob")).then(blob => blob instanceof Blob ? blob : null) : Promise.resolve(null)
        });
    }
}, takeSdfPrefetch = fontFamily => {
    const prefetched = sdfPrefetch.get(fontFamily);
    return void 0 !== prefetched && sdfPrefetch.delete(fontFamily), prefetched;
}, takeCanvasPrefetch = fontFamily => {
...
function applySubTextureScaling(node, img, srcPos) {
    ...
    const targetW = node.props.w || regionW, targetH = node.props.h || regionH, naturalW = img.naturalWidth || regionW, naturalH = img.naturalHeight || regionH, scaleX = targetW / regionW, scaleY = targetH / regionH;
...
function updateNodeStyles(node) {
    ...
    if (node instanceof DOMText) {
        ...
        style += radiusStyle, needsBackgroundLayer) {
            ...
            node.imgEl.removeAttribute("src"), node.imgEl.addEventListener("load", () => {
                const payload = {
                    type: "texture",
                    dimensions: {
...
function loadFontToDom(font) {
    ...
    const fontSet = document.fonts, names = Array.isArray(font.fontFamily) ? font.fontFamily : [ font.fontFamily ];
...
async function loadFonts(fonts) {
    if (void 0 !== renderer$1) return void (await attachFonts(fonts));
    const enableDomRenderer = DOM_RENDERING && Config.domRendererEnabled, preferSdf = function() {
        var _Config$rendererOptio;
        const engines = null == (_Config$rendererOptio = Config.rendererOptions) ? void 0 : _Config$rendererOptio.fontEngines;
        return void 0 === engines || 0 === engines.length || engines.some(engine => "sdf" === engine.type);
    }(), deferred = [];
    for (let i = 0; i < fonts.length; i++) {
        const font = fonts[i];
        enableDomRenderer ? "fontUrl" in font && loadFontToDom(font) : (prefetchFont(preferSdf ? font : {
            ...font,
            type: "canvas"
        }), deferred.push(font));
    }
    0 !== deferred.length && await new Promise((resolve, reject) => {
...
var lastInputKey, [focusPath, setFocusPath] = createSignal([]), updateFocusPath = (currentFocusedElm, prevFocusedElm) => {
...
}, lastGlobalKeyPressTime = 0, isElementThrottled = (elm, sameKey, currentTime) => void 0 !== elm.throttleInput && sameKey && void 0 !== elm._lastAnyKeyPressTime && currentTime - elm._lastAnyKeyPressTime < elm.throttleInput, propagateKeyPress = (e, mappedEvent, isUp = !1) => {
    const currentTime = performance.now(), key = (e => e.key || e.keyCode)(e), sameKey = lastInputKey === key;
    ...
    const {handled: handled, lastHandlerSeen: lastHandlerSeen} = ((fp, e, mappedEvent, isUp, sameKey, currentTime) => {
        const finalFocusElm = fp[0], eventHandlerKey = mappedEvent ? isUp ? `on${mappedEvent}Release` : `on${mappedEvent}` : void 0, fallbackHandlerKey = isUp ? void 0 : "onKeyPress";
        let lastHandlerSeen;
    ...
    })(fp, e, mappedEvent, isUp, sameKey, currentTime);
    return !!handled;
}, keyIdentities = keyOrEvent => {
    if ("object" != typeof keyOrEvent) return [ keyOrEvent ];
    const ids = [];
...
}, suppressedKeys = new Map, findSuppression = ids => {
    for (const id of ids) {
...
}, useFocusManager = userKeyMap => {
    userKeyMap && ((keyMap, targetMap) => {
    ...
    const keyPressHandler = event => ownerContext(() => handleKeyEvents(event, void 0)), keyUpHandler = event => ownerContext(() => handleKeyEvents(void 0, event));
...
function createRenderer(rendererOptions, node) {
    ...
    rootNode.lng = renderer.root, rootNode.rendered = !0, renderer.on("idle", () => {
...
var {effect: effect, memo: memo, createComponent: createComponent, createElement: createElement, createTextNode: createTextNode, insertNode: insertNode, insert: insert, spread: spread, setProp: setProp, use: use} = solidRenderer, taskQueue = [], tasksEnabled = !1;
...
export { onMount as $, For as A, WORDS_PER_QUAD as At, createContext as B, closeImageBitmap as Bt, isElementNode as C, isTextureError as Ct, Config as D, MAX_QUADS as Dt, isInteger as E, UpdateType as Et, Switch as F, clampUnit as Ft, createRoot as G, createMemo as H, createWebGLContext as Ht, batch as I, compareRect as It, getListener as J, createSelector as K, children as L, getNormalizedRgbaComponents as Lt, Match as M, createTextureCoords as Mt, Show as N, isHTMLImageElement as Nt, activeElement as O, MAX_QUAD_BUFFER_SIZE as Ot, Suspense as P, calcFactoredRadiusArray as Pt, onCleanup as Q, createComponent$1 as R, Texture as Rt, hasFocus as S, TextureErrorCode as St, isFunction as T, uploadCompressedTexture as Tt, createRenderEffect as U, createEffect as V, assertTruthy as Vt, createResource as W, mergeProps as X, getOwner as Y, on as Z, ElementNode as _, CoreShaderNode as _t, createElement as a, useContext as at, loadFonts as b, CoreTextureManager as bt, effect as c, takeCanvasPrefetch as ct, memo as d, resolveFramePacing as dt, resetErrorBoundaries as et, rootNode as f, resolveTargetFPS as ft, use as g, normalizeFontMetrics as gt, spread as h, mapTextLayout as ht, createComponent as i, untrack as it, Index as j, createIndexBuffer as jt, $TRACK as k, UNIT_TEXTURE_COORDS as kt, insert as l, takeSdfPrefetch as lt, setProp as m, defaultFontMetrics as mt, Text as n, sharedConfig as nt, createRenderer as o, clearFontPrefetch as ot, scheduleTask as p, frameTimeBucketLowerBound as pt, createSignal as q, View as r, startTransition as rt, createTextNode as s, prefetchFont as st, Dynamic as t, runWithOwner as tt, insertNode as u, RendererMain as ut, focusPath as v, isAdvancedShaderProp as vt, isFocused as w, ImageTexture as wt, renderer$1 as x, TextureError as xt, useFocusManager as y, resolveShaderProps as yt, createComputed as z, TextureType as zt };