(function() {
    ...
    System.register([ "./render-legacy-BcGhlmZk.js", "./mergeProps-legacy-CW0lxKJl.js", "./chainFunctions-legacy-D8RSddZy.js", "./Column-legacy-BHaIz8zK.js", "./Row-legacy-X6Hwq6V8.js", "./state-legacy-2LKtSLYa.js" ], function(_export, _context) {
        "use strict";
        var on, Show, Switch, Index, Match, createEffect, createMemo, createSignal, createElement, effect, memo, spread, createComponent, insert, setProp, createTextNode, onMount, insertNode, mergeProps, chainFunctions, Column, Row, setGlobalBackground, ContainerStyle, TextStyle, getformatValueText, Input, actionKeyContainerStyle, ActionKeyIconStyle, keyContainerStyle, BaseKeyTextStyle, KeyText, Key, ActionKey, Keyboard, formats, LoginPage;
        return {
            setters: [ function(_renderLegacy001Js) {
                on = _renderLegacy001Js.$;
                Show = _renderLegacy001Js.F;
                Switch = _renderLegacy001Js.L;
                Index = _renderLegacy001Js.N;
                Match = _renderLegacy001Js.P;
            ...
            execute: function execute() {
                ...
                getformatValueText = function getformatValueText(props, value) {
                ...
                ActionKey = function ActionKey(props) {
                ...
                Keyboard = function Keyboard(props) {
                ...
                _export("default", LoginPage = function LoginPage() {
                    var Title = {
                        fontSize: 42,
                        fontWeight: "bold"
                    };
                    ...
                    var onEnter = function onEnter(_e, _keyboard, key) {
                        if (typeof key.key === "string") setKeyEvent(key.key); else if (_typeof(key.key) === "object") {
...
//# sourceMappingURL=Login-legacy-D03U5wx2.js.map