(function() {
    ...
    System.register([ "./index-legacy-VOFG1F7r.js" ], function(exports, module) {
        "use strict";
        var useNavigate, useFocusStack, children, createSelector, createEffect, Announcer, memo, createElement, insertNode, setProp, createTextNode, insert, createComponent, Column, Row, For, mergeProps, effect, styles, assertTruthy, createSignal, spread, use;
        return {
            setters: [ function(module) {
                useNavigate = module.u;
                useFocusStack = module.J;
                children = module.K;
                createSelector = module.g;
                        ...
                        insert(_el$10, createComponent(Column, {
                            ...
                            get children() {
                                return [ function() {
                                    ...
                                    effect(function(_$p) {
                                        return setProp(_el$12, "style", styles.RowTitle, _$p);
                                    });
                                    return _el$11;
                                }(), function() {
                                    ...
                                    effect(function(_$p) {
                                        return setProp(_el$15, "style", styles.RowTitle, _$p);
                                    });
                                    return _el$14;
                                }(), function() {
                                    ...
                                    effect(function(_$p) {
                                        return setProp(_el$18, "style", styles.RowTitle, _$p);
                                    });
                                    return _el$17;
                                }(), function() {
                                    ...
                                    effect(function(_$p) {
                                        return setProp(_el$21, "style", styles.RowTitle, _$p);
                                    });
                                    return _el$20;
                                }() ];
                            }
...
//# sourceMappingURL=Portal-legacy-BWryQIJ7.js.map
