...
const compareZIndex = (a, b) => a.props.zIndex - b.props.zIndex;
...
class Stage {
    constructor(options) {
        ...
        var _a2;
        this.options = options;
        const {canvas: canvas2, clearColor: clearColor, appWidth: appWidth, appHeight: appHeight, boundsMargin: boundsMargin, enableContextSpy: enableContextSpy2, forceWebGL2: forceWebGL22, numImageWorkers: numImageWorkers2, textureMemory: textureMemory, renderEngine: renderEngine, fontEngines: fontEngines, createImageBitmapSupport: createImageBitmapSupport, premultiplyAlphaHonored: premultiplyAlphaHonored, platform: platform, maxRetryCount: maxRetryCount} = options;
    ...
    resolveNodeDefaults(props2) {
        ...
        return {
            ...
            textureOptions: (_B = props2.textureOptions) != null ? _B : EMPTY_TEXTURE_OPTIONS,
...
class RendererMain extends EventEmitter {
    constructor(settings, target) {
        ...
        settings = {
            ...
            forceWebGL2: (_e = settings.forceWebGL2) != null ? _e : false,
            inspector: (_f = settings.inspector) != null ? _f : false,
            inspectorOptions: (_g = settings.inspectorOptions) != null ? _g : {},
            renderEngine: settings.renderEngine,
            quadBufferSize: (_h = settings.quadBufferSize) != null ? _h : 4 * 1024 * 1024,
            fontEngines: (_i = settings.fontEngines) != null ? _i : [],
            textBaselineMode: (_j = settings.textBaselineMode) != null ? _j : "optical",
        ...
        this.stage = new Stage({
            ...
            platform: platform,
            maxRetryCount: (_l = settings.maxRetryCount) != null ? _l : 5
        });
...
class WebGlContextWrapper {
    constructor(gl) {
        ...
        this.vaoExt = this.gl2 === null ? gl.getExtension("OES_vertex_array_object") : null;
...
const Player = lazy(() => __vitePreload(() => import("./Player-kyX7AtTC.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DeU9Y9B5.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-DJ1i0z17.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-BjPkUrIp.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-ChJW6WVg.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-BfeF8iuN.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-CPxukHw4.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-DQy23DsD.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-CS284tzb.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-DFq-A0Wp.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-D0yTCqAR.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-Cr5AJb-H.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-CwFlRoex.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-CcE8E0CZ.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-CnV-E_pB.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-DEYgcz6L.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-DunUI6iN.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-BnNsDP_r.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients--kj2-aHk.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-CrFku-_M.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-DO_Pgxq5.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-sryjtpjC.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BhZiAnAG.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-CHyze6jp.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-Q3vTxo_i.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-CXZjn3p0.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CltWf2pu.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-D-THIxc2.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-Dc1_lqZc.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-Dz_dlFT5.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-DdWwBicL.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-BUtovNAR.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-CJ8sj51M.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-D0H9anu6.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-CG_CeQ5h.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-C19iv9jY.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-DwyYn6rA.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-3I8Jzcjl.js"), true ? [] : void 0));

const ComplexFlexCapsPage = lazy(() => __vitePreload(() => import("./ComplexFlexCaps-CrD7ZAnp.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-JkpMiNyv.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-DrM5_r-Y.js"), true ? [] : void 0));

const TextCenteringPage = lazy(() => __vitePreload(() => import("./TextCentering-B3lL0pkc.js"), true ? [] : void 0));

const CountdownTimerPage = lazy(() => __vitePreload(() => import("./CountdownTimer-CFeP-461.js"), true ? [] : void 0));

const CustomButtonsPage = lazy(() => __vitePreload(() => import("./CustomButtons-CmxJDFFx.js"), true ? [] : void 0));
                        ...
                        return [ createComponent(Route, {
                            ...
                            get children() {
                                return [ createComponent(Route, {
                                    ...
                                    path: "nested",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./Nested-CYcEKno9.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "textposter",
                                    ...
                                    path: "keepalive",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./KeepAlive-BOq5HUqf.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "suspense",
                                    get component() {
                                        return lazy(() => __vitePreload(() => import("./suspense-CZT_xKDW.js"), true ? [] : void 0));
                                    }
                                }), createComponent(Route, {
                                    path: "superflex",
