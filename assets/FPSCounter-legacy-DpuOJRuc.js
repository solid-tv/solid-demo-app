(function() {
    ...
    System.register([ "./render-legacy-D7c8BTw7.js" ], function(_export, _context) {
        "use strict";
        var createSignal, createElement, mergeProps, spread, setProp, insert, createTextNode, insertNode, fpsStyle, fpsLabel, fpsValue, fps, setFps, avgFps, setAvgFps, minFps, setMinFps, maxFps, setMaxFps, quads, setQuads, criticalThresholdSignal, setCriticalThresholdSignal, targetThresholdSignal, setTargetThresholdSignal, renderableMemUsedSignal, setRenderableMemUsedSignal, memUsedSignal, setMemUsedSignal, renderableTexturesLoadedSignal, setRenderableTexturesLoadedSignal, loadedTexturesSignal, setLoadedTexturesSignal, renderOps, setRenderOps, count, totalFps, infoFontSize, resetCounter, calcFps, frameCount, FPSCounter;
