(function() {
    ...
    System.register([ "./render-legacy-BO_iU_BL.js", "./mergeProps-legacy-BFxfnQ9V.js" ], function(_export, _context) {
        "use strict";
        var createSignal, createElement, spread, insert, setProp, createTextNode, insertNode, mergeProps, fpsStyle, fpsLabel, fpsValue, fps, setFps, avgFps, setAvgFps, minFps, setMinFps, maxFps, setMaxFps, quads, setQuads, criticalThresholdSignal, setCriticalThresholdSignal, targetThresholdSignal, setTargetThresholdSignal, renderableMemUsedSignal, setRenderableMemUsedSignal, memUsedSignal, setMemUsedSignal, renderableTexturesLoadedSignal, setRenderableTexturesLoadedSignal, loadedTexturesSignal, setLoadedTexturesSignal, renderOps, setRenderOps, count, totalFps, infoFontSize, resetCounter, calcFps, frameCount, FPSCounter;
