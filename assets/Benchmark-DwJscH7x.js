import { k as onCleanup, a as createSignal, D as useFocusStack, g as createEffect, a9 as renderer, z as debounce, s as setGlobalBackground, i as on, A as activeElement, c as createComponent, S as Show, V as View, T as Text, B as ContentBlock, a4 as LazyColumn, L as LazyRow, aa as Hero, a5 as TitleRow, K as styles, J as memo, ab as AssetPanel, ac as resetCounter, e as batch } from "./index-Dr3lQcZR.js";
                    ...
                    return [ createComponent(View, {
                        ...
                        get children() {
                            return [ createComponent(Text, {
                                ...
                                get children() {
                                    var _a;
                                    return memo(() => renderTime() !== null)() ? "Initial Render: ".concat((_a = renderTime()) == null ? void 0 : _a.toFixed(2), "ms") : "Rendering...";
                                }
                            }) ];
                        }
...
//# sourceMappingURL=Benchmark-DwJscH7x.js.map
