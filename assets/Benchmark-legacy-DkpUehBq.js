(function() {
    ...
    System.register([ "./render-legacy-sNUUjimV.js", "./Lazy-legacy-CfOfsFMV.js", "./FPSCounter-legacy-BwIz3rUR.js", "./ContentBlock-legacy-BX3qcSCp.js", "./createFocusStack-legacy-gsUhsdwl.js", "./components-legacy-Y1dT9cf9.js", "./styles-legacy-DalESU0G.js", "./state-legacy-BKJVH8EN.js", "./dist-legacy-R64ESJIG.js" ], function(_export, _context) {
        "use strict";
        var For, Config, batch, Show, activeElement, onCleanup, createEffect, on, createElement, effect, frameTimeBucketLowerBound, memo, use, createComponent, insert, setProp, createSignal, createTextNode, insertNode, renderer, LazyRow, LazyColumn, resetCounter, ContentBlock, useFocusStack, Hero, DISPLAY_SIZE, SHOW_TEXT, AssetPanel, TitleRow, styles_default, setGlobalBackground, debounce, TOTAL_CYCLES, NAV_DELAY_MS, Benchmark;
        ...
        return {
            setters: [ function(_renderLegacy001Js) {
                ...
                frameTimeBucketLowerBound = _renderLegacy001Js.ct;
            ...
            execute: function execute() {
                ...
                _export("default", Benchmark = function Benchmark(props) {
                    ...
                    var cumulativeAllBuckets = createZeroArray(45);
                    var cumulativeAnimBuckets = createZeroArray(45);
                    ...
                    var activeAnimationsWeightedSum = 0;
                            ...
                            return _regenerator().w(function(_context2) {
                                while (1) switch (_context2.n) {
                                  ...
                                  case 15:
                                    ...
                                    avgActiveAnims = totalRenderedFrames > 0 ? activeAnimationsWeightedSum / totalRenderedFrames : 0;
