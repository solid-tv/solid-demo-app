import { $ as onMount, A as For, a as createElement, c as effect, h as spread, i as createComponent, l as insert, m as setProp, s as createTextNode, u as insertNode } from "./render-CAUp88iy.js";
...
function CenterLine(props) {
    ...
    setProp(_el$, "height", 1), effect(_p$ => {
...
function Section1(props) {
    ...
    insert(_el$7, createComponent(For, {
        ...
        children: mode => {
            ...
            effect(_$p => setProp(_el$1, "color", theme_default.textPrimary, _$p)), _el$1) : (_el$11 = createElement("text"), 
            insertNode(_el$11, createTextNode("reload to view")), setProp(_el$11, "x", 120), 
            setProp(_el$11, "mountX", .5), setProp(_el$11, "fontSize", 18), setProp(_el$11, "lineHeight", 80), 
            effect(_$p => setProp(_el$11, "color", theme_default.textSecondary, _$p)), _el$11), null), 
            insert(_el$9, createComponent(CenterLine, {
                y: 40,
                width: 240
            }), null), setProp(_el$0, "style", Caption), setProp(_el$0, "y", 94), insert(_el$0, isActive ? `'${mode}' (active)` : `'${mode}'`), 
            effect(_$p => setProp(_el$0, "color", isActive ? theme_default.color.blue : theme_default.textSecondary, _$p)), 
            _el$8;
            var _el$11, _el$1, _el$8, _el$9, _el$0;
        }
    })), _el$2;
...
function Section2() {
    ...
    insert(_el$18, createComponent(For, {
        ...
        children: align => {
            ...
            setProp(_el$23, "y", 152), insert(_el$23, align, _el$25), effect(_$p => setProp(_el$21, "color", theme_default.textPrimary, _$p)), 
            _el$19;
            var _el$19, _el$20, _el$21, _el$23, _el$24, _el$25;
        }
    })), _el$13;
    var _el$13, _el$14, _el$16, _el$18;
}
...
function Section3() {
    const letters = [ {
        ...
        insert(_el$27, () => props.label), spread(_el$28, mergeProps(BoxBase, {
            x: 290,
            width: 520,
            height: 130,
            display: "flex",
            ...
            children: l => {
                ...
                insert(_el$30, () => l.ch), effect(_p$ => {
                    ...
                    e: void 0,
                    t: void 0
                }), _el$30) : (_el$31 = createElement("text"), insert(_el$31, () => l.ch), effect(_p$ => {
        ...
        insert(_el$29, () => props.caption), effect(_p$ => {
...
var TextCenteringPage = () => {
    ...
    setProp(_el$39, "x", 200), setProp(_el$39, "y", 1030), effect(_$p => setProp(_el$39, "style", {
        ...Caption,
        width: 1600
    }, _$p)), _el$39) ];
    var _el$39, _el$37;
