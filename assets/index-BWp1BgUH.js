...
const generateTextLayout = (props2, fontCache2) => {
    ...
    const lineHeight = props2.lineHeight || designLineHeight * fontSize / designFontSize;
...
const Player = lazy(() => __vitePreload(() => import("./Player-BzJBKbap.js"), true ? [] : void 0));

const Grid = lazy(() => __vitePreload(() => import("./Grid-DUzxINGK.js"), true ? [] : void 0));

const Loops = lazy(() => __vitePreload(() => import("./Loops-Dc7bNE1d.js"), true ? [] : void 0));

const Infinite = lazy(() => __vitePreload(() => import("./Infinite-wg2h9fEL.js"), true ? [] : void 0));

const TMDBGrid = lazy(() => __vitePreload(() => import("./TMDBGrid-BE6-SWho.js"), true ? [] : void 0));

const Portal = lazy(() => __vitePreload(() => import("./Portal-Dr6KlMXB.js"), true ? [] : void 0));

const MatrixPage = lazy(() => __vitePreload(() => import("./Matrix-BigXVqho.js"), true ? [] : void 0));

const TextPage = lazy(() => __vitePreload(() => import("./Text-C3dk2Og0.js"), true ? [] : void 0));

const TextPosterPage = lazy(() => __vitePreload(() => import("./TextPoster-DQyiupWP.js"), true ? [] : void 0));

const CreatePage = lazy(() => __vitePreload(() => import("./Create-fZeP7pby.js"), true ? [] : void 0));

const ViewportPage = lazy(() => __vitePreload(() => import("./Viewport-CAp5gyMv.js"), true ? [] : void 0));

const PositioningPage = lazy(() => __vitePreload(() => import("./Positioning-CkkmvhuS.js"), true ? [] : void 0));

const LayoutPage = lazy(() => __vitePreload(() => import("./Layout-DqOCQAKI.js"), true ? [] : void 0));

const FocusBasicsPage = lazy(() => __vitePreload(() => import("./FocusBasics-BpLB0cgF.js"), true ? [] : void 0));

const KeyHandlingPage = lazy(() => __vitePreload(() => import("./KeyHandling-BwG5-V4c.js"), true ? [] : void 0));

const TransitionsPage = lazy(() => __vitePreload(() => import("./Transitions-CoByhhXS.js"), true ? [] : void 0));

const ComponentsPage = lazy(() => __vitePreload(() => import("./Components-BAUzZBQq.js"), true ? [] : void 0));

const FocusHandlingPage = lazy(() => __vitePreload(() => import("./FocusHandling-Dc7AAQMx.js"), true ? [] : void 0));

const GradientsPage = lazy(() => __vitePreload(() => import("./Gradients-D8ahDhJI.js"), true ? [] : void 0));

const FlexPage = lazy(() => __vitePreload(() => import("./Flex-NY_dJ7gN.js"), true ? [] : void 0));

const FlexGrowPage = lazy(() => __vitePreload(() => import("./FlexGrow-CD994Zx0.js"), true ? [] : void 0));

const FlexMenuPage = lazy(() => __vitePreload(() => import("./FlexMenu-TP4lfsW6.js"), true ? [] : void 0));

const FlexSizePage = lazy(() => __vitePreload(() => import("./FlexSize-BRjmmwTj.js"), true ? [] : void 0));

const FlexColumnSizePage = lazy(() => __vitePreload(() => import("./FlexColumnSize-Dt8qwl95.js"), true ? [] : void 0));

const FlexColumnPage = lazy(() => __vitePreload(() => import("./FlexColumn-BiDOBMIm.js"), true ? [] : void 0));

const ButtonsMaterialPage = lazy(() => __vitePreload(() => import("./ButtonsMaterial-DoW0DSEq.js"), true ? [] : void 0));

const SuperFlexPage = lazy(() => __vitePreload(() => import("./SuperFlex-CX3UV47v.js"), true ? [] : void 0));

const Entity = lazy(() => __vitePreload(() => import("./Entity-C6DFXfSt.js"), true ? [] : void 0));

const People = lazy(() => __vitePreload(() => import("./People-B4uvJM1W.js"), true ? [] : void 0));

const FireboltPage = lazy(() => __vitePreload(() => import("./Firebolt-SEBrE5yQ.js"), true ? [] : void 0));

const LoginPage = lazy(() => __vitePreload(() => import("./Login-C28oPrdi.js"), true ? [] : void 0));

const VirtualPage = lazy(() => __vitePreload(() => import("./Virtual-CffYykia.js"), true ? [] : void 0));

const TagsPage = lazy(() => __vitePreload(() => import("./Tags-BgHb1Hdz.js"), true ? [] : void 0));

const ImagePerformance = lazy(() => __vitePreload(() => import("./ImagePerformance-CXD84kfH.js"), true ? [] : void 0));

const LargeImagePerformance = lazy(() => __vitePreload(() => import("./LargeImagePerformance-DgT7cF6j.js"), true ? [] : void 0));

const MixedImagePerformance = lazy(() => __vitePreload(() => import("./MixedImagePerformance-BC6_Kmj_.js"), true ? [] : void 0));

const TextureCompressionPerformance = lazy(() => __vitePreload(() => import("./TextureCompressionPerformance-DKhDJ3wh.js"), true ? [] : void 0));

const ComplexFlexPage = lazy(() => __vitePreload(() => import("./ComplexFlex-DHI_jD4x.js"), true ? [] : void 0));

const BenchmarkPage = lazy(() => __vitePreload(() => import("./Benchmark-CB5P6u7C.js"), true ? [] : void 0));

const RendererVersionsPage = lazy(() => __vitePreload(() => import("./RendererVersions-Z3Or9DUT.js"), true ? [] : void 0));
                ...
                return [ createComponent(Route, {
                    ...
                    get children() {
                        return [ createComponent(Route, {
                            ...
                            path: "nested",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./Nested-DawZm-P_.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "textposter",
                            ...
                            path: "keepalive",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./KeepAlive-DmT1OICD.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "suspense",
                            get component() {
                                return lazy(() => __vitePreload(() => import("./suspense-DzN3LZ5U.js"), true ? [] : void 0));
                            }
                        }), createComponent(Route, {
                            path: "superflex",
