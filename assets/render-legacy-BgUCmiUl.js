                ...
                ImageWorkerManager = function() {
                    function ImageWorkerManager(createImageBitmapSupport) {
                        ...
                        this.flushTask = function() {
                            _this6.flushScheduled = false;
                            var pending = _this6.pending;
                            var count = pending.length;
                            if (count === 0) return;
                            if (_this6.worker === null) try {
                                _this6.spawnWorker();
                            } catch (e) {}
                            var worker = _this6.worker;
                            if (worker === null) {
                                for (var i = 0; i < count; i++) {
                                    var id = pending[i].id;
                                    var msg = _this6.messageManager.get(id);
                                    if (msg !== void 0) {
                                        _this6.messageManager.delete(id);
                    ...
                    return _createClass(ImageWorkerManager, [ {
                        ...
                        value: function getImage(src, premultiplyAlpha, sx, sy, sw, sh) {
                            ...
                            return new Promise(function(resolve, reject) {
                                ...
                                if (_this8.flushScheduled === false) {
                                    _this8.flushScheduled = true;
                                    queueMicrotask(_this8.flushTask);
                                }
                            });
                        }
                    } ]);
                ...
                Stage = function() {
                    ...
                    return _createClass(Stage, [ {
                        ...
                        value: function updateAnimations() {
                            ...
                            var start = sampling === true ? this.platform.getTimeStamp() : 0;
                            animationManager.update(this.deltaTime);
                            var active = hadAnimations || animationManager.activeAnimations.length > 0;
                        ...
                        value: function drawFrame() {
                            ...
                            if (sampling === true) {
                                ...
                                var frameAnimationMs = this.frameAnimationMs;
                                var frameFlushMs = this.frameFlushMs;
                        ...
                        value: function emitFpsUpdate() {
                            ...
                            var animationMs = this.fpsAnimationMs;
                            var flushMs = this.fpsFlushMs;
                            var maxAnimationMs = this.fpsMaxAnimationMs;
                            var maxFlushMs = this.fpsMaxFlushMs;
