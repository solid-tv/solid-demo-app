(function() {
    ...
    System.register([ "./index-legacy-DNSIlMWB.js" ], function(exports, module) {
        "use strict";
        var useNavigate, useFocusStack, useMatch, createMemo, createSelector, createEffect, Announcer, createComponent, memo, View, Text, Column, styles, Row, For, mergeProps, assertTruthy, createSignal;
        return {
            ...
            execute: function execute() {
                var Portal = exports("default", function(props) {
                    ...
                    var isLeaf = useMatch(function() {
                        return "/examples";
                    });
                    var hasChildRoute = createMemo(function() {
                        return !isLeaf();
                    });
...
//# sourceMappingURL=Portal-legacy-pt3VlrY2.js.map
